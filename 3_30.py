...
class Ui_SecondWindow(object):
    ...
    def __init__(self, file_path, mode):
        ...
        self.DE_Other_Files_List = list()
        self.DE_Other_Files_List.append(list())
        self.DE_Other_Files_Button_List = list()
    ...
    def setupUi(self, SecondWindow):
        SecondWindow.setWindowIcon(QIcon(resource_path('Main/marine.png')))
        # SecondWindow.setWindowIcon(QIcon(resource_path('marine.png')))
        SecondWindow.setObjectName("SecondWindow")
        SecondWindow.resize(1065, 845)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1021, 698))
        ...
        self.agency_organization_party_name__horizontalLayout.setObjectName(
            "agency_organization_party_name__horizontalLayout")
        ...
        self.DE__scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 997, 626))
        ...
        self.DE_Gather_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 299, 476))
        ...
        self.DE_Gather_Info_organization_party_name__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.DE_Gather_Info_organization_party_name__horizontalLayout_1.setObjectName(
            "DE_Gather_Info_organization_party_name__horizontalLayout_1")
        self.DE_Gather_Info_organization_party_name__label_1 = QtWidgets.QLabel(self.DE_Gather_Info__scrollAreaWidgetContents_1)
        self.DE_Gather_Info_organization_party_name__label_1.setObjectName("DE_Gather_Info_organization_party_name__label_1")
        self.DE_Gather_Info_organization_party_name__horizontalLayout_1.addWidget(self.DE_Gather_Info_organization_party_name__label_1)
        self.DE_Gather_Info_organization_party_name__lineEdit_1 = QtWidgets.QLineEdit(
            self.DE_Gather_Info__scrollAreaWidgetContents_1)
        self.DE_Gather_Info_organization_party_name__lineEdit_1.setObjectName("DE_Gather_Info_organization_party_name__lineEdit_1")
        self.DE_Gather_Info_organization_party_name__horizontalLayout_1.addWidget(self.DE_Gather_Info_organization_party_name__lineEdit_1)
        self.DE_Gather_Info__verticalLayout_1.addLayout(self.DE_Gather_Info_organization_party_name__horizontalLayout_1)
        ...
        self.DE_Gather_Info_Gather_Source_Name__lineEdit_1 = QtWidgets.QLineEdit(
            self.DE_Gather_Info__scrollAreaWidgetContents_1)
        self.DE_Gather_Info_Gather_Source_Name__lineEdit_1.setObjectName(
            "DE_Gather_Info_Gather_Source_Name__lineEdit_1")
        self.DE_Gather_Info_Gather_Source_Name__horizontalLayout_1.addWidget(
            self.DE_Gather_Info_Gather_Source_Name__lineEdit_1)
        ...
        self.DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1 = QtWidgets.QLineEdit(
            self.DE_Gather_Info__scrollAreaWidgetContents_1)
        self.DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1.setObjectName(
            "DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1")
        self.DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1.addWidget(
            self.DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1)
        ...
        self.DE_Gather_Info_file__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 281, 213))
        ...
        self.DE_Gather_Info_gather_file_size__horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.DE_Gather_Info_gather_file_size__horizontalLayout_2.setObjectName(
            "DE_Gather_Info_gather_file_size__horizontalLayout_2")
        self.DE_Gather_Info_gather_file_size__label_1 = QtWidgets.QLabel(
            self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
        self.DE_Gather_Info_gather_file_size__label_1.setObjectName("DE_Gather_Info_gather_file_size__label_1")
        self.DE_Gather_Info_gather_file_size__horizontalLayout_2.addWidget(
            self.DE_Gather_Info_gather_file_size__label_1)
        self.DE_Gather_Info_gather_file_size__lineEdit_1 = QtWidgets.QLineEdit(
            self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
        self.DE_Gather_Info_gather_file_size__lineEdit_1.setObjectName("DE_Gather_Info_gather_file_size__lineEdit_1")
        self.DE_Gather_Info_gather_file_size__horizontalLayout_2.addWidget(
            self.DE_Gather_Info_gather_file_size__lineEdit_1)
        self.DE_Gather_Info_file__verticalLayout_1.addLayout(self.DE_Gather_Info_gather_file_size__horizontalLayout_2)
        ...
        self.DE_Vessel_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 299, 294))
        ...
        self.DE_Marines_Electronics_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 305, 254))
        ...
        self.DE_Other_Files__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 285, 269))
        ...
        self.DE_Acquisition_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 316, 532))
        ...
        self.DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 285, 381))
        ...
        self.AI_scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 363, 352))
        ...
        self.AI_Reports__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 281, 465))
        ...
        self.AI_Reports_submission_agency__horizontalLayout_1.setObjectName(
            "AI_Reports_submission_agency__horizontalLayout_1")
        ...
        self.AI_Reports_reports_creation_datetime__horizontalLayout_1.setObjectName(
            "AI_Reports_reports_creation_datetime__horizontalLayout_1")
        self.AI_Reports_reprot_creation_datetime__label_1 = QtWidgets.QLabel(
        ...
        self.AI_Reports_reports_creation_datetime__horizontalLayout_1.addWidget(
            self.AI_Reports_reprot_creation_datetime__label_1)
        self.AI_Reports_reprot_creation_datetime__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_Reports__scrollAreaWidgetContents_1)
        self.AI_Reports_reprot_creation_datetime__lineEdit_1.setObjectName(
            "AI_Reports_reprot_creation_datetime__lineEdit_1")
        self.AI_Reports_reports_creation_datetime__horizontalLayout_1.addWidget(
            self.AI_Reports_reprot_creation_datetime__lineEdit_1)
        ...
        self.AI_Reports_division_name_of_report_maker__horizontalLayout_1.setObjectName(
            "AI_Reports_division_name_of_report_maker__horizontalLayout_1")
        self.AI_Reports_division_name_of_report_maker__label_1 = QtWidgets.QLabel(
            self.AI_Reports__scrollAreaWidgetContents_1)
        self.AI_Reports_division_name_of_report_maker__label_1.setObjectName(
            "AI_Reports_division_name_of_report_maker__label_1")
        self.AI_Reports_division_name_of_report_maker__horizontalLayout_1.addWidget(
            self.AI_Reports_division_name_of_report_maker__label_1)
        self.AI_Reports_division_name_of_report_maker__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_Reports__scrollAreaWidgetContents_1)
        self.AI_Reports_division_name_of_report_maker__lineEdit_1.setObjectName(
            "AI_Reports_division_name_of_report_maker__lineEdit_1")
        self.AI_Reports_division_name_of_report_maker__horizontalLayout_1.addWidget(
            self.AI_Reports_division_name_of_report_maker__lineEdit_1)
        ...
        self.AI_Reports_team_name_of_report_maker__horizontalLayout_1.setObjectName(
            "AI_Reports_team_name_of_report_maker__horizontalLayout_1")
        self.AI_Reports_team_name_of_report_maker__label_1 = QtWidgets.QLabel(
            self.AI_Reports__scrollAreaWidgetContents_1)
        self.AI_Reports_team_name_of_report_maker__label_1.setObjectName(
            "AI_Reports_team_name_of_report_maker__label_1")
        self.AI_Reports_team_name_of_report_maker__horizontalLayout_1.addWidget(
            self.AI_Reports_team_name_of_report_maker__label_1)
        self.AI_Reports_team_name_of_report_maker__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_Reports__scrollAreaWidgetContents_1)
        self.AI_Reports_team_name_of_report_maker__lineEdit_1.setObjectName(
            "AI_Reports_team_name_of_report_maker__lineEdit_1")
        self.AI_Reports_team_name_of_report_maker__horizontalLayout_1.addWidget(
            self.AI_Reports_team_name_of_report_maker__lineEdit_1)
        ...
        self.AI_Reports_file_creation_datetime__horizontalLayout_1.setObjectName(
            "AI_Reports_file_creation_datetime__horizontalLayout_1")
        ...
        self.AI_Reports_file_creation_datetime__horizontalLayout_1.addWidget(
            self.AI_Reports_file_creation_datetime__label_1)
        self.AI_Reports_file_creation_datetime__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_Reports__scrollAreaWidgetContents_1)
        self.AI_Reports_file_creation_datetime__lineEdit_1.setObjectName(
            "AI_Reports_file_creation_datetime__lineEdit_1")
        self.AI_Reports_file_creation_datetime__horizontalLayout_1.addWidget(
            self.AI_Reports_file_creation_datetime__lineEdit_1)
        ...
        self.AI_Reports_file_description__horizontalLayout_1.setObjectName(
            "AI_Reports_file_description__horizontalLayout_1")
        ...
        self.AI_Reports_file_hash_type__horizontalLayout_1.setObjectName(
            "AI_Reports_file_hash_type__horizontalLayout_1")
        ...
        self.AI_Reports_file_hash_value__horizontalLayout_1.setObjectName(
            "AI_Reports_file_hash_value__horizontalLayout_1")
        ...
        self.AI__scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 281, 269))
        ...
        self.AI_Other_Files_file_browse__horizontalLayout_1.setObjectName(
            "AI_Other_Files_file_browse__horizontalLayout_1")
        ...
        self.AI_Other_Files_file_hash_type__horizontalLayout_1.setObjectName(
            "AI_Other_Files_file_hash_type__horizontalLayout_1")
        ...
        self.AI_Other_Files_file_hash_value__horizontalLayout_1.setObjectName(
            "AI_Other_Files_file_hash_value__horizontalLayout_1")
        ...
        self.AI_Other_Files_file_hash_value__horizontalLayout_1.addWidget(
            self.AI_Other_Files_file_hash_value__lineEdit_1)
        ...
        self.AI_Other_Files_file_description__horizontalLayout_1.setObjectName(
            "AI_Other_Files_file_description__horizontalLayout_1")
        ...
        self.AI_Other_Files_file_description__horizontalLayout_1.addWidget(
            self.AI_Other_Files_file_description__label_1)
        ...
        self.AI_Other_Files_file_description__horizontalLayout_1.addWidget(
            self.AI_Other_Files_file_description__lineEdit_1)
        ...
        self.AI_Other_Files_file_metadata__horizontalLayout_1.setObjectName(
            "AI_Other_Files_file_metadata__horizontalLayout_1")
        ...
        self.AI_EquipmentTraces__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 179, 281))
        self.AI_EquipmentTraces__scrollAreaWidgetContents_1.setObjectName(
            "AI_EquipmentTraces__scrollAreaWidgetContents_1")
        ...
        self.AI_EquipmentTraces_id__lineEdit_1 = QtWidgets.QLineEdit(
        ...
        self.AI_EquipmentTraces_type__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        ...
        self.AI_EquipmentTraces_description__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_description__horizontalLayout_1")
        self.AI_EquipmentTraces_description__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        ...
        self.AI_EquipmentTraces_description__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_description__lineEdit_1.setObjectName("AI_EquipmentTraces_description__lineEdit_1")
        self.AI_EquipmentTraces_description__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_description__lineEdit_1)
        ...
        self.AI_EquipmentTraces_mgmt_id__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_mgmt_id__horizontalLayout_1")
        ...
        self.AI_EquipmentTraces_mgmt_id__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        ...
        self.AI_EquipmentTraces_vessel_id__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_vessel_id__horizontalLayout_1")
        self.AI_EquipmentTraces_vessel_id__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        ...
        self.AI_EquipmentTraces_vessel_id__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        ...
        self.AI_EquipmentTraces_evidence_id__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_evidence_id__horizontalLayout_1")
        self.AI_EquipmentTraces_evidence_id__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        ...
        self.AI_EquipmentTraces_evidence_id__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_evidence_id__lineEdit_1.setObjectName("AI_EquipmentTraces_evidence_id__lineEdit_1")
        self.AI_EquipmentTraces_evidence_id__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_evidence_id__lineEdit_1)
        ...
        self.AI_EquipmentTraces_user_trace_info__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info__label_1.setObjectName("AI_EquipmentTraces_user_trace_info__label_1")
        self.AI_EquipmentTraces_user_trace_info__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info__label_1)
        ...
        self.AI_EquipmentTraces_user_traces_info_sub__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_traces_info_sub__horizontalLayout_1")
        self.AI_EquipmentTraces_user_traces_info_sub__scrollArea_1 = QtWidgets.QScrollArea(
            self.AI_EquipmentTraces__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_traces_info_sub__scrollArea_1.setWidgetResizable(True)
        self.AI_EquipmentTraces_user_traces_info_sub__scrollArea_1.setObjectName(
            "AI_EquipmentTraces_user_traces_info_sub__scrollArea_1")
        self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1 = QtWidgets.QWidget()
        self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1.setGeometry(
            QtCore.QRect(0, 0, 163, 238))
        self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1.setObjectName(
            "AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1")
        ...
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_power_on_time__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_power_on_time__label_1")
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_power_on_time__label_1)
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_system_power_on_time__horizontalLayout_1)
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_extractopm_description__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_extractopm_description__label_1")
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__label_1)
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_extractopm_description__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__horizontalLayout_1)
        self.AI_EquipmentTraces_user_trace_info_system_description__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_system_description__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_description__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_system_description__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_description__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_description__label_1")
        self.AI_EquipmentTraces_user_trace_info_system_description__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_description__label_1)
        self.AI_EquipmentTraces_user_trace_info_system_description__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_description__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_description__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_system_description__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_description__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_system_description__horizontalLayout_1)
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__lhorizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__lhorizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_operation_status__lhorizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_operation_status__label_1")
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__lhorizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_operation_status__label_1)
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_operation_status__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__lhorizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_operation_status__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_system_operation_status__lhorizontalLayout_1)
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_power_off_time__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_power_off_time__label_1")
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_power_off_time__label_1)
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_system_power_off_time__horizontalLayout_1)
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_recording_period__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_recording_period__label_1")
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_track_recording_period__label_1)
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_recording_period__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_track_recording_period__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_track_recording_period__horizontalLayout_1)
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_deletion_trace__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_deletion_trace__label_1")
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__label_1)
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_track_deletion_trace__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__horizontalLayout_1)
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__horizontalLayout_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_user_trace_notes__horizontalLayout_1")
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__label_1 = QtWidgets.QLabel(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__label_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_user_trace_notes__label_1")
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_user_trace_notes__label_1)
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_1 = QtWidgets.QLineEdit(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_1.setObjectName(
            "AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_1")
        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_1)
        self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_trace_info_user_trace_notes__horizontalLayout_1)
        self.gridLayout_14.addLayout(self.AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1, 0, 0, 1, 1)
        self.AI_EquipmentTraces_user_traces_info_sub__scrollArea_1.setWidget(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollAreaWidgetContents_1)
        self.AI_EquipmentTraces_user_traces_info_sub__horizontalLayout_1.addWidget(
            self.AI_EquipmentTraces_user_traces_info_sub__scrollArea_1)
        self.AI_EquipmentTraces__verticalLayout_1.addLayout(
            self.AI_EquipmentTraces_user_traces_info_sub__horizontalLayout_1)
        ...
        self.scrollAreaWidgetContents_12.setGeometry(QtCore.QRect(0, 0, 163, 266))
        ...
        self.Log_digital_evidence_package_management_id___horizontalLayout_1.setObjectName(
        ...
        self.Log_digital_evidence_package_management_id__label_1.setObjectName(
            "Log_digital_evidence_package_management_id__label_1")
        self.Log_digital_evidence_package_management_id___horizontalLayout_1.addWidget(
            self.Log_digital_evidence_package_management_id__label_1)
        self.Log_digital_evidence_package_management_id__lineEdit_1 = QtWidgets.QLineEdit(
            self.scrollAreaWidgetContents_12)
        self.Log_digital_evidence_package_management_id__lineEdit_1.setReadOnly(True)
        self.Log_digital_evidence_package_management_id__lineEdit_1.setObjectName(
            "Log_digital_evidence_package_management_id__lineEdit_1")
        self.Log_digital_evidence_package_management_id___horizontalLayout_1.addWidget(
            self.Log_digital_evidence_package_management_id__lineEdit_1)
        ...
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__horizontalLayout_1.setObjectName(
            "Log_Digital_Evidence_Pack_History_Start_Date_Time__horizontalLayout_1")
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__label_1 = QtWidgets.QLabel(
            self.scrollAreaWidgetContents_12)
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__label_1.setObjectName(
            "Log_Digital_Evidence_Pack_History_Start_Date_Time__label_1")
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__horizontalLayout_1.addWidget(
            self.Log_Digital_Evidence_Pack_History_Start_Date_Time__label_1)
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1 = QtWidgets.QLineEdit(
            self.scrollAreaWidgetContents_12)
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1.setObjectName(
            "Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1")
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__horizontalLayout_1.addWidget(
            self.Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1)
        ...
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__horizontalLayout_1.setObjectName(
            "Log_Digital_Evidence_Pack_History_End_Date_Time__horizontalLayout_1")
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__label_1 = QtWidgets.QLabel(
            self.scrollAreaWidgetContents_12)
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__label_1.setObjectName(
            "Log_Digital_Evidence_Pack_History_End_Date_Time__label_1")
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__horizontalLayout_1.addWidget(
            self.Log_Digital_Evidence_Pack_History_End_Date_Time__label_1)
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1 = QtWidgets.QLineEdit(
            self.scrollAreaWidgetContents_12)
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1.setObjectName(
            "Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1")
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__horizontalLayout_1.addWidget(
            self.Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1)
        ...
        self.Log_devision_name_of_logger__horizontalLayout_1.setObjectName(
        ...
        self.Log_digital_evidence_package_management_id__lineEdit_1.setText("1")
        self.Log_digital_evidence_package_management_id__lineEdit_1.setReadOnly(True)

        self.DE__addButton.clicked.connect(self.DE_AddTab)

        tmp_list = list()
        tmp_list.append(self.DE_Vessel_Info_vessel_name__lineEdit_1)  # 선박 이름 0
        tmp_list.append(self.DE_Vessel_Info_vessel_management_id__lineEdit_1)  # 선박 관리 번호 1
        tmp_list.append(self.DE_Vessel_Info_vessel_MMSI__lineEdit_1)  # 선박 MMSI 2
        tmp_list.append(self.DE_Vessel_Info_vessel_callsign__lineEdit_1)  # 선박 callsign 3
        tmp_list.append(self.DE_Vessel_Info_vessel_IMO__lineEdit_1)  # 선박 IMO 4
        tmp_list.append(self.DE_Vessel_Info_vessel_MRN__lineEdit_1)  # 선박 MRN 5
        tmp_list.append(self.DE_Vessel_Info_vessel_tonnage__lineEdit_1)  # 선박 톤수 6
        tmp_list.append(self.DE_Vessel_Info_vessel_length__lineEdit_1)  # 선박 길이 7
        tmp_list.append(self.DE_Vessel_Info_vessel_total_number_of_equipmentwith_track__lineEdit_1)  # 항적 분석 장비 수 8
        tmp_list.append(self.DE_Vessel_Type__lineEdit_1)  # 선박 유형 9
        tmp_list.append(self.DE_Marines_Electronics_Info_device_management_id__lineEdit_1)  # 장비 관리 고유 번호 10
        tmp_list.append(self.DE_Marines_Electronics_Info_device_type__lineEdit_1)  # 장비 유형 11
        tmp_list.append(self.DE_Marines_Electronics_Info_device_manufacturer__lineEdit_1)  # 장비 제조사 12
        tmp_list.append(self.DE_Marines_Electronics_Info_device_model_name__lineEdit_1)  # 장비 모델명 13
        tmp_list.append(self.DE_Marines_Electronics_Info_device_model_serial_number__lineEdit_1)  # 장비 모델 시리얼 넘버 14
        tmp_list.append(self.DE_Marines_Electronics_Info_device_os_firmware__lineEdit_1)  # 장비 os firmware 15
        tmp_list.append(self.DE_Marines_Electronics_Info_device_description__lineEdit_1)  # 장비 설명 16
        tmp_list.append(self.DE_Gather_Info_gather_no__lineEdit_1)  # 채증 번호 17
        tmp_list.append(self.DE_Gather_Info_gather_location__lineEdit_1)  # 채증 장소 18
        tmp_list.append(self.DE_Gather_Info_organization_party_name__lineEdit_1) # 채증 부서 19
        tmp_list.append(self.DE_Gather_Info_gather_person_name__lineEdit_1) # 채증 담당자20
        tmp_list.append(self.DE_Gather_Info_gather_datetime__lineEdit_1)  # 채증 시간 21
        tmp_list.append(self.DE_Gather_Info_gather_person_agency__lineEdit_1)  # 채증 기관 22
        tmp_list.append(self.DE_Gather_Info_gather_person_rank__lineEdit_1)  # 채증 담당자 계급 23
        tmp_list.append(self.DE_Gather_Info_organization_code__lineEdit_1)  # 소속 조직 코드 24
        tmp_list.append(self.DE_Gather_Info_submitter_name__lineEdit_1)  # 피압수자 25
        tmp_list.append(self.DE_Gather_Info_Gather_Source_Name__lineEdit_1)  # 정보 저장 매체명 26
        tmp_list.append(self.DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1) # 수집 대상자 유형 27
        tmp_list.append(self.DE_Gather_Info_file__filebrowse__lineEdit_1) # 파일 입력 27
        tmp_list.append(self.DE_Gather_Info_gather_media_type__lineEdit_1) # 채증 미디어 유형 28
        tmp_list.append(self.DE_Gather_Info__gather_hash_type__lineEdit_1) # 채증 미디어 해시 종류  29
        tmp_list.append(self.DE_Gather_Info_gather_hash__lineEdit_1) # 채증 미디어 해시값 30
        tmp_list.append(self.DE_Gather_Info_gather_path__lineEdit_1)  # 채증 미디어 경로 31
        tmp_list.append(self.DE_Gather_Info_gather_file_size__lineEdit_1) # 파일 크기 32
        tmp_list.append(self.DE_Gather_Info_gather_metadata__lineEdit_1) # 파일 메타 데이터 33
        tmp_list.append(self.DE_Other_Files_file_browse__lineEdit_1) # 파일 입력 34
        tmp_list.append(self.DE_Other_Files_id__lineEdit_1)  # 기타 파일 관리 번호 35
        tmp_list.append(self.DE_Other_Files_type__lineEdit_1)  # 파일 유형 36
        tmp_list.append(self.DE_Other_Files_file_size__lineEdit_1)  # 파일 크기 37
        tmp_list.append(self.DE_Other_Files_file_path__lineEdit_1)  # 파일 경로 38
        tmp_list.append(self.DE_Other_Files_file_hash_type__lineEdit_1)  # 해시 종류 39
        tmp_list.append(self.DE_Other_Files_file_hash_value__lineEdit_1)  # 해시값 40
        tmp_list.append(self.DE_Other_Files_file_description__lineEdit_1)  # 파일 설명 41
        tmp_list.append(self.DE_Other_Files_file_metadata__lineEdit_1)  # 파일 메타데이터 42
        tmp_list.append(self.DE_Authentication_ID__lineEdit_1) # 수집 관리 번호 43
        tmp_list.append(self.DE_Acquisition_Info_acquisition_person_name__lineEdit_1) # 수집자명 44
        tmp_list.append(self.DE_Acquisition_Info_acquisition_date_time__lineEdit_1)  # 수집 시간 45
        tmp_list.append(self.DE_Acquisition_Info_acquisition_location__lineEdit_1)  # 수집 장소 46
        tmp_list.append(self.DE_Acquisition_Info_acquisition_tool__lineEdit_1)  # 수집 도구 47
        tmp_list.append(self.DE_Acquisition_Info_acquisition_tool_version__lineEdit_1) # 수집 도구 버전 48
        tmp_list.append(self.DE_Authentication_Person_Party_Name__lineEdit_1)  # 수집 부서 49
        tmp_list.append(self.DE_Acquisition_Info_DEF_serial_no__lineEdit_1)  # 일련번호 50
        tmp_list.append(self.DE_Acquisition_Info_DEF_management_id__lineEdit_1)  # 디지털 증거 관리 번호 51
        tmp_list.append(self.DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1)  # 디지털 증거 유형 52
        tmp_list.append(self.DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1)  # 증거 채증 유형 53
        tmp_list.append(self.DE_Acquisition_Info_DEF_gather_no__lineEdit_1)  # 채증 관리 번호 54
        tmp_list.append(self.DE_Acquisition_Info_DEF_browse__lineEdit_1) # 파일 입력 55
        tmp_list.append(self.DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1) # 디지털 증거 파일 이름 56
        tmp_list.append(self.DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1) # 디지털 증거 파일 경로 57
        tmp_list.append(self.DE_Acquisition_Info_DEF_hash_type__lineEdit_1)  # 해시 종류 58
        tmp_list.append(self.DE_Acquisition_Info_DEF_hash_value__lineEdit_1)  # 해시값 59
        tmp_list.append(self.DE_Acquisition_Info_DEF_sector_size__lineEdit_1)  # 섹터 크기 60
        tmp_list.append(self.DE_Acquisition_Info_DEF_file_size__lineEdit_1)  # 파일 크기 61
        tmp_list.append(self.DE_Acquisition_Info_DEF__metadata__lineEdit_1)  # 파일 메타데이터 62
        ...
        tmp_list.append(self.DE_Gather_Info_gather_file_size__lineEdit_1)
        ...
        self.DE_Other_Files_List[0].append(tmp_list)

        de_Other_Files_button_list = list()
        de_Other_Files_button_list.append(self.DE_Other_Files_file_browse__browseButton_1)
        de_Other_Files_button_list.append(self.DE_Other_Files_file_browse__EnterButton_1)
        self.DE_Other_Files_Button_List[0].append(de_Other_Files_button_list)

        self.DE_Other_Files_Button_List[0][0][0].clicked.connect(
            lambda: self.DE_Other_Files_file_browse__browseButton_1_QFileDialog(0, 0))

        self.DE_Other_Files_Button_List[0][0][1].clicked.connect(
            lambda: self.DE_Other_Files_file_browse__EnterButton_1_Calculate(0, 0)
        )

        self.DE_Other_Files__addButton_1.clicked.connect(
            lambda: self.DE_Other_Files_AddTab(0))
        ...
        tmp_list = list()
        tmp_list.append(self.DE_Acquisition_Info_DEF_serial_no__lineEdit_1)  # 0
        tmp_list.append(self.DE_Acquisition_Info_DEF_management_id__lineEdit_1)  # 1
        tmp_list.append(self.DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1)  # 2
        tmp_list.append(self.DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1)  # 3
        tmp_list.append(self.DE_Acquisition_Info_DEF_gather_no__lineEdit_1)  # 4
        tmp_list.append(self.DE_Acquisition_Info_DEF_browse__lineEdit_1)  # 5
        tmp_list.append(self.DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1)  # 6
        tmp_list.append(self.DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1)  # 7
        tmp_list.append(self.DE_Acquisition_Info_DEF_hash_type__lineEdit_1)  # #8
        tmp_list.append(self.DE_Acquisition_Info_DEF_hash_value__lineEdit_1)  # 9
        tmp_list.append(self.DE_Acquisition_Info_DEF_sector_size__lineEdit_1)  # 10
        tmp_list.append(self.DE_Acquisition_Info_DEF_file_size__lineEdit_1)  # 11
        tmp_list.append(self.DE_Acquisition_Info_DEF__metadata__lineEdit_1)  # 12
        ...
        self.DE_Acquisition_Info_DEF_Button_List[0][0][0][0].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(0, 0, 0))

        self.DE_Acquisition_Info_DEF_Button_List[0][0][0][1].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(0, 0, 0))
        ...
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1.setText(str(now))

        self.ExportButton.clicked.connect(self.Easy_Export)


        self.KSButton.clicked.connect(self.New_XML)
        ...
        if self.mode == 'load':
            with open(self.file_path, 'r', encoding="utf-8") as f:
                ...
                for i in range(0, len(data['Digital Evidence Package']['Analysis Info']['Other Files'])):
                    self.Load_AI_Other(i, data)

                for i in range(0, len(data['Logs'])):

                    if i == 0:
                        digital_evidence_package_management_id = data['Logs'][str(i)]['log_management_id']
                        log_history_start_date_time = data['Logs'][str(i)]['log_history_start_date_time']
                        log_datetime = data['Logs'][str(i)]['log_history_end_date_time']  # datetime으로 고쳤음
                        log_type = data['Logs'][str(i)]['log_type']
                        log_description = data['Logs'][str(i)]['log_description']
                        devision_name_of_logger = data['Logs'][str(i)]['devision_name_of_logger']
                        team_name_of_logger = data['Logs'][str(i)]['team_name_of_logger']
                        rank_of_logger = data['Logs'][str(i)]['rank_of_logger']
                        name_of_logger = data['Logs'][str(i)]['name_of_logger']

                        self.Log_digital_evidence_package_management_id__lineEdit_1.setText(
                            digital_evidence_package_management_id)
                        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1.setText(
                            log_history_start_date_time)
                        ...
                        tmp_Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1.setReadOnly(True)
                        tmp_Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1.setReadOnly(True)
                        tmp_Log_digital_evidence_package_management_id__lineEdit_1.setText(str(log_number))
                        tmp_Log_digital_evidence_package_management_id__lineEdit_1.setReadOnly(True)

                        datetime.datetime.today()
                        datetime.datetime.now()
                        now = datetime.datetime.now()

                        tmp_Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1.setText(str(now))
                        ...
                        tmp_list.append(now)
                        tmp_list.append(tmp_Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1)
                        ...
                        tmp_Log_digital_evidence_package_management_id__label_1.setText("로그 번호:")
                        ...
                        tmp_Log_log_description__lineEdit_1.setPlaceholderText(
                            _translate("SecondWindow", "ex) create D20210001-V001-ME001-E001"))
                        ...
                        digital_evidence_package_management_id = data['Logs'][str(i)][
                            'log_management_id']
                        log_history_start_date_time = data['Logs'][str(i)]['log_history_start_date_time']
                        log_history_end_date_time = data['Logs'][str(i)]['log_history_end_date_time']
                        log_type = data['Logs'][str(i)]['log_type']
                        log_description = data['Logs'][str(i)]['log_description']
                        devision_name_of_logger = data['Logs'][str(i)]['devision_name_of_logger']
                        team_name_of_logger = data['Logs'][str(i)]['team_name_of_logger']
                        ...
                        tmp_Log_digital_evidence_package_management_id__lineEdit_1.setText(
                            digital_evidence_package_management_id)
                        tmp_Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1.setText(
                            log_history_start_date_time)
                        tmp_Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1.setText(
                            log_history_end_date_time)
                ...
                if len(data['Logs']) > 0:
                    ...
                    for s in range(0, len(self.Log_List)):
                        self.Log_List[s][4].setReadOnly(True)
                        self.Log_List[s][5].setReadOnly(True)
                        self.Log_List[s][6].setReadOnly(True)
                        self.Log_List[s][7].setReadOnly(True)
                        self.Log_List[s][8].setReadOnly(True)
                        self.Log_List[s][9].setReadOnly(True)
                    ...
                    tmp_list.append(tmp_Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1)  # 3
                    tmp_list.append(tmp_Log_log_type__lineEdit_1)  # 4
                    tmp_list.append(tmp_Log_log_description__lineEdit_1)  # 5
                    tmp_list.append(tmp_Log_devision_name_of_logger__lineEdit_1)  # 6
                    tmp_list.append(tmp_Log_team_name_of_logger__lineEdit_1)  # 7
                    tmp_list.append(tmp_Log_rank_of_logger__lineEdit_1)  # 8
                    tmp_list.append(tmp_Log_name_of_logger__lineEdit_1)  # 9
                    self.Log_List.append(tmp_list)
    ...
    def Load_DE(self, i, data):

        # DE 0
        if i == 0:

            vessel_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_name']
            vessel_management_id = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                    'vessel_management_id']

            vessel_MMSI = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_MMSI']
            vessel_callsign = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_callsign']
            vessel_IMO = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_IMO']
            vessel_MRN = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_MRN']
            vessel_tonnage = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_tonnage']
            vessel_length = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_length']
            total_number_of_equipment_with_track = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                    'total_number_of_equipment_with_track']
            vessel_type = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                'vessel_type']
            ...
            device_management_id = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                    'device_management_id']
            device_type = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                    'device_type']
            ...
            gather_no = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                'gather_management_id']
            gather_location = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                'gather_location']
            gather_organization_party_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['gather_organization_party_name']
            gather_person_name = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'gather_person_name']
            gather_datetime = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                'gather_datetime']
            ...
            gather_organization_code = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'gather_organization_code']
            submitter_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                'submitter_name']
            gather_source_name = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'gather_source_name']
            ...
            self.DE_Gather_Info_organization_party_name__lineEdit_1.setText(gather_organization_party_name)
            ...
            self.DE_Gather_Info_Gather_Source_Name__lineEdit_1.setText(gather_source_name)
            self.DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1.setText(
                gather_relation_person_type_code)

            ##################Gather Info _ Media File 부분####################
            len(data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
            ...
            for j in range(0, len(
                ...
                self.Load_DE_Gather(i, j, data)



            #############[Digital Evidence][Other Files]#######
            len(data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'])

            for j in range(0, len(
                    data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'])):

                self.Load_DE_Other(i, j, data)

            #############[Digital Evidence][Authentication Info]
            len(data['Digital Evidence Package']['Digital Evidences'][str(i)]['Authentication Info'])

            for j in range(0, len(
                    data['Digital Evidence Package']['Digital Evidences'][str(i)]['Authentication Info'])):

                # Authentication 1개

                self.Load_DE_Acquisition(i, j, data)
        # DE>2
        else:
            ...
            tmp_DE__scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 997, 626))
            ...
            tmp_DE_Gather_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 299, 476))
            ...
            tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1.setObjectName(
                "DE_Gather_Info_organization_party_name__horizontalLayout_1")
            tmp_DE_Gather_Info_organization_party_name__label_1 = QtWidgets.QLabel(
                tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_organization_party_name__label_1.setObjectName(
                "DE_Gather_Info_organization_party_name__label_1")
            tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1.addWidget(
                tmp_DE_Gather_Info_organization_party_name__label_1)
            tmp_DE_Gather_Info_organization_party_name__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_organization_party_name__lineEdit_1.setObjectName(
                "DE_Gather_Info_organization_party_name__lineEdit_1")
            tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1.addWidget(
                tmp_DE_Gather_Info_organization_party_name__lineEdit_1)
            tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1)
            ...
            tmp_DE_Gather_Info_Gather_Source_Name__horizontalLayout_1.setObjectName(
                "DE_Gather_Info_Gather_Source_Name__horizontalLayout_1")
            tmp_DE_Gather_Info_Gather_Source_Name__label_1 = QtWidgets.QLabel(
                tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_Gather_Source_Name__label_1.setObjectName("DE_Gather_Info_Gather_Source_Name__label_1")
            tmp_DE_Gather_Info_Gather_Source_Name__horizontalLayout_1.addWidget(
                tmp_DE_Gather_Info_Gather_Source_Name__label_1)
            tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1.setObjectName(
                "DE_Gather_Info_Gather_Source_Name__lineEdit_1")
            tmp_DE_Gather_Info_Gather_Source_Name__horizontalLayout_1.addWidget(
                tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1)
            ...
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1.setObjectName(
                "DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1")
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___label_1 = QtWidgets.QLabel(
                tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___label_1.setObjectName(
                "DE_Gather_Info_Gather_Relation_Person_Type_Code___label_1")
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1.addWidget(
                tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___label_1)
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1.setObjectName(
                "DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1")
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1.addWidget(
                tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1)
            tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1)
            ...
            tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 281, 213))
            ...
            tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2 = QtWidgets.QHBoxLayout()
            tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2.setObjectName(
                "DE_Gather_Info_gather_file_size__horizontalLayout_2")
            tmp_DE_Gather_Info_gather_file_size__label_1 = QtWidgets.QLabel(
                tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_gather_file_size__label_1.setObjectName("DE_Gather_Info_gather_file_size__label_1")
            tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2.addWidget(
                tmp_DE_Gather_Info_gather_file_size__label_1)
            tmp_DE_Gather_Info_gather_file_size__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
            tmp_DE_Gather_Info_gather_file_size__lineEdit_1.setObjectName("DE_Gather_Info_gather_file_size__lineEdit_1")
            tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2.addWidget(
                tmp_DE_Gather_Info_gather_file_size__lineEdit_1)
            tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2)
            ...
            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 299, 294))
            ...
            tmp_DE_Marines_Electronics_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 305, 254))
            ...
            tmp_DE_Other_Files__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 285, 269))
            ...
            tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 316, 532))
            ...
            tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 285, 381))
            ...
            tmp_list = list()
            tmp_list.append(tmp_DE_Vessel_Info_vessel_name__lineEdit_1)  # 선박 이름 0
            tmp_list.append(tmp_DE_Vessel_Info_vessel_management_id__lineEdit_1)  # 선박 관리 번호 1
            tmp_list.append(tmp_DE_Vessel_Info_vessel_MMSI__lineEdit_1)  # 선박 MMSI 2
            tmp_list.append(tmp_DE_Vessel_Info_vessel_callsign__lineEdit_1)  # 선박 callsign 3
            tmp_list.append(tmp_DE_Vessel_Info_vessel_IMO__lineEdit_1)  # 선박 IMO 4
            tmp_list.append(tmp_DE_Vessel_Info_vessel_MRN__lineEdit_1)  # 선박 MRN 5
            tmp_list.append(tmp_DE_Vessel_Info_vessel_tonnage__lineEdit_1)  # 선박 톤수 6
            tmp_list.append(tmp_DE_Vessel_Info_vessel_length__lineEdit_1)  # 선박 길이 7
            tmp_list.append(tmp_DE_Vessel_Info_vessel_total_number_of_equipmentwith_track__lineEdit_1)  # 항적 분석 장비 수 8
            tmp_list.append(tmp_DE_Vessel_Type__lineEdit_1)  # 선박 유형 9
            tmp_list.append(tmp_DE_Marines_Electronics_Info_device_management_id__lineEdit_1)  # 장비 관리 고유 번호 10
            tmp_list.append(tmp_DE_Marines_Electronics_Info_device_type__lineEdit_1)  # 장비 유형 11
            tmp_list.append(tmp_DE_Marines_Electronics_Info_device_manufacturer__lineEdit_1)  # 장비 제조사 12
            tmp_list.append(tmp_DE_Marines_Electronics_Info_device_model_name__lineEdit_1)  # 장비 모델명 13
            tmp_list.append(tmp_DE_Marines_Electronics_Info_device_model_serial_number__lineEdit_1)  # 장비 모델 시리얼 넘버 14
            tmp_list.append(tmp_DE_Marines_Electronics_Info_device_os_firmware__lineEdit_1)  # 장비 os firmware 15
            tmp_list.append(tmp_DE_Marines_Electronics_Info_device_description__lineEdit_1)  # 장비 설명 16
            tmp_list.append(tmp_DE_Gather_Info_gather_no__lineEdit_1)  # 채증 번호 17
            tmp_list.append(tmp_DE_Gather_Info_gather_location__lineEdit_1)  # 채증 장소 18
            tmp_list.append(tmp_DE_Gather_Info_organization_party_name__lineEdit_1)  # 채증 부서 19
            tmp_list.append(tmp_DE_Gather_Info_gather_person_name__lineEdit_1)  # 채증 담당자20
            tmp_list.append(tmp_DE_Gather_Info_gather_datetime__lineEdit_1)  # 채증 시간 21
            tmp_list.append(tmp_DE_Gather_Info_gather_person_agency__lineEdit_1)  # 채증 기관 22
            tmp_list.append(tmp_DE_Gather_Info_gather_person_rank__lineEdit_1)  # 채증 담당자 계급 23
            tmp_list.append(tmp_DE_Gather_Info_organization_code__lineEdit_1)  # 소속 조직 코드 24
            tmp_list.append(tmp_DE_Gather_Info_submitter_name__lineEdit_1)  # 피압수자 25
            tmp_list.append(tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1)  # 정보 저장 매체명 26
            tmp_list.append(tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1)  # 수집 대상자 유형 27
            tmp_list.append(tmp_DE_Gather_Info_file__filebrowse__lineEdit_1)  # 파일 입력 28
            tmp_list.append(tmp_DE_Gather_Info_gather_media_type__lineEdit_1)  # 채증 미디어 유형 29
            tmp_list.append(tmp_DE_Gather_Info__gather_hash_type__lineEdit_1)  # 채증 미디어 해시 종류
            tmp_list.append(tmp_DE_Gather_Info_gather_hash__lineEdit_1)  # 채증 미디어 해시값
            tmp_list.append(tmp_DE_Gather_Info_gather_path__lineEdit_1)  # 채증 미디어 경로
            tmp_list.append(tmp_DE_Gather_Info_gather_file_size__lineEdit_1)  # 파일 크기
            tmp_list.append(tmp_DE_Gather_Info_gather_metadata__lineEdit_1)  # 파일 메타 데이터
            tmp_list.append(tmp_DE_Other_Files_file_browse__lineEdit_1)  # 파일 입력
            tmp_list.append(tmp_DE_Other_Files_id__lineEdit_1)  # 기타 파일 관리 번호
            tmp_list.append(tmp_DE_Other_Files_type__lineEdit_1)  # 파일 유형
            tmp_list.append(tmp_DE_Other_Files_file_size__lineEdit_1)  # 파일 크기
            tmp_list.append(tmp_DE_Other_Files_file_path__lineEdit_1)  # 파일 경로
            tmp_list.append(tmp_DE_Other_Files_file_hash_type__lineEdit_1)  # 해시 종류
            tmp_list.append(tmp_DE_Other_Files_file_hash_value__lineEdit_1)  # 해시값
            tmp_list.append(tmp_DE_Other_Files_file_description__lineEdit_1)  # 파일 설명
            tmp_list.append(tmp_DE_Other_Files_file_metadata__lineEdit_1)  # 파일 메타데이터
            tmp_list.append(tmp_DE_Authentication_ID__lineEdit_1)  # 수집 관리 번호
            tmp_list.append(tmp_DE_Acquisition_Info_acquisition_person_name__lineEdit_1)  # 수집자명
            tmp_list.append(tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1)  # 수집 시간
            tmp_list.append(tmp_DE_Acquisition_Info_acquisition_location__lineEdit_1)  # 수집 장소
            tmp_list.append(tmp_DE_Acquisition_Info_acquisition_tool__lineEdit_1)  # 수집 도구
            tmp_list.append(tmp_DE_Acquisition_Info_acquisition_tool_version__lineEdit_1)  # 수집 도구 버전
            tmp_list.append(tmp_DE_Authentication_Person_Party_Name__lineEdit_1)  # 수집 부서
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_serial_no__lineEdit_1)  # 일련번호
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_management_id__lineEdit_1)  # 디지털 증거 관리 번호
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1)  # 디지털 증거 유형
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1)  # 증거 채증 유형
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1)  # 채증 관리 번호
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)  # 파일 입력
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1)  # 디지털 증거 파일 이름
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1)  # 디지털 증거 파일 경로
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1)  # 해시 종류
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1)  # 해시값
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_sector_size__lineEdit_1)  # 섹터 크기
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1)  # 파일 크기
            tmp_list.append(tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1)  # 파일 메타데이터
            self.DE_AddAll_List.append(tmp_list)
            ...
            gather_info_list.append(tmp_DE_Gather_Info_file__filebrowse__lineEdit_1) #0
            gather_info_list.append(tmp_DE_Gather_Info_gather_media_type__lineEdit_1) #1
            gather_info_list.append(tmp_DE_Gather_Info__gather_hash_type__lineEdit_1) #2
            gather_info_list.append(tmp_DE_Gather_Info_gather_hash__lineEdit_1) #3
            gather_info_list.append(tmp_DE_Gather_Info_gather_path__lineEdit_1) #4
            gather_info_list.append(tmp_DE_Gather_Info_gather_file_size__lineEdit_1) #5
            gather_info_list.append(tmp_DE_Gather_Info_gather_metadata__lineEdit_1) #6
            ...
            self.DE_Gather_Info_Button_List[len(self.DE_Gather_Info_List) - 1].append(
                gather_info_button_list)
            ...
            tmp_len = len(self.DE_Other_Files_List) - 1

            de_Other_Files_list = list()
            de_Other_Files_list.append(tmp_DE_Other_Files_file_browse__lineEdit_1)  # 33
            de_Other_Files_list.append(tmp_DE_Other_Files_id__lineEdit_1)  # 34
            de_Other_Files_list.append(tmp_DE_Other_Files_type__lineEdit_1)  # 35
            de_Other_Files_list.append(tmp_DE_Other_Files_file_size__lineEdit_1)  # 36
            de_Other_Files_list.append(tmp_DE_Other_Files_file_path__lineEdit_1)  # 37
            de_Other_Files_list.append(tmp_DE_Other_Files_file_hash_type__lineEdit_1)  # 38
            de_Other_Files_list.append(tmp_DE_Other_Files_file_hash_value__lineEdit_1)  # 39
            de_Other_Files_list.append(tmp_DE_Other_Files_file_description__lineEdit_1)
            de_Other_Files_list.append(tmp_DE_Other_Files_file_metadata__lineEdit_1)  # 41
            self.DE_Other_Files_List[len(self.DE_Other_Files_List) - 1].append(de_Other_Files_list)

            de_Other_Files_button_list = list()
            de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__browseButton_1)
            de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__EnterButton_1)
            self.DE_Other_Files_Button_List[len(self.DE_Other_Files_List) - 1].append(
                de_Other_Files_button_list)

            # [큰탭][소탭][버튼]
            self.DE_Other_Files_Button_List[tmp_len][0][0].clicked.connect(
                lambda: self.DE_Other_Files_file_browse__browseButton_1_QFileDialog(tmp_len, 0))
            self.DE_Other_Files_Button_List[tmp_len][0][1].clicked.connect(
                lambda: self.DE_Other_Files_file_browse__EnterButton_1_Calculate(tmp_len, 0)
            )
            ...
            tmp_DE_Acquisition_Info__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_AddTab(i))
            # </Acquisition>
            ...
            self.DE_Acquisition_Info_DEF_Button_List.append(list())
            self.DE_Acquisition_Info_DEF_Button_List[
                len(self.DE_Acquisition_Info_DEF_Button_List) - 1].append(list())
            ...
            #
            _translate = QtCore.QCoreApplication.translate
            tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", " " + str(len(self.DE_AddAll_List) - 1)) + str(
                    len(self.DE_Acquisition_Info_List[len(self.DE_AddAll_List) - 1]) - 1) + str(len(
                    self.DE_Acquisition_Info_DEF_List[len(self.DE_AddAll_List) - 1][
                        len(self.DE_Acquisition_Info_List[len(self.DE_AddAll_List) - 1]) - 1]) - 1))

            small = int(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.placeholderText()[-1])
            med = int(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.placeholderText()[-2])
            big = int(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.placeholderText()[-3])

            self.DE_Acquisition_Info_DEF_Button_List[big][med][small][0].clicked.connect(
                lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(big,
                                                                                        med,
                                                                                        small))
            self.DE_Acquisition_Info_DEF_Button_List[big][med][small][1].clicked.connect(
                lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(big, med,
                                                                                     small))
            ...
            _translate = QtCore.QCoreApplication.translate
            tmp_tabWidget_9.setTabText(self.tabWidget_9.indexOf(self.tab_8),
                                       _translate("SecondWindow", "Tab 1"))

            _translate = QtCore.QCoreApplication.translate
            tmp_tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.tab_4),
                                       _translate("SecondWindow", "Tab 1"))

            _translate = QtCore.QCoreApplication.translate
            tmp_Acquisition_tabWidget.setTabText(self.Acquisition_tabWidget.indexOf(self.Acquisition_tab),
                                                 _translate("SecondWindow", "Tab 1"))

            _translate = QtCore.QCoreApplication.translate
            tmp_DEF_tabWidget.setTabText(self.DEF_tabWidget.indexOf(self.DEF_tab),
                                         _translate("SecondWindow", "Tab 1"))
            ...
            tmp_DE_Vessel_Info_vessel_management_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-V001"))
            tmp_DE_Vessel_Info_vessel_MMSI__label_1.setText("선박 MMSI:")
            tmp_DE_Vessel_Info_vessel_MMSI__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 440001000"))
            tmp_DE_Vessel_Info_vessel_callsign__label_1.setText("선박 callsign:")  #
            tmp_DE_Vessel_Info_vessel_callsign__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) KR9ABC"))
            tmp_DE_Vessel_Info_vessel_IMO__label_1.setText("선박 IMO:")
            tmp_DE_Vessel_Info_vessel_IMO__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) IMO 9656532"))
            tmp_DE_Vessel_Info_vessel_MRN__label_1.setText("선박 MRN:")
            tmp_DE_Vessel_Info_vessel_MRN__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 적하목록관리번호"))
            tmp_DE_Vessel_Info_vessel_tonnage__label_1.setText("선박 톤수:")
            tmp_DE_Vessel_Info_vessel_length__label_1.setText("선박 길이:")  # 7
            tmp_DE_Vessel_Info_vessel_total_number_of_equipmentwith_track__label_1.setText(
                "항적 분석 장비 수:")  # 8
            ...
            tmp_DE_Marines_Electronics_Info_device_management_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-V001-D001"))
            ...
            tmp_DE_Marines_Electronics_Info_device_os_firmware__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 0.01"))
            ...
            tmp_DE_Gather_Info_gather_no__lineEdit_1.setPlaceholderText(  _translate("SecondWindow", "ex) D20220203-V001-D001-G001"))
            tmp_DE_Gather_Info_gather_location__label_1.setText("채증 장소:")  # 18
            tmp_DE_Gather_Info_organization_party_name__label_1.setText("채증 부서:")
            tmp_DE_Gather_Info_gather_person_name__label_1.setText("채증 담당자:")  #
            tmp_DE_Gather_Info_gather_datetime__label_1.setText("채증 시간:")  #
            tmp_DE_Gather_Info_gather_datetime__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
            ...
            tmp_DE_Gather_Info_organization_code__label_1.setText("소속 조직 코드:")  #
            tmp_DE_Gather_Info_organization_code__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 044-205-2314"))
            tmp_DE_Gather_Info_submitter_name__label_1.setText("피압수자:")  #
            tmp_DE_Gather_Info_Gather_Source_Name__label_1.setText("정보 저장 매체명:")  #
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___label_1.setText("수집 대상자 유형:")  #
            tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) 소유자, 실사용자, 기타"))
            ...
            tmp_DE_Gather_Info_gather_file_size__label_1.setText("파일 크기:")
            tmp_DE_Gather_Info_gather_metadata__label_1.setText("파일 메타데이터:")  #

            tmp_DE_Other_Files_file_browse__label_1.setText("파일 입력:")  #
            tmp_DE_Other_Files_id__label_1.setText("기타 파일 관리 번호:")  #
            tmp_DE_Other_Files_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-O001"))
            ...
            tmp_DE_Authentication_ID__label_1.setText("수집 관리 번호:")  # 42
            tmp_DE_Authentication_ID__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-V001-D001-A001"))
            ...
            tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
            ...
            tmp_DE_Acquisition_Info_acquisition_tool_version__label_1.setText("수집 도구 버전:")  #
            tmp_DE_Authentication_Person_Party_Name__label_1.setText("수집 부서:")  #

            tmp_DE_Acquisition_Info_DEF_serial_no__label_1.setText("일련 번호:")  #
            tmp_DE_Acquisition_Info_DEF_management_id__label_1.setText("디지털 증거 관리 번호:")  #
            tmp_DE_Acquisition_Info_DEF_management_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-V001-D001-I001"))
            tmp_DE_Acquisition_Info_DEF_digital_evidence_type__label_1.setText("디지털 증거 유형:")  #
            tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) Raw 파일"))
            tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__label_1.setText("증거 채증 유형:")  #
            tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) SD Card"))
            tmp_DE_Acquisition_Info_DEF_gather_no__label_1.setText("채증 관리 번호:")  #
            tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) D20220203-V001-D001-G001"))
            ...
            self.DE_AddAll_List[i][0].setText(vessel_name)
            self.DE_AddAll_List[i][1].setText(vessel_management_id)
            self.DE_AddAll_List[i][2].setText(vessel_MMSI)
            self.DE_AddAll_List[i][3].setText(vessel_callsign)
            self.DE_AddAll_List[i][4].setText(vessel_IMO)
            self.DE_AddAll_List[i][5].setText(vessel_MRN)
            self.DE_AddAll_List[i][6].setText(vessel_tonnage)
            self.DE_AddAll_List[i][7].setText(vessel_length)
            self.DE_AddAll_List[i][8].setText(total_number_of_equipment_with_track)
            self.DE_AddAll_List[i][9].setText(vessel_type)
            ...
            self.DE_AddAll_List[i][10].setText(device_management_id)
            self.DE_AddAll_List[i][11].setText(device_type)
            self.DE_AddAll_List[i][12].setText(device_manufacturer)
            self.DE_AddAll_List[i][13].setText(device_model_name)
            self.DE_AddAll_List[i][14].setText(device_model_serial_number)
            self.DE_AddAll_List[i][15].setText(device_os_firmware)
            self.DE_AddAll_List[i][16].setText(device_descripton)
            ...
            gather_organization_party_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                'gather_organization_party_name']
            ...
            self.DE_AddAll_List[i][17].setText(gather_no)
            self.DE_AddAll_List[i][18].setText(gather_location)
            self.DE_AddAll_List[i][19].setText(gather_organization_party_name)
            self.DE_AddAll_List[i][20].setText(gather_person_name)
            self.DE_AddAll_List[i][21].setText(gather_datetime)
            self.DE_AddAll_List[i][22].setText(gather_person_agency)
            self.DE_AddAll_List[i][23].setText(gather_person_rank)
            self.DE_AddAll_List[i][24].setText(gather_organization_code)
            self.DE_AddAll_List[i][25].setText(submitter_name)
            self.DE_AddAll_List[i][26].setText(gather_source_name)
            self.DE_AddAll_List[i][27].setText(gather_relation_person_type_code)
    ...
    def Load_DE_Gather(self, i, j, data):

        if j == 0:
            gather_media_type = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_media_type']
            gather_hash_type = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_hash_type']
            gather_hash = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_hash']
            gather_path = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_path']
            gather_file_size = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_file_size']
            gather_metadata = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_metadata']
            ...
            # self.DE_Gather_Info_gather_file_size__lineEdit_1.setText(gather_file_size)
            # self.DE_Gather_Info_gather_metadata__lineEdit_1.setText(gather_metadata)

            self.DE_Gather_Info_List[i][j][1].setText(gather_media_type)
            self.DE_Gather_Info_List[i][j][2].setText(gather_hash_type)
            self.DE_Gather_Info_List[i][j][3].setText(gather_hash)
            self.DE_Gather_Info_List[i][j][4].setText(gather_path)
            self.DE_Gather_Info_List[i][j][5].setText(gather_file_size)
            self.DE_Gather_Info_List[i][j][6].setText(gather_metadata)
            ...
            self.DE_Gather_Info_Tab_Widget_List[i].addTab(tmp_tab_8, "Tab" + str(
                len(self.DE_Gather_Info_List[i]) + 1))
            ...
            tmp_list.append(tmp_DE_Gather_Info_gather_file_size__lineEdit_1)
            tmp_list.append(tmp_DE_Gather_Info_gather_metadata__lineEdit_1)
            self.DE_Gather_Info_List[i].append(tmp_list)  # a = 전체 tab의 개수-1

            gather_info_button_list = list()
            gather_info_button_list.append(tmp_DE_Gather_Info_file__filebrowse__browseButton_1)
            gather_info_button_list.append(tmp_DE_Gather_Info_file__filebrowse__enterButton_1)
            self.DE_Gather_Info_Button_List[i].append(gather_info_button_list)

            tmp_len = len(self.DE_Gather_Info_Button_List[i]) - 1
            self.DE_Gather_Info_Button_List[i][tmp_len][0].clicked.connect(
                lambda: self.DE_Gather_Info_file__filebrowse__browseButton_1_QFileDialog(i, tmp_len)
            )
            self.DE_Gather_Info_Button_List[i][tmp_len][1].clicked.connect(
                lambda: self.DE_Gather_Info_file__filebrowse__enterButton_1_Calculate(i, tmp_len)
            )
            ...
            gather_path = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_path']
            gather_file_size = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                    'Gather Info Media File'][str(j)]['gather_file_size']
            ...
            tmp_DE_Gather_Info_gather_media_type__lineEdit_1.setText(gather_media_type)
            tmp_DE_Gather_Info__gather_hash_type__lineEdit_1.setText(gather_hash_type)
            tmp_DE_Gather_Info_gather_hash__lineEdit_1.setText(gather_hash)
            tmp_DE_Gather_Info_gather_path__lineEdit_1.setText(gather_path)
            tmp_DE_Gather_Info_gather_file_size__lineEdit_1.setText(gather_file_size)
            tmp_DE_Gather_Info_gather_metadata__lineEdit_1.setText(gather_metadata)
    ...
    def Load_DE_Other(self, i, j, data):
        ...
        if j == 0:
            ...
            self.DE_Other_Files_List[i][j][1].setText(id)
            self.DE_Other_Files_List[i][j][2].setText(type)
            self.DE_Other_Files_List[i][j][3].setText(file_size)
            self.DE_Other_Files_List[i][j][4].setText(file_path)
            self.DE_Other_Files_List[i][j][5].setText(file_hash_type)
            self.DE_Other_Files_List[i][j][6].setText(file_hash_value)
            self.DE_Other_Files_List[i][j][7].setText(file_description)
            self.DE_Other_Files_List[i][j][8].setText(file_metadata)
            ...
            tmp_DE_Other_Files__scrollAreaWidgetContents_1.setObjectName(
                "DE_Other_Files__scrollAreaWidgetContents_1")
            tmp_gridLayout_13 = QtWidgets.QGridLayout(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_gridLayout_13.setObjectName("gridLayout_13")
            tmp_DE_Other_Files__verticalLayout_1 = QtWidgets.QVBoxLayout()
            tmp_DE_Other_Files__verticalLayout_1.setObjectName("DE_Other_Files__verticalLayout_1")
            ...
            tmp_DE_Other_Files_file_browse__horizontalLayout_1.setObjectName(
                "DE_Other_Files_file_browse__horizontalLayout_1")
            tmp_DE_Other_Files_file_browse__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_browse__label_1.setObjectName(
                "DE_Other_Files_file_browse__label_1")
            tmp_DE_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_browse__label_1)
            tmp_DE_Other_Files_file_browse__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_browse__lineEdit_1.setObjectName(
                "DE_Other_Files_file_browse__lineEdit_1")
            tmp_DE_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_browse__lineEdit_1)
            tmp_DE_Other_Files_file_browse__browseButton_1 = QtWidgets.QPushButton(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_browse__browseButton_1.setObjectName(
                "DE_Other_Files_file_browse__browseButton_1")
            tmp_DE_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_browse__browseButton_1)
            tmp_DE_Other_Files_file_browse__EnterButton_1 = QtWidgets.QPushButton(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_browse__EnterButton_1.setObjectName(
                "DE_Other_Files_file_browse__EnterButton_1")
            tmp_DE_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_browse__EnterButton_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_file_browse__horizontalLayout_1)
            tmp_DE_Other_Files_id__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_id__horizontalLayout_1.setObjectName(
                "DE_Other_Files_id__horizontalLayout_1")
            tmp_DE_Other_Files_id__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_id__label_1.setObjectName("DE_Other_Files_id__label_1")
            tmp_DE_Other_Files_id__horizontalLayout_1.addWidget(tmp_DE_Other_Files_id__label_1)
            tmp_DE_Other_Files_id__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_id__lineEdit_1.setObjectName("DE_Other_Files_id__lineEdit_1")
            tmp_DE_Other_Files_id__horizontalLayout_1.addWidget(tmp_DE_Other_Files_id__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_id__horizontalLayout_1)
            tmp_DE_Other_Files_type__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_type__horizontalLayout_1.setObjectName(
                "DE_Other_Files_type__horizontalLayout_1")
            tmp_DE_Other_Files_type__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_type__label_1.setObjectName("DE_Other_Files_type__label_1")
            tmp_DE_Other_Files_type__horizontalLayout_1.addWidget(tmp_DE_Other_Files_type__label_1)
            tmp_DE_Other_Files_type__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_type__lineEdit_1.setObjectName("DE_Other_Files_type__lineEdit_1")
            tmp_DE_Other_Files_type__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_type__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_type__horizontalLayout_1)
            tmp_DE_Other_Files_file_size__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_file_size__horizontalLayout_1.setObjectName(
                "DE_Other_Files_file_size__horizontalLayout_1")
            tmp_DE_Other_Files_file_size__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_size__label_1.setObjectName("DE_Other_Files_file_size__label_1")
            tmp_DE_Other_Files_file_size__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_size__label_1)
            tmp_DE_Other_Files_file_size__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_size__lineEdit_1.setObjectName(
                "DE_Other_Files_file_size__lineEdit_1")
            tmp_DE_Other_Files_file_size__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_size__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_file_size__horizontalLayout_1)
            tmp_DE_Other_Files_file_path__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_file_path__horizontalLayout_1.setObjectName(
                "DE_Other_Files_file_path__horizontalLayout_1")
            tmp_DE_Other_Files_file_path__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_path__label_1.setObjectName("DE_Other_Files_file_path__label_1")
            tmp_DE_Other_Files_file_path__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_path__label_1)
            tmp_DE_Other_Files_file_path__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_path__lineEdit_1.setObjectName(
                "DE_Other_Files_file_path__lineEdit_1")
            tmp_DE_Other_Files_file_path__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_path__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_file_path__horizontalLayout_1)
            tmp_DE_Other_Files_file_hash_type__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_file_hash_type__horizontalLayout_1.setObjectName(
                "DE_Other_Files_file_hash_type__horizontalLayout_1")
            tmp_DE_Other_Files_file_hash_type__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_hash_type__label_1.setObjectName(
                "DE_Other_Files_file_hash_type__label_1")
            tmp_DE_Other_Files_file_hash_type__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_hash_type__label_1)
            tmp_DE_Other_Files_file_hash_type__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_hash_type__lineEdit_1.setObjectName(
                "DE_Other_Files_file_hash_type__lineEdit_1")
            tmp_DE_Other_Files_file_hash_type__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_hash_type__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_file_hash_type__horizontalLayout_1)
            tmp_DE_Other_Files_file_hash_value__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_file_hash_value__horizontalLayout_1.setObjectName(
                "DE_Other_Files_file_hash_value__horizontalLayout_1")
            tmp_DE_Other_Files_file_hash_value__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_hash_value__label_1.setObjectName(
                "DE_Other_Files_file_hash_value__label_1")
            tmp_DE_Other_Files_file_hash_value__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_hash_value__label_1)
            tmp_DE_Other_Files_file_hash_value__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_hash_value__lineEdit_1.setObjectName(
                "DE_Other_Files_file_hash_value__lineEdit_1")
            tmp_DE_Other_Files_file_hash_value__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_hash_value__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_file_hash_value__horizontalLayout_1)
            tmp_DE_Other_Files_file_description__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_file_description__horizontalLayout_1.setObjectName(
                "DE_Other_Files_file_description__horizontalLayout_1")
            tmp_DE_Other_Files_file_description__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_description__label_1.setObjectName(
                "DE_Other_Files_file_description__label_1")
            tmp_DE_Other_Files_file_description__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_description__label_1)
            tmp_DE_Other_Files_file_description__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_description__lineEdit_1.setObjectName(
                "DE_Other_Files_file_description__lineEdit_1")
            tmp_DE_Other_Files_file_description__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_description__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_file_description__horizontalLayout_1)
            tmp_DE_Other_Files_file_metadata__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Other_Files_file_metadata__horizontalLayout_1.setObjectName(
                "DE_Other_Files_file_metadata__horizontalLayout_1")
            tmp_DE_Other_Files_file_metadata__label_1 = QtWidgets.QLabel(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_metadata__label_1.setObjectName(
                "DE_Other_Files_file_metadata__label_1")
            tmp_DE_Other_Files_file_metadata__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_metadata__label_1)
            tmp_DE_Other_Files_file_metadata__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_DE_Other_Files_file_metadata__lineEdit_1.setObjectName(
                "DE_Other_Files_file_metadata__lineEdit_1")
            tmp_DE_Other_Files_file_metadata__horizontalLayout_1.addWidget(
                tmp_DE_Other_Files_file_metadata__lineEdit_1)
            tmp_DE_Other_Files__verticalLayout_1.addLayout(
                tmp_DE_Other_Files_file_metadata__horizontalLayout_1)
            tmp_gridLayout_13.addLayout(tmp_DE_Other_Files__verticalLayout_1, 0, 0, 1, 1)
            tmp_DE_Other_Files__scrollArea_1.setWidget(
                tmp_DE_Other_Files__scrollAreaWidgetContents_1)
            tmp_gridLayout_9.addWidget(tmp_DE_Other_Files__scrollArea_1, 0, 0, 1, 1)

            self.DE_Other_Files_Tab_Widget_List[i].addTab(tmp_tab_4, "Tab" + str(
                len(self.DE_Other_Files_List[i]) + 1))
            ...
            tmp_DE_Other_Files_id__lineEdit_1.setText(id)
            tmp_DE_Other_Files_type__lineEdit_1.setText(type)
            tmp_DE_Other_Files_file_size__lineEdit_1.setText(file_size)
            tmp_DE_Other_Files_file_path__lineEdit_1.setText(file_path)
            tmp_DE_Other_Files_file_hash_type__lineEdit_1.setText(file_hash_type)
            tmp_DE_Other_Files_file_hash_value__lineEdit_1.setText(file_hash_value)
            tmp_DE_Other_Files_file_description__lineEdit_1.setText(file_description)
            tmp_DE_Other_Files_file_metadata__lineEdit_1.setText(file_metadata)
            ...
            self.DE_Other_Files_List[i].append(tmp_list)

            de_Other_Files_button_list = list()
            de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__browseButton_1)
            de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__EnterButton_1)
            self.DE_Other_Files_Button_List[i].append(de_Other_Files_button_list)

            tmp_len = len(self.DE_Other_Files_Button_List[i]) - 1

            if j == 1:

                self.DE_Other_Files_Button_List[i][1][0].clicked.connect(
                    lambda: self.DE_Other_Files_file_browse__browseButton_1_QFileDialog(i, 1))

                self.DE_Other_Files_Button_List[i][1][1].clicked.connect(
                    lambda: self.DE_Other_Files_file_browse__EnterButton_1_Calculate(i, 1))

            elif j == 2:

                self.DE_Other_Files_Button_List[i][2][0].clicked.connect(
                    lambda: self.DE_Other_Files_file_browse__browseButton_1_QFileDialog(i, 2))

                self.DE_Other_Files_Button_List[i][2][1].clicked.connect(
                    lambda: self.DE_Other_Files_file_browse__EnterButton_1_Calculate(i, 2))
    ...
    def Load_DE_Acquisition(self, i, j, data):

        if j == 0:

            authentication_id = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][
                    str(j)][
                    'authentication_management_id']
            authentication_person_name = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'authentication_person_name']
            ...
            authentication_tool_version = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'authentication_tool_version']

            authentication_person_party_name = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'authentication_person_party_name']
            ...
            self.DE_Acquisition_Info_List[i][0][0].setText(authentication_id)
            self.DE_Acquisition_Info_List[i][0][1].setText(authentication_person_name)
            self.DE_Acquisition_Info_List[i][0][2].setText(authentication_date_time)
            self.DE_Acquisition_Info_List[i][0][3].setText(authentication_location)
            self.DE_Acquisition_Info_List[i][0][4].setText(authentication_tool)
            self.DE_Acquisition_Info_List[i][0][5].setText(authentication_tool_version)
            self.DE_Acquisition_Info_List[i][0][6].setText(authentication_person_party_name)

            ##################Authentication Info _ DEF 부분####################
            len(data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][
                    str(j)]['Digital Evidence Files'])

            for k in range(0, len(data['Digital Evidence Package']['Digital Evidences'][str(i)][
                                      'Authentication Info'][str(j)]['Digital Evidence Files'])):

                self.Load_DE_DEF(i, j, k, data)
            ...
            tmp_DE_Acquisition_Info__scrollArea_1.setObjectName("DE_Acquisition_Info__scrollArea_1")
            tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1 = QtWidgets.QWidget()
            tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1.setGeometry(
                QtCore.QRect(0, 0, 368, 657))
            tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1.setObjectName(
                "DE_Acquisition_Info__scrollAreaWidgetContents_1")
            tmp_gridLayout_4 = QtWidgets.QGridLayout(
                tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
            tmp_gridLayout_4.setObjectName("gridLayout_4")
            tmp_DE_Acquisition_Info__verticalLayout_1 = QtWidgets.QVBoxLayout()
            tmp_DE_Acquisition_Info__verticalLayout_1.setObjectName(
                "DE_Acquisition_Info__verticalLayout_1")
            tmp_DE_Authentication_ID__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Authentication_ID__horizontalLayout_1.setObjectName(
                "DE_Authentication_ID__horizontalLayout_1")
            tmp_DE_Authentication_ID__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
            tmp_DE_Authentication_ID__label_1.setObjectName("DE_Authentication_ID__label_1")
            tmp_DE_Authentication_ID__horizontalLayout_1.addWidget(
                tmp_DE_Authentication_ID__label_1)
            tmp_DE_Authentication_ID__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
            tmp_DE_Authentication_ID__lineEdit_1.setObjectName("DE_Authentication_ID__lineEdit_1")
            tmp_DE_Authentication_ID__horizontalLayout_1.addWidget(
                tmp_DE_Authentication_ID__lineEdit_1)
            tmp_DE_Acquisition_Info__verticalLayout_1.addLayout(
                tmp_DE_Authentication_ID__horizontalLayout_1)
            tmp_DE_Acquisition_Info_acquisition_person_name__horizontalLayout_1 = QtWidgets.QHBoxLayout()
            tmp_DE_Acquisition_Info_acquisition_person_name__horizontalLayout_1.setObjectName(
                "DE_Acquisition_Info_acquisition_person_name__horizontalLayout_1")
            tmp_DE_Acquisition_Info_acquisition_person_name__label_1 = QtWidgets.QLabel(
            ...
            tmp_DE_Acquisition_Info__verticalLayout_1.addLayout(
                tmp_DE_Authentication_Person_Party_Name__horizontalLayout_1)
            tmp_gridLayout_4.addLayout(tmp_DE_Acquisition_Info__verticalLayout_1, 0, 0, 1, 1)
            tmp_DEF_tabWidget = QtWidgets.QTabWidget(
                tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info_file__scrollArea_1.setWidgetResizable(True)
            tmp_DE_Acquisition_Info_file__scrollArea_1.setObjectName(
                "DE_Acquisition_Info_file__scrollArea_1")
            tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1 = QtWidgets.QWidget()
            tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1.setGeometry(
                QtCore.QRect(0, 0, 307, 381))
            tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1.setObjectName(
                "DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1")
            tmp_gridLayout_15 = QtWidgets.QGridLayout(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_gridLayout_15.setObjectName("gridLayout_15")
            tmp_DE_Acquisition_Info__DEF_file__verticalLayout_1 = QtWidgets.QVBoxLayout()
            tmp_DE_Acquisition_Info__DEF_file__verticalLayout_1.setObjectName(
            ...
            tmp_DE_Acquisition_Info_DEF_serial_no__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF_serial_no__label_1.setObjectName(
                "DE_Acquisition_Info_DEF_serial_no__label_1")
            tmp_DE_Acquisition_Info_DEF_serial_no__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF_serial_no__label_1)
            tmp_DE_Acquisition_Info_DEF_serial_no__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info_DEF_gather_no__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF_gather_no__label_1.setObjectName(
                "DE_Acquisition_Info_DEF_gather_no__label_1")
            tmp_DE_Acquisition_Info_DEF_gather_no__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF_gather_no__label_1)
            tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info_DEF_browse__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF_browse__label_1.setMaximumSize(
                QtCore.QSize(16777215, 16500000))
            tmp_DE_Acquisition_Info_DEF_browse__label_1.setObjectName(
                "DE_Acquisition_Info_DEF_browse__label_1")
            tmp_DE_Acquisition_Info_DEF_file_browse_horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF_browse__label_1)
            tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.setObjectName(
                "DE_Acquisition_Info_DEF_browse__lineEdit_1")
            tmp_DE_Acquisition_Info_DEF_file_browse_horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)
            tmp_DE_Acquisition_Info_DEF_browse__browseButton_1 = QtWidgets.QPushButton(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info_DEF_hash_type__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF_hash_type__label_1.setObjectName(
                "DE_Acquisition_Info_DEF_hash_type__label_1")
            tmp_DE_Acquisition_Info_DEF_hash_type__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF_hash_type__label_1)
            tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info_DEF_hash_value__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF_hash_value__label_1.setObjectName(
                "DE_Acquisition_Info_DEF_hash_value__label_1")
            tmp_DE_Acquisition_Info_DEF_hash_value__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF_hash_value__label_1)
            tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info_DEF_file_size__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF_file_size__label_1.setObjectName(
                "DE_Acquisition_Info_DEF_file_size__label_1")
            tmp_DE_Acquisition_Info_DEF_file_size__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF_file_size__label_1)
            tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info_DEF__metadata__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF__metadata__label_1.setObjectName(
                "DE_Acquisition_Info_DEF__metadata__label_1")
            tmp_DE_Acquisition_Info_DEF__metadata__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF__metadata__label_1)
            tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            ...
            tmp_DE_Acquisition_Info__DEF_file__verticalLayout_1.addLayout(
                tmp_DE_Acquisition_Info_DEF__metadata__horizontalLayout_1)
            tmp_gridLayout_15.addLayout(tmp_DE_Acquisition_Info__DEF_file__verticalLayout_1, 0, 0,
                                        1, 1)
            tmp_DE_Acquisition_Info_file__scrollArea_1.setWidget(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_gridLayout_17.addWidget(tmp_DE_Acquisition_Info_file__scrollArea_1, 0, 0, 1, 1)
            ...
            tmp_DE_Acquisition_Info_DEF__addButton__horizontalLayout_1.setObjectName(
                "DE_Acquisition_Info_DEF__addButton__horizontalLayout_1")
            tmp_DE_Acquisition_Info_DEF__label_1 = QtWidgets.QLabel(
                tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF__label_1.setObjectName("DE_Acquisition_Info_DEF__label_1")
            tmp_DE_Acquisition_Info_DEF__addButton__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF__label_1)
            tmp_DE_Acquisition_Info_DEF__addButton_1 = QtWidgets.QPushButton(
                tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
            tmp_DE_Acquisition_Info_DEF__addButton_1.setObjectName(
                "DE_Acquisition_Info_DEF__addButton_1")
            tmp_DE_Acquisition_Info_DEF__addButton__horizontalLayout_1.addWidget(
                tmp_DE_Acquisition_Info_DEF__addButton_1)
            tmp_gridLayout_4.addLayout(tmp_DE_Acquisition_Info_DEF__addButton__horizontalLayout_1,
                                       1, 0,
                                       1, 1)
            tmp_DE_Acquisition_Info__scrollArea_1.setWidget(
                tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
            tmp_gridLayout_29.addWidget(tmp_DE_Acquisition_Info__scrollArea_1, 0, 0, 1, 1)
            ...
            # <Acquisition>
            self.DE_Acquisition_Info_Tab_Widget_List[i].addTab(tmp_Acquisition_tab, "Tab" + str(
                len(self.DE_Acquisition_Info_List[i]) + 1))
            ...
            tmp_list.append(tmp_DE_Acquisition_Info_acquisition_tool_version__lineEdit_1)
            tmp_list.append(tmp_DE_Authentication_Person_Party_Name__lineEdit_1)
            self.DE_Acquisition_Info_List[i].append(tmp_list)

            tmp_len = len(self.DE_Acquisition_Info_DEF_List) - 1
            tmp_lenn = len(self.DE_Acquisition_Info_DEF_List[tmp_len]) - 1

            self.DE_Acquisition_Info_DEF_List[i].append(list())
            ...
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1) #3
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1) #4
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1) #5
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1) #6
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1) #7
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1) #8
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1) #9
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_sector_size__lineEdit_1) #10
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1) #11
            tmp_list.append(tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1) #12
            self.DE_Acquisition_Info_DEF_List[i][
                len(self.DE_Acquisition_Info_DEF_List[i]) - 1].append(tmp_list)

            tmp_len = len(self.DE_Acquisition_Info_DEF_List) - 1
            tmp_lenn = len(self.DE_Acquisition_Info_DEF_List[tmp_len]) - 1
            tmp_lennn = len(self.DE_Acquisition_Info_DEF_List[tmp_len][tmp_lenn]) - 1

            self.DE_Acquisition_Info_DEF_Tab_Widget_List[i].append(tmp_DEF_tabWidget)

            self.DE_Acquisition_Info_DEF_Button_List[i].append(list())
            ...
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__enterButton_1)
            self.DE_Acquisition_Info_DEF_Button_List[i][
                len(self.DE_Acquisition_Info_DEF_Button_List[i]) - 1].append(tmp_list)
            #
            ...
            tmp_len = len(self.DE_Acquisition_Info_DEF_List[i][j]) - 1
            self.DE_Acquisition_Info_DEF_Button_List[big][med][small][0].clicked.connect(
                lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(big,
                                                                                        med,
                                                                                        small))
            ...
            tmp_len = len(self.DE_Acquisition_Info_DEF_List[i]) - 1
            tmp_len2 = len(self.DE_Acquisition_Info_DEF_List[i][tmp_len]) - 1
            self.DEF_AddButton_List[i].append(list())
            self.DEF_AddButton_List[i][tmp_len].append(tmp_DE_Acquisition_Info_DEF__addButton_1)
            self.DEF_AddButton_List[i][tmp_len][0].clicked.connect(
                lambda: self.DE_Acquisition_Info_DEF_AddTab(i, tmp_len))

            # </DEF>
            _translate = QtCore.QCoreApplication.translate

            tmp_DE_Authentication_ID__label_1.setText("수집 관리 번호:")
            tmp_DE_Authentication_ID__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) D20220203-V001-D001-A001"))
            tmp_DE_Acquisition_Info_acquisition_person_name__label_1.setText("수집자명:")
            tmp_DE_Acquisition_Info_acquisition_date_time__label_1.setText("수집 시간:")
            ...
            tmp_DE_Acquisition_Info_DEF_management_id__label_1.setText("디지털 증거 관리 번호:")
            tmp_DE_Acquisition_Info_DEF_digital_evidence_type__label_1.setText("디지털 증거 유형:")
            tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) Raw 파일"))
            tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__label_1.setText("증거 채증 유형:")
            tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) SD Card"))
            tmp_DE_Acquisition_Info_DEF_gather_no__label_1.setText("채증 관리 번호:")
            ...
            tmp_DE_Authentication_ID__lineEdit_1.setText(authentication_id)
            tmp_DE_Acquisition_Info_acquisition_person_name__lineEdit_1.setText(
                authentication_person_name)
            tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1.setText(
                authentication_date_time)
            tmp_DE_Acquisition_Info_acquisition_location__lineEdit_1.setText(
                authentication_location)
            tmp_DE_Acquisition_Info_acquisition_tool__lineEdit_1.setText(authentication_tool)
            tmp_DE_Acquisition_Info_acquisition_tool_version__lineEdit_1.setText(
                authentication_tool_version)
            tmp_DE_Authentication_Person_Party_Name__lineEdit_1.setText(
                authentication_person_party_name)
    ...
    def Load_DE_DEF(self, i, j, k, data):

        if k == 0:

            serial_no = data['Digital Evidence Package']['Digital Evidences'][str(i)][
                'Authentication Info'][str(j)][
                'Digital Evidence Files'][str(k)]['serial_no']
            management_id = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['digital_evidence_management_id']
            digital_evidence_type = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['digital_evidence_type']
            evidences_gathering_type = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['evidences_gathering_type']
            gather_no = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['gather_management_id']
            DEF_file_name = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['file_name']
            DEF_file_path = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['file_path']
            hash_type = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['hash_type']
            hash_value = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['hash_value']
            sector_size = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['sector_size']
            DEF_file_size = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['file_size']
            metadata = \
                data['Digital Evidence Package']['Digital Evidences'][str(i)][
                    'Authentication Info'][str(j)][
                    'Digital Evidence Files'][str(k)]['metadata']

            self.DE_Acquisition_Info_DEF_List[i][j][0][0].setText(serial_no)
            self.DE_Acquisition_Info_DEF_List[i][j][0][1].setText(management_id)
            self.DE_Acquisition_Info_DEF_List[i][j][0][2].setText(digital_evidence_type)
            self.DE_Acquisition_Info_DEF_List[i][j][0][3].setText(evidences_gathering_type)
            self.DE_Acquisition_Info_DEF_List[i][j][0][4].setText(gather_no)
            self.DE_Acquisition_Info_DEF_List[i][j][0][6].setText(DEF_file_name)
            self.DE_Acquisition_Info_DEF_List[i][j][0][7].setText(DEF_file_path)
            self.DE_Acquisition_Info_DEF_List[i][j][0][8].setText(hash_type)
            self.DE_Acquisition_Info_DEF_List[i][j][0][9].setText(hash_value)
            self.DE_Acquisition_Info_DEF_List[i][j][0][10].setText(sector_size)
            self.DE_Acquisition_Info_DEF_List[i][j][0][11].setText(DEF_file_size)
            self.DE_Acquisition_Info_DEF_List[i][j][0][12].setText(metadata)

        else:

            self.DE_Acquisition_Info_DEF_num = 1
            ...
            tmp_DE_Acquisition_Info_file__scrollArea_1.setWidget(
                tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
            tmp_gridLayout_17.addWidget(tmp_DE_Acquisition_Info_file__scrollArea_1, 0, 0, 1,
                                        1)

            self.DE_Acquisition_Info_DEF_Tab_Widget_List[i][j].addTab(tmp_DEF_tab,
                                                                      "Tab" + str(
                                                                          len(
                                                                              self.DE_Acquisition_Info_DEF_List[
                                                                                  i][
                                                                                  j]) + 1))  #
            ...
            self.DE_Acquisition_Info_DEF_List[i][j].append(tmp_list)

            tmp_list = list()
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)  # 0
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__enterButton_1)
            self.DE_Acquisition_Info_DEF_Button_List[i][j].append(tmp_list)
            ...
            tmp_DE_Acquisition_Info_DEF_serial_no__lineEdit_1.setText(serial_no)
            tmp_DE_Acquisition_Info_DEF_management_id__lineEdit_1.setText(management_id)
            tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1.setText(
                digital_evidence_type)
            tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1.setText(
                evidences_gathering_type)
            tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1.setText(gather_no)
            tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1.setText(
                DEF_file_name)
            tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1.setText(
                DEF_file_path)
            tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1.setText(hash_type)
            tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1.setText(hash_value)
            tmp_DE_Acquisition_Info_DEF_sector_size__lineEdit_1.setText(sector_size)
            tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1.setText(DEF_file_size)
            tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1.setText(metadata)

            _translate = QtCore.QCoreApplication.translate
            tmp_DE_Acquisition_Info_DEF_serial_no__label_1.setText("일련 번호:")
            tmp_DE_Acquisition_Info_DEF_management_id__label_1.setText("디지털 증거 관리 번호:")
            tmp_DE_Acquisition_Info_DEF_management_id__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) D20220203-V001-D001-I001"))
            tmp_DE_Acquisition_Info_DEF_digital_evidence_type__label_1.setText("디지털 증거 유형:")
            tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) Raw 파일"))
            ...
            tmp_DE_Acquisition_Info_DEF_browse__label_1.setText("파일 입력:")
            tmp_DE_Acquisition_Info_DEF_browse__browseButton_1.setText("Browse..."
                                                                                   # + str(len(self.DE_AddAll_List) - 1)
                                                                                   # + str(len(self.DE_Acquisition_Info_List[len(self.DE_AddAll_List) - 1]) - 1)
                                                                                   # + str(len(self.DE_Acquisition_Info_DEF_List[len(self.DE_AddAll_List) - 1][len(self.DE_Acquisition_Info_List[len(self.DE_AddAll_List) - 1]) - 1]) - 1)
                                                                       )
            tmp_DE_Acquisition_Info_DEF_browse__enterButton_1.setText("Enter")
            ...
            small = int(self.DE_Acquisition_Info_DEF_List[i][j][k][5].placeholderText()[-1])
            med = int(self.DE_Acquisition_Info_DEF_List[i][j][k][5].placeholderText()[-2])
            big = int(self.DE_Acquisition_Info_DEF_List[i][j][k][5].placeholderText()[-3])

            self.DE_Acquisition_Info_DEF_Button_List[big][med][small][0].clicked.connect(
                lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(big, med, small))

            self.DE_Acquisition_Info_DEF_Button_List[big][med][small][1].clicked.connect(
                lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(big, med, small))

    def Load_AI_Report(self, i, data):
        if i == 0:
            id = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['id']
            type = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['type']
            subtype = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['subtype']
            mgmt_id = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'equipment_management_id']
            submission_agency = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'submission_agency']
            report_creation_datetime = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'report_creation_datetime']
            division_name_of_report_maker = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'division_name_of_report_maker']
            team_name_of_report_maker = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'team_name_of_report_maker']
            file_name = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['file_name']
            file_size = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['file_size']
            file_path = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['file_path']
            file_creation_datetime = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'file_creation_datetime']
            file_description = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'file_description']
            hash_type = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['hash_type']
            hash_value = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)]['hash_value']
            ...
            tmp_AI_Reports__scrollAreaWidgetContents_1.setObjectName(
                "AI_Reports__scrollAreaWidgetContents_1")
            ...
            tmp_AI_Reports_type__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_subtype__horizontalLayout_1.setObjectName(
                "AI_Reports_subtype__horizontalLayout_1")
            ...
            tmp_AI_Reports_subtype__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_mgmt_id__horizontalLayout_1.setObjectName(
                "AI_Reports_mgmt_id__horizontalLayout_1")
            ...
            tmp_AI_Reports_mgmt_id__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_submission_agency__horizontalLayout_1.setObjectName(
                "AI_Reports_submission_agency__horizontalLayout_1")
            tmp_AI_Reports_submission_agency__label_1 = QtWidgets.QLabel(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            tmp_AI_Reports_submission_agency__label_1.setObjectName("AI_Reports_submission_agency__label_1")
            tmp_AI_Reports_submission_agency__horizontalLayout_1.addWidget(
                tmp_AI_Reports_submission_agency__label_1)
            ...
            tmp_AI_Reports_submission_agency__lineEdit_1.setObjectName(
                "AI_Reports_submission_agency__lineEdit_1")
            tmp_AI_Reports_submission_agency__horizontalLayout_1.addWidget(
                tmp_AI_Reports_submission_agency__lineEdit_1)
            ...
            tmp_AI_Reports_reprot_creation_datetime__label_1.setObjectName(
                "AI_Reports_reprot_creation_datetime__label_1")
            ...
            tmp_AI_Reports__verticalLayout_1.addLayout(
                tmp_AI_Reports_reports_creation_datetime__horizontalLayout_1)
            ...
            tmp_AI_Reports__verticalLayout_1.addLayout(
                tmp_AI_Reports_division_name_of_report_maker__horizontalLayout_1)
            ...
            tmp_AI_Reports__verticalLayout_1.addLayout(
                tmp_AI_Reports_team_name_of_report_maker__horizontalLayout_1)
            ...
            tmp_AI_Reports_file_info__horizontalLayout_1.setObjectName(
                "AI_Reports_file_info__horizontalLayout_1")
            ...
            tmp_AI_Reports_file_info__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_file_info__enterButton_1 = QtWidgets.QPushButton(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_file_name__horizontalLayout_1.setObjectName(
                "AI_Reports_file_name__horizontalLayout_1")
            ...
            tmp_AI_Reports_file_name__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_file_size__horizontalLayout_1.setObjectName(
                "AI_Reports_file_size__horizontalLayout_1")
            ...
            tmp_AI_Reports_file_size__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_file_path__horizontalLayout_1.setObjectName(
                "AI_Reports_file_path__horizontalLayout_1")
            ...
            tmp_AI_Reports_file_path__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            ...
            tmp_AI_Reports_file_creation_datetime__label_1.setObjectName(
                "AI_Reports_file_creation_datetime__label_1")
            ...
            tmp_AI_Reports__verticalLayout_1.addLayout(
                tmp_AI_Reports_file_creation_datetime__horizontalLayout_1)
            ...
            tmp_AI_Reports_file_description__horizontalLayout_1.setObjectName(
                "AI_Reports_file_description__horizontalLayout_1")
            tmp_AI_Reports_file_description__label_1 = QtWidgets.QLabel(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            tmp_AI_Reports_file_description__label_1.setObjectName("AI_Reports_file_description__label_1")
            tmp_AI_Reports_file_description__horizontalLayout_1.addWidget(
                tmp_AI_Reports_file_description__label_1)
            tmp_AI_Reports_file_description__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            tmp_AI_Reports_file_description__lineEdit_1.setObjectName(
                "AI_Reports_file_description__lineEdit_1")
            tmp_AI_Reports_file_description__horizontalLayout_1.addWidget(
                tmp_AI_Reports_file_description__lineEdit_1)
            ...
            tmp_AI_Reports_file_hash_type__horizontalLayout_1.setObjectName(
                "AI_Reports_file_hash_type__horizontalLayout_1")
            tmp_AI_Reports_file_hash_type__label_1 = QtWidgets.QLabel(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            tmp_AI_Reports_file_hash_type__label_1.setObjectName("AI_Reports_file_hash_type__label_1")
            tmp_AI_Reports_file_hash_type__horizontalLayout_1.addWidget(
                tmp_AI_Reports_file_hash_type__label_1)
            tmp_AI_Reports_file_hash_type__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            tmp_AI_Reports_file_hash_type__lineEdit_1.setObjectName("AI_Reports_file_hash_type__lineEdit_1")
            tmp_AI_Reports_file_hash_type__horizontalLayout_1.addWidget(
                tmp_AI_Reports_file_hash_type__lineEdit_1)
            ...
            tmp_AI_Reports_file_hash_value__horizontalLayout_1.setObjectName(
                "AI_Reports_file_hash_value__horizontalLayout_1")
            tmp_AI_Reports_file_hash_value__label_1 = QtWidgets.QLabel(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            tmp_AI_Reports_file_hash_value__label_1.setObjectName("AI_Reports_file_hash_value__label_1")
            tmp_AI_Reports_file_hash_value__horizontalLayout_1.addWidget(
                tmp_AI_Reports_file_hash_value__label_1)
            tmp_AI_Reports_file_hash_value__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_Reports__scrollAreaWidgetContents_1)
            tmp_AI_Reports_file_hash_value__lineEdit_1.setObjectName(
                "AI_Reports_file_hash_value__lineEdit_1")
            tmp_AI_Reports_file_hash_value__horizontalLayout_1.addWidget(
                tmp_AI_Reports_file_hash_value__lineEdit_1)
            ...
            tmp_ai_reports_len = len(self.AIReports_List) - 1
            ...
            self.AIReports_Button_List[i][0].clicked.connect(
                lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(tmp_ai_reports_len))

            self.AIReports_Button_List[i][1].clicked.connect(
                lambda: self.AI_Reports_file_info__enterButton_1_Calculate(tmp_ai_reports_len))
            # self.AIReports_Button_List[i][0].clicked.connect(lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(tmp_ai_reports_len))
            # #
            # self.AIReports_Button_List[i][1].clicked.connect(lambda: self.AI_Reports_file_info__enterButton_1_Calculate(tmp_ai_reports_len))

            # for fix in range (1, len(data['Digital Evidence Package']['Analysis Info']['Reports'])):
            #
            #     tmp_AI_Reports_file_info__browseButton_1.clicked.connect(lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(fix))
            #     #
            #     tmp_AI_Reports_file_info__enterButton_1.clicked.connect(lambda: self.AI_Reports_file_info__enterButton_1_Calculate(fix))
            #
            #
            #
            # # if i == 1:
            # #
            # #     tmp_AI_Reports_file_info__browseButton_1.clicked.connect(lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(1))
            # #
            # #     tmp_AI_Reports_file_info__enterButton_1.clicked.connect(lambda: self.AI_Reports_file_info__enterButton_1_Calculate(1))
            # #
            # # elif i == 2:
            # #     tmp_AI_Reports_file_info__browseButton_1.clicked.connect(
            # #         lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(2))
            # #
            # #     tmp_AI_Reports_file_info__enterButton_1.clicked.connect(
            # #         lambda: self.AI_Reports_file_info__enterButton_1_Calculate(2))
            # #
            # # elif i == 3:
            # #     tmp_AI_Reports_file_info__browseButton_1.clicked.connect(
            # #         lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(3))
            # #
            # #     tmp_AI_Reports_file_info__enterButton_1.clicked.connect(
            # #         lambda: self.AI_Reports_file_info__enterButton_1_Calculate(3))
            # #
            # # else:
            # #     pass
            ...
            tmp_AI_Reports_id__label_1.setText("보고서 관리 번호:")
            tmp_AI_Reports_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-SAIDAR-R001"))
            tmp_AI_Reports_type__label_1.setText("유형:")
            tmp_AI_Reports_type__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) REPORTS"))
            tmp_AI_Reports_subtype__label_1.setText("하위 유형:")
            tmp_AI_Reports_subtype__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) SAIDAR"))
            tmp_AI_Reports_mgmt_id__label_1.setText("장비 관리 고유 번호:")
            tmp_AI_Reports_mgmt_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-V001-D001"))
            ...
            tmp_AI_Reports_reprot_creation_datetime__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
            ...
            tmp_AI_Reports_file_creation_datetime__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 2022-02-03 15:47:53.384014+09:00"))
            tmp_AI_Reports_file_description__label_1.setText("파일 설명:")
            tmp_AI_Reports_file_description__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 보고서 PDF 파일"))
            ...
            report_creation_datetime = data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                'report_creation_datetime']
            division_name_of_report_maker = \
                data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                    'division_name_of_report_maker']
            team_name_of_report_maker = \
                data['Digital Evidence Package']['Analysis Info']['Reports'][str(i)][
                    'team_name_of_report_maker']
            ...
            tmp_AI_Reports_id__lineEdit_1.setText(id)
            tmp_AI_Reports_type__lineEdit_1.setText(type)
            tmp_AI_Reports_subtype__lineEdit_1.setText(subtype)
            tmp_AI_Reports_mgmt_id__lineEdit_1.setText(mgmt_id)
            tmp_AI_Reports_submission_agency__lineEdit_1.setText(submission_agency)
            tmp_AI_Reports_reprot_creation_datetime__lineEdit_1.setText(report_creation_datetime)
            tmp_AI_Reports_division_name_of_report_maker__lineEdit_1.setText(division_name_of_report_maker)
            tmp_AI_Reports_team_name_of_report_maker__lineEdit_1.setText(team_name_of_report_maker)
            tmp_AI_Reports_file_name__lineEdit_1.setText(file_name)
            tmp_AI_Reports_file_size__lineEdit_1.setText(file_size)
            tmp_AI_Reports_file_path__lineEdit_1.setText(file_path)
            tmp_AI_Reports_file_creation_datetime__lineEdit_1.setText(file_creation_datetime)
            tmp_AI_Reports_file_description__lineEdit_1.setText(file_description)
            tmp_AI_Reports_file_hash_type__lineEdit_1.setText(hash_type)
            tmp_AI_Reports_file_hash_value__lineEdit_1.setText(hash_value)

    def Load_AI_Equipment(self, i, data):
        if i == 0:
            id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)]['id']
            type = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)]['type']
            description = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)][
                'description']
            mgmt_id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)][
                'equipment_traces_management_id']
            vessel_id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)][
                'vessel_id']
            evidence_id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)][
                'evidence_id']
            power_on_time = \
                data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)][
                    'power_on_time']
            ...
            track_deletion_trace = \
                data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)][
                    'track_deletion_trace']
            trace_notes = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][str(i)][
                'trace_notes']
            ...
            tmp_AI_EquipmentTraces__horizontalLayout_1.setObjectName(
                "AI_EquipmentTraces__horizontalLayout_1")
            ...
            tmp_AI_EquipmentTraces__scrollAreaWidgetContents_1.setObjectName(
                "AI_EquipmentTraces__scrollAreaWidgetContents_1")
            ...
            tmp_AI_EquipmentTraces_id__horizontalLayout_1.setObjectName(
                "AI_EquipmentTraces_id__horizontalLayout_1")
            tmp_AI_EquipmentTraces_id__label_1 = QtWidgets.QLabel(
                tmp_AI_EquipmentTraces__scrollAreaWidgetContents_1)
            ...
            tmp_AI_EquipmentTraces__verticalLayout_1.addLayout(
                tmp_AI_EquipmentTraces_id__horizontalLayout_1)
            ...
            tmp_AI_EquipmentTraces_type__horizontalLayout_1.setObjectName(
                "AI_EquipmentTraces_type__horizontalLayout_1")
            tmp_AI_EquipmentTraces_type__label_1 = QtWidgets.QLabel(
                tmp_AI_EquipmentTraces__scrollAreaWidgetContents_1)
            ...
            tmp_AI_EquipmentTraces_type__horizontalLayout_1.addWidget(
                tmp_AI_EquipmentTraces_type__lineEdit_1)
            tmp_AI_EquipmentTraces__verticalLayout_1.addLayout(
                tmp_AI_EquipmentTraces_type__horizontalLayout_1)
            ...
            tmp_AI_EquipmentTraces_description__label_1.setObjectName(
                "AI_EquipmentTraces_description__label_1")
            ...
            tmp_AI_EquipmentTraces_description__lineEdit_1.setObjectName(
                "AI_EquipmentTraces_description__lineEdit_1")
            tmp_AI_EquipmentTraces_description__horizontalLayout_1.addWidget(
                tmp_AI_EquipmentTraces_description__lineEdit_1)
            tmp_AI_EquipmentTraces__verticalLayout_1.addLayout(
                tmp_AI_EquipmentTraces_description__horizontalLayout_1)
            ...
            tmp_AI_EquipmentTraces_mgmt_id__horizontalLayout_1.addWidget(
                tmp_AI_EquipmentTraces_mgmt_id__label_1)
            tmp_AI_EquipmentTraces_mgmt_id__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI_EquipmentTraces__scrollAreaWidgetContents_1)
            tmp_AI_EquipmentTraces_mgmt_id__lineEdit_1.setObjectName(
                "AI_EquipmentTraces_mgmt_id__lineEdit_1")
            tmp_AI_EquipmentTraces_mgmt_id__horizontalLayout_1.addWidget(
                tmp_AI_EquipmentTraces_mgmt_id__lineEdit_1)
            tmp_AI_EquipmentTraces__verticalLayout_1.addLayout(
                tmp_AI_EquipmentTraces_mgmt_id__horizontalLayout_1)
            ...
            tmp_AI_EquipmentTraces_vessel_id__horizontalLayout_1.addWidget(
                tmp_AI_EquipmentTraces_vessel_id__label_1)
            ...
            tmp_AI_EquipmentTraces_vessel_id__lineEdit_1.setObjectName(
                "AI_EquipmentTraces_vessel_id__lineEdit_1")
            tmp_AI_EquipmentTraces_vessel_id__horizontalLayout_1.addWidget(
                tmp_AI_EquipmentTraces_vessel_id__lineEdit_1)
            tmp_AI_EquipmentTraces__verticalLayout_1.addLayout(
                tmp_AI_EquipmentTraces_vessel_id__horizontalLayout_1)
            ...
            tmp_AI_EquipmentTraces_evidence_id__label_1.setObjectName(
                "AI_EquipmentTraces_evidence_id__label_1")
            ...
            tmp_AI_EquipmentTraces_evidence_id__lineEdit_1.setObjectName(
                "AI_EquipmentTraces_evidence_id__lineEdit_1")
            tmp_AI_EquipmentTraces_evidence_id__horizontalLayout_1.addWidget(
                tmp_AI_EquipmentTraces_evidence_id__lineEdit_1)
            tmp_AI_EquipmentTraces__verticalLayout_1.addLayout(
                tmp_AI_EquipmentTraces_evidence_id__horizontalLayout_1)
            ...
            tmp_AI_EquipmentTraces_user_trace_info__label_1.setObjectName(
                "AI_EquipmentTraces_user_trace_info__label_1")
            ...
            tmp_gridLayout_14.addLayout(tmp_AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1, 0, 0,
                                        1, 1)
            ...
            tmp_AI_EquipmentTraces__scrollArea_1.setWidget(
                tmp_AI_EquipmentTraces__scrollAreaWidgetContents_1)
            ...
            tmp_AI_EquipmentTraces__label_1.setText("장비 추적 (장비별로)")
            tmp_AI_EquipmentTraces_id__label_1.setText("장비 추적 관리 번호:")
            tmp_AI_EquipmentTraces_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-V001-D001-T001"))
            tmp_AI_EquipmentTraces_type__label_1.setText("유형:")
            tmp_AI_EquipmentTraces_type__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) TRACE"))
            tmp_AI_EquipmentTraces_description__label_1.setText("유형 설명:")
            tmp_AI_EquipmentTraces_description__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) TRACE"))
            tmp_AI_EquipmentTraces_mgmt_id__label_1.setText("장비 아이디:")
            tmp_AI_EquipmentTraces_mgmt_id__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) D20220203-V001-D001"))
            tmp_AI_EquipmentTraces_vessel_id__label_1.setText("선박 관리 번호:")
            tmp_AI_EquipmentTraces_vessel_id__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) D20220203-V001"))
            tmp_AI_EquipmentTraces_evidence_id__label_1.setText("증거 관리 번호:")
            tmp_AI_EquipmentTraces_evidence_id__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) D20220203-V001-D001-I001"))
            ...
            tmp_AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
            tmp_AI_EquipmentTraces_user_trace_info_track_extractopm_description__label_1.setText(
                "항적 추출 방법:")
            ...
            tmp_AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1.setPlaceholderText(
                _translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
            ...
            tmp_AI_EquipmentTraces_id__lineEdit_1.setText(id)
            tmp_AI_EquipmentTraces_type__lineEdit_1.setText(type)
            tmp_AI_EquipmentTraces_description__lineEdit_1.setText(type)
            tmp_AI_EquipmentTraces_mgmt_id__lineEdit_1.setText(mgmt_id)
            tmp_AI_EquipmentTraces_vessel_id__lineEdit_1.setText(vessel_id)
            tmp_AI_EquipmentTraces_evidence_id__lineEdit_1.setText(evidence_id)
            tmp_AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1.setText(power_on_time)
            tmp_AI_EquipmentTraces_user_trace_info_track_extractopm_description__lineEdit_1.setText(
                track_extraction_description)
            tmp_AI_EquipmentTraces_user_trace_info_system_description__lineEdit_1.setText(system_info_description)
            tmp_AI_EquipmentTraces_user_trace_info_system_operation_status__lineEdit_1.setText(system_info_description)
            tmp_AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1.setText(power_off_time)
            tmp_AI_EquipmentTraces_user_trace_info_track_recording_period__lineEdit_1.setText(track_recording_period)
            tmp_AI_EquipmentTraces_user_trace_info_track_deletion_trace__lineEdit_1.setText(track_deletion_trace)
            tmp_AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_1.setText(trace_notes)

    def Load_AI_Other(self, i, data):
        if i == 0:
            id = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)]['id']
            type = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)]['type']
            file_size = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)]['file_size']
            file_path = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)]['file_path']
            file_hash_type = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
                'file_hash_type']
            file_hash_value = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
                'file_hash_value']
            file_description = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
                'file_description']
            file_metadata = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
                'file_metadata']
            ...
            tmp_AI_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_browse__label_1)
            tmp_AI_Other_Files_file_browse__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI__scrollAreaWidgetContents)
            tmp_AI_Other_Files_file_browse__lineEdit_1.setObjectName(
                "AI_Other_Files_file_browse__lineEdit_1")
            tmp_AI_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_browse__lineEdit_1)
            tmp_AI_Other_Files_file_browse__browseButton_1 = QtWidgets.QPushButton(
                tmp_AI__scrollAreaWidgetContents)
            tmp_AI_Other_Files_file_browse__browseButton_1.setObjectName(
                "AI_Other_Files_file_browse__browseButton_1")
            tmp_AI_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_browse__browseButton_1)
            tmp_AI_Other_Files_file_browse__enterButton_1 = QtWidgets.QPushButton(
                tmp_AI__scrollAreaWidgetContents)
            tmp_AI_Other_Files_file_browse__enterButton_1.setObjectName(
                "AI_Other_Files_file_browse__enterButton_1")
            tmp_AI_Other_Files_file_browse__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_browse__enterButton_1)
            tmp_AI_Other_Files__verticalLayout_1.addLayout(
                tmp_AI_Other_Files_file_browse__horizontalLayout_1)
            ...
            tmp_AI_Other_Files_type__horizontalLayout_1.setObjectName(
                "AI_Other_Files_type__horizontalLayout_1")
            ...
            tmp_AI_Other_Files_file_size__horizontalLayout_1.setObjectName(
                "AI_Other_Files_file_size__horizontalLayout_1")
            ...
            tmp_AI_Other_Files_file_size__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_size__label_1)
            ...
            tmp_AI_Other_Files_file_size__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_size__lineEdit_1)
            ...
            tmp_AI_Other_Files_file_path__horizontalLayout_1.setObjectName(
                "AI_Other_Files_file_path__horizontalLayout_1")
            ...
            tmp_AI_Other_Files_file_path__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_path__label_1)
            ...
            tmp_AI_Other_Files_file_path__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_path__lineEdit_1)
            ...
            tmp_AI_Other_Files_file_hash_type__label_1.setObjectName(
                "AI_Other_Files_file_hash_type__label_1")
            tmp_AI_Other_Files_file_hash_type__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_hash_type__label_1)
            tmp_AI_Other_Files_file_hash_type__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI__scrollAreaWidgetContents)
            tmp_AI_Other_Files_file_hash_type__lineEdit_1.setObjectName(
                "AI_Other_Files_file_hash_type__lineEdit_1")
            tmp_AI_Other_Files_file_hash_type__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_hash_type__lineEdit_1)
            tmp_AI_Other_Files__verticalLayout_1.addLayout(
                tmp_AI_Other_Files_file_hash_type__horizontalLayout_1)
            ...
            tmp_AI_Other_Files_file_metadata__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_metadata__label_1)
            tmp_AI_Other_Files_file_metadata__lineEdit_1 = QtWidgets.QLineEdit(
                tmp_AI__scrollAreaWidgetContents)
            tmp_AI_Other_Files_file_metadata__lineEdit_1.setObjectName(
                "AI_Other_Files_file_metadata__lineEdit_1")
            tmp_AI_Other_Files_file_metadata__horizontalLayout_1.addWidget(
                tmp_AI_Other_Files_file_metadata__lineEdit_1)
            tmp_AI_Other_Files__verticalLayout_1.addLayout(
                tmp_AI_Other_Files_file_metadata__horizontalLayout_1)
            ...
            tmp_ai_other_len = len(self.AI_List) - 1
            ...
            self.AI_Other_Files_Button_List[i][0].clicked.connect(
                lambda: self.AI_Other_Files_file_browse__browseButton_1_QFileDialog(tmp_ai_other_len))

            self.AI_Other_Files_Button_List[i][1].clicked.connect(
                lambda: self.AI_Other_Files_file_browse__enterButton_1_Calculate(tmp_ai_other_len))
            ...
            tmp_AI_Other_Files_id__label_1.setText("기타 파일 관리 번호:")
            ...
            id = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)]['id']
            type = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)]['type']
            file_size = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
                'file_size']
            file_path = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
                'file_path']
            file_hash_type = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
                'file_hash_type']
            file_hash_value = data['Digital Evidence Package']['Analysis Info']['Other Files'][str(i)][
            ...
            tmp_AI_Other_Files_id__lineEdit_1.setText(id)
            tmp_AI_Other_Files_type__lineEdit_1.setText(type)
            tmp_AI_Other_Files_file_size__lineEdit_1.setText(file_size)
            tmp_AI_Other_Files_file_path__lineEdit_1.setText(file_path)
            tmp_AI_Other_Files_file_hash_type__lineEdit_1.setText(file_hash_type)
            tmp_AI_Other_Files_file_hash_value__lineEdit_1.setText(file_hash_value)
            tmp_AI_Other_Files_file_description__lineEdit_1.setText(file_description)
            tmp_AI_Other_Files_file_metadata__lineEdit_1.setText(file_metadata)

    def New_XML(self):

        digital_evidence_pack = Element("digital_evidence_pack")

        management = Element("management")
        digital_evidence_pack.append(management)

        digital_evidence_pack_management_identifier = Element("digital_evidence_pack_management_identifier")
        digital_evidence_pack_management_identifier.text = self.CI_List[0].text()
        management.append(digital_evidence_pack_management_identifier)


        digital_evidence_pack_format_version = Element("digital_evidence_pack_format_version")
        digital_evidence_pack_format_version.text = "0.1"
        management.append(digital_evidence_pack_format_version)

        digital_evidence_pack_size_numeric = Element("digital_evidence_pack_size_numeric")
        digital_evidence_pack_size_numeric.text = "?"
        management.append(digital_evidence_pack_size_numeric)

        #

        agency = Element("agency")
        digital_evidence_pack.append(agency)

        digital_evidence_pack_agency_incident = Element("digital_evidence_pack_agency_incident")
        digital_evidence_pack_agency_incident.text = self.CI_List[1].text()
        agency.append(digital_evidence_pack_agency_incident)

        digital_evidence_pack_agency_organization_code = Element("digital_evidence_pack_agency_organization_code")
        digital_evidence_pack_agency_organization_code.text = self.CI_List[2].text()
        agency.append(digital_evidence_pack_agency_organization_code)

        digital_evidence_pack_agency_organization_name = Element("digital_evidence_pack_agency_organization_name")
        digital_evidence_pack_agency_organization_name.text = self.CI_List[3].text()
        agency.append(digital_evidence_pack_agency_organization_name)

        digital_evidence_pack_agency_organization_party_name = Element("digital_evidence_pack_agency_organization_party_name")
        digital_evidence_pack_agency_organization_party_name.text = self.CI_List[4].text()
        agency.append(digital_evidence_pack_agency_organization_party_name)

        #DE 시작

        digital_evidence = Element("digital_evidence")
        digital_evidence_pack.append(digital_evidence)

        digital_evidence_count = Element("DE_" + "1")
        digital_evidence.append(digital_evidence_count)

        information = Element("information")
        digital_evidence_count.append(information)

        digital_evidence_serial_no = Element("digital_evidence_serial_no")
        digital_evidence_serial_no.text = self.DE_AddAll_List[0][17].text()
        information.append(digital_evidence_serial_no)
        # # #
        digital_evidence_gather = Element("digital_evidence_gather")
        information.append(digital_evidence_gather)
        # #
        digital_evidence_gather_information = Element("digital_evidence_gather_information")
        digital_evidence_gather.append(digital_evidence_gather_information)
        #
        gather_date_time = Element("gather_date_time")
        gather_date_time.text = self.DE_AddAll_List[0][21].text()
        digital_evidence_gather_information.append(gather_date_time)

        gather_location = Element("gather_location")
        digital_evidence_gather_information.append(gather_location)

        location_name = Element("location_name")
        location_name.text = self.DE_AddAll_List[0][18].text()
        gather_location.append(location_name)

        gather_person = Element("gather_person")
        digital_evidence_gather_information.append(gather_person)

        gather_organization_person_name = Element("gather_organization_person_name")
        gather_organization_person_name.text = self.DE_AddAll_List[0][20].text()
        gather_person.append(gather_organization_person_name)

        gather_organization_code = Element("gather_organization_code")
        gather_organization_code.text = self.DE_AddAll_List[0][24].text()
        gather_person.append(gather_organization_code)

        gather_organization_name = Element("gather_organization_name")
        gather_organization_name.text = self.DE_AddAll_List[0][22].text()
        gather_person.append(gather_organization_name)

        gather_source = Element("gather_source")
        digital_evidence_gather_information .append(gather_source)

        gather_source_name = Element("gather_source_name")
        gather_source_name.text = self.DE_AddAll_List[0][26].text()
        gather_source.append(gather_source_name)

        gather_relation_person = Element("gather_relation_person")
        digital_evidence_gather_information.append(gather_relation_person)

        gather_relation_person_name = Element("gather_relation_person_name")
        gather_relation_person_name.text = self.DE_AddAll_List[0][25].text() #
        gather_relation_person.append(gather_relation_person_name)

        gather_relation_person_type_code = Element("gather_relation_person_type_code")
        gather_relation_person_type_code.text = self.DE_AddAll_List[0][27].text()
        gather_relation_person.append(gather_relation_person_type_code)

        gather_authentication = Element("gather_authentication")
        digital_evidence_gather_information.append(gather_authentication)

        digital_evidence_gather_file = Element("digital_evidence_gather_file")
        digital_evidence_gather.append(digital_evidence_gather_file)

        file_meta = Element("file_meta")
        digital_evidence_gather_file.append(file_meta)

        name = Element("name")
        file_path = self.DE_AddAll_List[0][28].text()
        file_name = file_path[file_path.rfind("/") + 1:]
        name.text = file_name
        file_meta.append(name)

        size_numeric = Element("size_numeric")
        size_numeric.text = self.DE_AddAll_List[0][33].text()
        file_meta.append(size_numeric)

        file_data = Element("File_Data")
        digital_evidence_gather_file.append(file_data)

        digital_evidence_type_code = Element("digital_evidence_type_code")
        digital_evidence_type_code.text = self.DE_AddAll_List[0][29].text()
        information.append(digital_evidence_type_code)

        digital_evidence_file = Element("digital_evidence_file")
        information.append(digital_evidence_file)

        #
        def_1 = Element("def_1")
        digital_evidence_file.append(def_1)

        file_meta = Element("file_meta")
        def_1.append(file_meta)

        name = Element("name")
        name.text = self.DE_AddAll_List[0][57].text()
        file_meta.append(name)

        size_numeric = Element("size_numeric")
        size_numeric.text = self.DE_AddAll_List[0][62].text()
        file_meta.append(size_numeric)

        file_data = Element("file_data")
        file_data.text = self.DE_AddAll_List[0][58].text()
        def_1.append(file_data)

        if len(self.DE_Acquisition_Info_DEF_List[0]) > 1:
            for a in range (1, len(self.DE_Acquisition_Info_DEF_List[0])):
                def_ = Element("def_" + str(a+1))
                digital_evidence_file.append(def_)

                file_meta = Element("file_meta")
                def_.append(file_meta)

                name = Element("name")
                name.text = self.DE_Acquisition_Info_DEF_List[0][a][0][6].text()
                file_meta.append(name)

                size_numeric = Element("size_numeric")
                size_numeric.text = self.DE_Acquisition_Info_DEF_List[0][a][0][11].text()
                file_meta.append(size_numeric)

                file_data = Element("file_data")
                file_data.text = self.DE_Acquisition_Info_DEF_List[0][a][0][7].text()
                def_.append(file_data)

        #

        digital_evidence_authentication = Element("digital_evidence_authentication")
        information.append(digital_evidence_authentication)

        digital_evidence_authentication_information = Element("digital_evidence_authentication_information")
        digital_evidence_authentication.append(digital_evidence_authentication_information)

        #

        digital_evidence_authentication_information_count = Element("deai_count_"+str(1))
        digital_evidence_authentication_information.append(digital_evidence_authentication_information_count)

        authentication_person = Element("authentication_person")
        digital_evidence_authentication_information_count.append(authentication_person)

        authentication_organization_person_name = Element("authentication_organization_person_name")
        authentication_organization_person_name.text = self.DE_AddAll_List[0][45].text()
        authentication_person.append(authentication_organization_person_name)

        authentication_organization_party_name = Element("authentication_organization_party_name")
        authentication_organization_party_name.text = self.DE_AddAll_List[0][50].text()
        authentication_person.append(authentication_organization_party_name)

        authentication_location = Element("authentication_location")
        digital_evidence_authentication_information_count.append(authentication_location)

        location_name = Element("location_name")
        location_name.text = self.DE_AddAll_List[0][47].text()
        authentication_location.append(location_name)

        authentication_tool = Element("authentication_tool")
        digital_evidence_authentication_information_count.append(authentication_tool)

        authentication_tool_name = Element("authentication_tool_name")
        authentication_tool_name.text = self.DE_AddAll_List[0][48].text()
        authentication_tool.append(authentication_tool_name)

        authentication_tool_version = Element("authentication_tool_version")
        authentication_tool_version.text = self.DE_AddAll_List[0][49].text()
        authentication_tool.append(authentication_tool_version)

        authentiation_hash_type_code = Element("Authentiation_Hash_Type_Code")
        authentiation_hash_type_code.text = self.DE_AddAll_List[0][59].text()
        digital_evidence_authentication_information_count.append(authentiation_hash_type_code)

        authentication_hash = Element("authentication_hash")
        digital_evidence_authentication_information_count.append(authentication_hash)

        authentication_hash_value = Element("Authentication_Hash_Value")
        authentication_hash_value.text = self.DE_AddAll_List[0][60].text()
        authentication_hash.append(authentication_hash_value)

        #
        if len(self.DE_Acquisition_Info_List[0]) > 1:
            for a in range (1, len(self.DE_Acquisition_Info_List[0])):

                digital_evidence_authentication_information_count = Element("deai_count_" + str(a+1))
                digital_evidence_authentication_information.append(digital_evidence_authentication_information_count)
                ...
                authentication_organization_person_name = Element("authentication_organization_person_name")
                authentication_organization_person_name.text = self.DE_Acquisition_Info_List[0][a][1].text()
                authentication_person.append(authentication_organization_person_name)

                authentication_organization_party_name = Element("authentication_organization_party_name")
                authentication_organization_party_name.text = self.DE_Acquisition_Info_List[0][a][6].text()
                authentication_person.append(authentication_organization_party_name)
                ...
                location_name = Element("location_name")
                location_name.text = self.DE_Acquisition_Info_List[0][a][3].text()
                authentication_location.append(location_name)
                ...
                authentication_tool_name = Element("authentication_tool_name")
                authentication_tool_name.text = self.DE_Acquisition_Info_List[0][a][4].text()
                authentication_tool.append(authentication_tool_name)

                authentication_tool_version = Element("authentication_tool_version")
                authentication_tool_version.text = self.DE_Acquisition_Info_List[0][a][5].text()
                authentication_tool.append(authentication_tool_version)

                authentiation_hash_type_code = Element("Authentiation_Hash_Type_Code")
                authentiation_hash_type_code.text = self.DE_Acquisition_Info_DEF_List[0][a][0][8].text()
                digital_evidence_authentication_information_count.append(authentiation_hash_type_code)
                ...
                authentication_hash_value = Element("Authentication_Hash_Value")
                authentication_hash_value.text = self.DE_Acquisition_Info_DEF_List[0][a][0][9].text()
                authentication_hash.append(authentication_hash_value)
        ...
        digital_evidence_authentication_file = Element("digital_evidence_authentication_file")
        digital_evidence_authentication_information_count.append(digital_evidence_authentication_file)

        defa = Element("DEFA_1")
        digital_evidence_authentication_file.append(defa)

        file_meta = Element("file_meta")
        defa.append(file_meta)

        name = Element("name")
        file_path = self.DE_Other_Files_List[0][0][0].text()
        file_name = file_path[file_path.rfind("/") + 1:]
        name.text = file_name
        file_meta.append(name)

        size_numeric = Element("size_numeric")
        size_numeric.text = self.DE_AddAll_List[0][38].text()
        file_meta.append(size_numeric)

        file_data = Element("file_data")
        file_data.text = self.DE_AddAll_List[0][39].text()
        defa.append(file_data)

        if len(self.DE_Other_Files_List[0]) > 1:
            for a in range (1, len(self.DE_Other_Files_List[0])):

                defa = Element("DEFA_" + str(a+1))
                digital_evidence_authentication_file.append(defa)
                ...
                name = Element("name")
                file_path = self.DE_Other_Files_List[0][a][0].text()
                file_name = file_path[file_path.rfind("/") + 1:]
                name.text = file_name
                file_meta.append(name)

                size_numeric = Element("size_numeric")
                size_numeric.text = self.DE_Other_Files_List[0][a][3].text()
                file_meta.append(size_numeric)

                file_data = Element("file_data")
                file_data.text = self.DE_Other_Files_List[0][a][4].text()
                defa.append(file_data)


        #만약 큰탭이 늘어난다면

        if len(self.DE_AddAll_List) > 1:

            for b in range (1, len(self.DE_AddAll_List)):

                digital_evidence_count = Element("DE_" + str(b+1))
                digital_evidence.append(digital_evidence_count)
                ...
                digital_evidence_serial_no = Element("digital_evidence_serial_no")
                digital_evidence_serial_no.text = self.DE_AddAll_List[b][17].text()
                information.append(digital_evidence_serial_no)
                # # #
                digital_evidence_gather = Element("digital_evidence_gather")
                information.append(digital_evidence_gather)
                ...
                #
                gather_date_time = Element("gather_date_time")
                gather_date_time.text = self.DE_AddAll_List[b][21].text()
                digital_evidence_gather_information.append(gather_date_time)
                ...
                location_name = Element("location_name")
                location_name.text = self.DE_AddAll_List[b][18].text()
                gather_location.append(location_name)
                ...
                gather_organization_person_name = Element("gather_organization_person_name")
                gather_organization_person_name.text = self.DE_AddAll_List[b][20].text()
                gather_person.append(gather_organization_person_name)

                gather_organization_code = Element("gather_organization_code")
                gather_organization_code.text = self.DE_AddAll_List[b][24].text()
                gather_person.append(gather_organization_code)

                gather_organization_name = Element("gather_organization_name")
                gather_organization_name.text = self.DE_AddAll_List[b][22].text()
                gather_person.append(gather_organization_name)
                ...
                gather_source_name = Element("gather_source_name")
                gather_source_name.text = self.DE_AddAll_List[b][26].text()
                gather_source.append(gather_source_name)
                ...
                gather_relation_person_name = Element("gather_relation_person_name")
                gather_relation_person_name.text = self.DE_AddAll_List[b][25].text()  #
                gather_relation_person.append(gather_relation_person_name)

                gather_relation_person_type_code = Element("gather_relation_person_type_code")
                gather_relation_person_type_code.text = self.DE_AddAll_List[b][27].text()
                gather_relation_person.append(gather_relation_person_type_code)
                ...
                name = Element("name")
                file_path = self.DE_AddAll_List[b][28].text()
                file_name = file_path[file_path.rfind("/") + 1:]
                name.text = file_name
                file_meta.append(name)

                size_numeric = Element("size_numeric")
                size_numeric.text = self.DE_AddAll_List[b][33].text()
                file_meta.append(size_numeric)
                ...
                digital_evidence_type_code = Element("digital_evidence_type_code")
                digital_evidence_type_code.text = self.DE_AddAll_List[b][29].text()
                information.append(digital_evidence_type_code)
                ...
                name = Element("name")
                name.text = self.DE_AddAll_List[b][57].text()
                file_meta.append(name)

                size_numeric = Element("size_numeric")
                size_numeric.text = self.DE_AddAll_List[b][62].text()
                file_meta.append(size_numeric)

                file_data = Element("file_data")
                file_data.text = self.DE_AddAll_List[b][58].text()
                def_1.append(file_data)

                if len(self.DE_Acquisition_Info_DEF_List[b]) > 1:
                    for a in range(1, len(self.DE_Acquisition_Info_DEF_List[b])):
                        def_ = Element("def_" + str(a + 1))
                        digital_evidence_file.append(def_)
                        ...
                        name = Element("name")
                        name.text = self.DE_Acquisition_Info_DEF_List[b][a][0][6].text()
                        file_meta.append(name)

                        size_numeric = Element("size_numeric")
                        size_numeric.text = self.DE_Acquisition_Info_DEF_List[b][a][0][11].text()
                        file_meta.append(size_numeric)

                        file_data = Element("file_data")
                        file_data.text = self.DE_Acquisition_Info_DEF_List[b][a][0][7].text()
                        def_.append(file_data)
                ...
                authentication_organization_person_name = Element("authentication_organization_person_name")
                authentication_organization_person_name.text = self.DE_AddAll_List[b][45].text()
                authentication_person.append(authentication_organization_person_name)

                authentication_organization_party_name = Element("authentication_organization_party_name")
                authentication_organization_party_name.text = self.DE_AddAll_List[b][50].text()
                authentication_person.append(authentication_organization_party_name)
                ...
                location_name = Element("location_name")
                location_name.text = self.DE_AddAll_List[b][47].text()
                authentication_location.append(location_name)
                ...
                authentication_tool_name = Element("authentication_tool_name")
                authentication_tool_name.text = self.DE_AddAll_List[b][48].text()
                authentication_tool.append(authentication_tool_name)

                authentication_tool_version = Element("authentication_tool_version")
                authentication_tool_version.text = self.DE_AddAll_List[b][49].text()
                authentication_tool.append(authentication_tool_version)

                authentiation_hash_type_code = Element("Authentiation_Hash_Type_Code")
                authentiation_hash_type_code.text = self.DE_AddAll_List[b][59].text()
                digital_evidence_authentication_information_count.append(authentiation_hash_type_code)
                ...
                authentication_hash_value = Element("Authentication_Hash_Value")
                authentication_hash_value.text = self.DE_AddAll_List[b][60].text()
                authentication_hash.append(authentication_hash_value)

                #
                if len(self.DE_Acquisition_Info_List[b]) > 1:
                    for a in range(1, len(self.DE_Acquisition_Info_List[b])):
                        digital_evidence_authentication_information_count = Element("deai_count_" + str(a + 1))
                        digital_evidence_authentication_information.append(
                            digital_evidence_authentication_information_count)

                        authentication_person = Element("authentication_person")
                        digital_evidence_authentication_information_count.append(authentication_person)

                        authentication_organization_person_name = Element("authentication_organization_person_name")
                        authentication_organization_person_name.text = self.DE_Acquisition_Info_List[b][a][1].text()
                        authentication_person.append(authentication_organization_person_name)

                        authentication_organization_party_name = Element("authentication_organization_party_name")
                        authentication_organization_party_name.text = self.DE_Acquisition_Info_List[b][a][6].text()
                        authentication_person.append(authentication_organization_party_name)
                        ...
                        location_name = Element("location_name")
                        location_name.text = self.DE_Acquisition_Info_List[b][a][3].text()
                        authentication_location.append(location_name)
                        ...
                        authentication_tool_name = Element("authentication_tool_name")
                        authentication_tool_name.text = self.DE_Acquisition_Info_List[b][a][4].text()
                        authentication_tool.append(authentication_tool_name)

                        authentication_tool_version = Element("authentication_tool_version")
                        authentication_tool_version.text = self.DE_Acquisition_Info_List[b][a][5].text()
                        authentication_tool.append(authentication_tool_version)

                        authentiation_hash_type_code = Element("Authentiation_Hash_Type_Code")
                        authentiation_hash_type_code.text = self.DE_Acquisition_Info_DEF_List[b][a][0][8].text()
                        digital_evidence_authentication_information_count.append(authentiation_hash_type_code)
                        ...
                        authentication_hash_value = Element("Authentication_Hash_Value")
                        authentication_hash_value.text = self.DE_Acquisition_Info_DEF_List[b][a][0][9].text()
                        authentication_hash.append(authentication_hash_value)
                ...
                name = Element("name")
                file_path = self.DE_Other_Files_List[b][0][0].text()
                file_name = file_path[file_path.rfind("/") + 1:]
                name.text = file_name
                file_meta.append(name)

                size_numeric = Element("size_numeric")
                size_numeric.text = self.DE_AddAll_List[b][38].text()
                file_meta.append(size_numeric)

                file_data = Element("file_data")
                file_data.text = self.DE_AddAll_List[b][39].text()
                defa.append(file_data)

                if len(self.DE_Other_Files_List[b]) > 1:
                    for a in range(1, len(self.DE_Other_Files_List[b])):
                        defa = Element("DEFA_" + str(a + 1))
                        digital_evidence_authentication_file.append(defa)
                        ...
                        name = Element("name")
                        file_path = self.DE_Other_Files_List[b][a][0].text()
                        file_name = file_path[file_path.rfind("/") + 1:]
                        name.text = file_name
                        file_meta.append(name)

                        size_numeric = Element("size_numeric")
                        size_numeric.text = self.DE_Other_Files_List[b][a][3].text()
                        file_meta.append(size_numeric)

                        file_data = Element("file_data")
                        file_data.text = self.DE_Other_Files_List[b][a][4].text()
                        defa.append(file_data)

        #

        history = Element("history")
        digital_evidence_pack.append(history)

        history_count = Element("history_1")
        history.append(history_count)

        digital_evidence_pack_history_type_code = Element("digital_evidence_pack_history_type_code")
        digital_evidence_pack_history_type_code.text = self.Log_List[0][4].text()
        history_count.append(digital_evidence_pack_history_type_code)

        digital_evidence_pack_history_star_date_time = Element("digital_evidence_pack_history_star_date_time")
        digital_evidence_pack_history_star_date_time.text = self.Log_List[0][1].text()
        history_count.append(digital_evidence_pack_history_star_date_time)

        digital_evidence_pack_history_end_date_time = Element("digital_evidence_pack_history_end_date_time")
        digital_evidence_pack_history_end_date_time.text = self.Log_List[0][3].text()
        history_count.append(digital_evidence_pack_history_end_date_time)

        if len(self.Log_List) > 1:
           for a in range (1, len(self.Log_List)):
               history_count = Element("history_1")
               history.append(history_count)

               digital_evidence_pack_history_type_code = Element("digital_evidence_pack_history_type_code")
               digital_evidence_pack_history_type_code.text = self.Log_List[a][4].text()
               history_count.append(digital_evidence_pack_history_type_code)

               digital_evidence_pack_history_star_date_time = Element("digital_evidence_pack_history_star_date_time")
               digital_evidence_pack_history_star_date_time.text = self.Log_List[a][1].text()
               history_count.append(digital_evidence_pack_history_star_date_time)

               digital_evidence_pack_history_end_date_time = Element("digital_evidence_pack_history_end_date_time")
               digital_evidence_pack_history_end_date_time.text = self.Log_List[a][3].text()
               history_count.append(digital_evidence_pack_history_end_date_time)




        xmlstr = minidom.parseString(ET.tostring(digital_evidence_pack)).toprettyxml(indent="  ")

        with open('digital_evidence_pack.xml', 'w') as f:
            f.write(xmlstr)

        self.MessageBox_KS("KS 증거팩 파일 생성이 완료되었습니다.")

    def MessageBox_KS(self, str):
        msg = QMessageBox()
        msg.setText(str)
        msg.setWindowTitle("완료")
        msg.setIcon(QMessageBox.Information)
        # msg.setWindowIcon(QIcon(resource_path('marine.png')))
        msg.setWindowIcon(QIcon(resource_path('Main/marine.png')))
        msg.exec_()

    def Easy_Export(self):

        datetime.datetime.today()
        datetime.datetime.now()
        now = datetime.datetime.now()
        self.Log_List[len(self.Log_List) - 1][3].setText(str(now))

        file_data = OrderedDict()

        # case info
        file_data["Digital Evidence Package"] = {"Case Info":
                                                     {"case_management_id": self.CI_List[0].text(),
            ...
            ,
                                                 "Digital Evidences": {0:
                                                                           {"Vessel Info":
                                                                                {"vessel_name": self.DE_AddAll_List[0][
                                                                                    0].text(),
                                                                                 "vessel_management_id":
                                                                                     self.DE_AddAll_List[0][1].text(),
                                                                                 "vessel_MMSI": self.DE_AddAll_List[0][
                                                                                     2].text(),
                                                                                 "vessel_callsign":
                                                                                     self.DE_AddAll_List[0][3].text(),
                                                                                 "vessel_IMO": self.DE_AddAll_List[0][
                                                                                     4].text(),
                                                                                 "vessel_MRN": self.DE_AddAll_List[0][
                                                                                     5].text(),
                                                                                 "vessel_tonnage":
                                                                                     self.DE_AddAll_List[0][6].text(),
                                                                                 "vessel_length":
                                                                                     self.DE_AddAll_List[0][7].text(),
                                                                                 "total_number_of_equipment_with_track":
                                                                                     self.DE_AddAll_List[0][8].text(),
                                                                                 "vessel_type": self.DE_AddAll_List[0][
                                                                                     9].text()
                                                                                 }

                                                                               ,

                                                                            'Marine Electronics Info':
                                                                                {"device_management_id":
                                                                                     self.DE_AddAll_List[0][10].text(),
                                                                                 "device_type": self.DE_AddAll_List[0][
                                                                                     11].text(),
                                                                                 "device_manufacturer":
                                                                                     self.DE_AddAll_List[0][12].text(),
                                                                                 "device_model_name":
                                                                                     self.DE_AddAll_List[0][13].text(),
                                                                                 "device_model_serial_number":
                                                                                     self.DE_AddAll_List[0][14].text(),
                                                                                 "device_os_firmware":
                                                                                     self.DE_AddAll_List[0][15].text(),
                                                                                 "device_description":
                                                                                     self.DE_AddAll_List[0][16].text()
                                                                                 }
                                                                               ,

                                                                            'Gather Info':
                                                                                {"gather_management_id":
                                                                                     self.DE_AddAll_List[0][17].text(),
                                                                                 "gather_location":
                                                                                     self.DE_AddAll_List[0][18].text(),

                                                                                 "gather_organization_party_name":
                                                                                    self.DE_AddAll_List[0][19].text(),

                                                                                 "gather_person_name":
                                                                                     self.DE_AddAll_List[0][20].text(),
                                                                                 "gather_datetime":
                                                                                     self.DE_AddAll_List[0][21].text(),
                                                                                 "gather_person_agency":
                                                                                     self.DE_AddAll_List[0][22].text(),
                                                                                 "gather_person_rank":
                                                                                     self.DE_AddAll_List[0][23].text(),
                                                                                 "gather_organization_code":
                                                                                     self.DE_AddAll_List[0][24].text(),
                                                                                 "submitter_name":
                                                                                     self.DE_AddAll_List[0][25].text(),
                                                                                 "gather_source_name":
                                                                                     self.DE_AddAll_List[0][26].text(),
                                                                                 "gather_relation_person_type_code":
                                                                                     self.DE_AddAll_List[0][27].text(),
                                                                                            ...
                                                                                            {0:
                                                                                                 {"serial_no":
                                                                                                      self.DE_Acquisition_Info_DEF_List[
                                                                                                          0][0][0][
                                                                                                          0].text(),
                                                                                                  "digital_evidence_management_id":
                                                                                                      self.DE_Acquisition_Info_DEF_List[
                                                                                                          0][0][0][
                                                                                                          0].text(),
                                                                                                  "digital_evidence_type":
            ...
            ,
                                                 "Analysis Info":
                                                     {"Reports":
                                                          {0:
                                                               {"id": self.AIReports_List[0][0].text(),
                                                                "type": self.AIReports_List[0][1].text(),
                                                                "subtype": self.AIReports_List[0][2].text(),
                                                                "equipment_management_id": self.AIReports_List[0][
                                                                    3].text(),
                                                                "submission_agency": self.AIReports_List[0][4].text(),
                                                                "report_creation_datetime": self.AIReports_List[0][
                                                                    5].text(),
                                                                "division_name_of_report_maker": self.AIReports_List[0][
                                                                    6].text(),
                                                                "team_name_of_report_maker": self.AIReports_List[0][
                                                                    7].text(),
                                                                "file_name": self.AIReports_List[0][9].text(),
                                                                "file_size": self.AIReports_List[0][10].text(),
                                                                "file_path": self.AIReports_List[0][11].text(),
                                                                "file_creation_datetime": self.AIReports_List[0][
                                                                    12].text(),
                                                                "file_description": self.AIReports_List[0][13].text(),
                                                                "hash_type": self.AIReports_List[0][14].text(),
                                                                "hash_value": self.AIReports_List[0][15].text()}
                                                           }
                                                         ,
                                                      "Equipment Traces":
                                                          {0:
                                                               {"id": self.AI_EquipmentTraces_List[0][0].text(),
                                                                "type": self.AI_EquipmentTraces_List[0][1].text(),
                                                                "description": self.AI_EquipmentTraces_List[0][
                                                                    2].text(),
                                                                "equipment_traces_management_id":
                                                                    self.AI_EquipmentTraces_List[0][3].text(),
                                                                "vessel_id": self.AI_EquipmentTraces_List[0][4].text(),
                                                                "evidence_id": self.AI_EquipmentTraces_List[0][
                                                                    5].text(),
                                                                "power_on_time": self.AI_EquipmentTraces_List[0][
                                                                    6].text(),
                                                                "track_extraction_description":
                                                                    self.AI_EquipmentTraces_List[0][7].text(),
                                                                "system_info_description":
                                                                    self.AI_EquipmentTraces_List[0][8].text(),
                                                                "operation_status": self.AI_EquipmentTraces_List[0][
                                                                    9].text(),
                                                                "power_off_time": self.AI_EquipmentTraces_List[0][
                                                                    10].text(),
                                                                "track_recording_period":
                                                                    self.AI_EquipmentTraces_List[0][11].text(),
                                                                "track_deletion_trace": self.AI_EquipmentTraces_List[0][
                                                                    12].text(),
                                                                "trace_notes": self.AI_EquipmentTraces_List[0][
                                                                    13].text()
                                                                }
                                                           }
                                                         ,
                                                      "Other Files":
                                                          {0:
                                                               {"id": self.AI_List[0][1].text(),
                                                                "type": self.AI_List[0][2].text(),
                                                                "file_size": self.AI_List[0][3].text(),
                                                                "file_path": self.AI_List[0][4].text(),
                                                                "file_hash_type": self.AI_List[0][5].text(),
                                                                "file_hash_value": self.AI_List[0][6].text(),
                                                                "file_description": self.AI_List[0][7].text(),
                                                                "file_metadata": self.AI_List[0][8].text(),
                                                                }
        ...
        # Digital Evidence [number]로 깔아주기

        for all in range(1, len(self.DE_AddAll_List)):  # 100

            file_data["Digital Evidence Package"]["Digital Evidences"][all] = {"Vessel Info":
                                                                                   {"vessel_name":
                                                                                        self.DE_AddAll_List[all][
                                                                                            0].text(),
                                                                                    "vessel_management_id":
                                                                                        self.DE_AddAll_List[all][
                                                                                            1].text(),
        ...
        # Gather
        try:
            for big in range(0, 100):  # 100
                for g in range(0, len(self.DE_Gather_Info_List[big])):
                    file_data["Digital Evidence Package"]["Digital Evidences"][big]["Gather Info"][
                        "Gather Info Media File"][g] = {
                        'gather_media_type': self.DE_Gather_Info_List[big][g][1].text(),
                        'gather_hash_type': self.DE_Gather_Info_List[big][g][2].text(),
                        'gather_hash': self.DE_Gather_Info_List[big][g][3].text(),
                        'gather_path': self.DE_Gather_Info_List[big][g][4].text(),
                        'gather_file_size':
                            self.DE_Gather_Info_List[
                                big][g][5].text(),
                        'gather_metadata': self.DE_Gather_Info_List[big][g][6].text()
                    }
        ...
        try:
            for big in range(0, 100):  # 100
                for o in range(0, len(self.DE_Other_Files_List[big])):
                    file_data["Digital Evidence Package"]["Digital Evidences"][big]["Other Files"][o] = {
                        'Other_Files_id': self.DE_Other_Files_List[big][o][1].text(),
                        'Other_Files_type': self.DE_Other_Files_List[big][o][2].text(),
                        'Other_Files_size': self.DE_Other_Files_List[big][o][3].text(),
                        'Other_Files_path': self.DE_Other_Files_List[big][o][4].text(),
                        'Other_Files_hash_type': self.DE_Other_Files_List[big][o][5].text(),
                        'Other_Files_hash_value': self.DE_Other_Files_List[big][o][6].text(),
                        'Other_Files_file_description': self.DE_Other_Files_List[big][o][7].text(),
                        'Other_Files_file_metadata': self.DE_Other_Files_List[big][o][8].text()
                    }
        ...
        try:
            for big in range(0, 100):
                for a in range(0, len(self.DE_Acquisition_Info_List[big])):
                    file_data["Digital Evidence Package"]["Digital Evidences"][big]["Authentication Info"][a] = {
                        'authentication_management_id': self.DE_Acquisition_Info_List[big][a][0].text(),
                        'authentication_person_name': self.DE_Acquisition_Info_List[big][a][1].text(),
                        'authentication_date_time': self.DE_Acquisition_Info_List[big][a][2].text(),
                        'authentication_location': self.DE_Acquisition_Info_List[big][a][3].text(),
                        'authentication_tool': self.DE_Acquisition_Info_List[big][a][4].text(),
                        'authentication_tool_version': self.DE_Acquisition_Info_List[big][a][5].text(),
                        'authentication_person_party_name': self.DE_Acquisition_Info_List[big][a][6].text(),

                        "Digital Evidence Files":
                            {"0":
                                {
                                    "serial_no": self.DE_Acquisition_Info_DEF_List[big][a][0][0].text(),
                                    "digital_evidence_management_id": self.DE_Acquisition_Info_DEF_List[big][a][0][
                                        1].text(),
                                    "digital_evidence_type": self.DE_Acquisition_Info_DEF_List[big][a][0][2].text(),
                                    "evidences_gathering_type": self.DE_Acquisition_Info_DEF_List[big][a][0][3].text(),
                                    "gather_management_id": self.DE_Acquisition_Info_DEF_List[big][a][0][4].text(),
                                    "file_name": self.DE_Acquisition_Info_DEF_List[big][a][0][6].text(),
                                    "file_path": self.DE_Acquisition_Info_DEF_List[big][a][0][7].text(),
                                    "hash_type": self.DE_Acquisition_Info_DEF_List[big][a][0][8].text(),
                                    "hash_value": self.DE_Acquisition_Info_DEF_List[big][a][0][9].text(),
                                    "sector_size": self.DE_Acquisition_Info_DEF_List[big][a][0][10].text(),
                                    "file_size": self.DE_Acquisition_Info_DEF_List[big][a][0][11].text(),
                                    "metadata": self.DE_Acquisition_Info_DEF_List[big][a][0][12].text()
                                }
                            }}
        ...
        try:
            for big in range(0, 100):
                for a in range(0, len(self.DE_Acquisition_Info_List[big])):
                    for d in range(1, len(self.DE_Acquisition_Info_DEF_List[big][a])):
                        file_data["Digital Evidence Package"]["Digital Evidences"][big]["Authentication Info"][a]["Digital Evidence Files"][d] = {
                            "serial_no": self.DE_Acquisition_Info_DEF_List[big][a][d][0].text(),
                            "digital_evidence_management_id": self.DE_Acquisition_Info_DEF_List[big][a][d][1].text(),
                            "digital_evidence_type": self.DE_Acquisition_Info_DEF_List[big][a][d][2].text(),
                            "evidences_gathering_type": self.DE_Acquisition_Info_DEF_List[big][a][d][3].text(),
                            "gather_management_id": self.DE_Acquisition_Info_DEF_List[big][a][d][4].text(),
                            "file_name": self.DE_Acquisition_Info_DEF_List[big][a][d][6].text(),
                            "file_path": self.DE_Acquisition_Info_DEF_List[big][a][d][7].text(),
                            "hash_type": self.DE_Acquisition_Info_DEF_List[big][a][d][8].text(),
                            "hash_value": self.DE_Acquisition_Info_DEF_List[big][a][d][9].text(),
                            "sector_size": self.DE_Acquisition_Info_DEF_List[big][a][d][10].text(),
                            "file_size": self.DE_Acquisition_Info_DEF_List[big][a][d][11].text(),
                            "metadata": self.DE_Acquisition_Info_DEF_List[big][a][d][12].text()}
        except:
            pass

        for r in range(1, len(self.AIReports_List)):
            file_data["Digital Evidence Package"]["Analysis Info"]["Reports"][r] = {
                "id": self.AIReports_List[r][0].text(),
                "type": self.AIReports_List[r][1].text(),
                "subtype": self.AIReports_List[r][2].text(),
                "equipment_management_id": self.AIReports_List[r][3].text(),
                "submission_agency": self.AIReports_List[r][4].text(),
                "report_creation_datetime": self.AIReports_List[r][5].text(),
                "division_name_of_report_maker": self.AIReports_List[r][6].text(),
                "team_name_of_report_maker": self.AIReports_List[r][7].text(),
                "file_name": self.AIReports_List[r][9].text(),
                "file_size": self.AIReports_List[r][10].text(),
                "file_path": self.AIReports_List[r][11].text(),
                "file_creation_datetime": self.AIReports_List[r][12].text(),
                "file_description": self.AIReports_List[r][13].text(),
                "hash_type": self.AIReports_List[r][14].text(),
                "hash_value": self.AIReports_List[r][15].text()}

        for e in range(1, len(self.AI_EquipmentTraces_List)):
            file_data["Digital Evidence Package"]["Analysis Info"]["Equipment Traces"][e] = {
                "id": self.AI_EquipmentTraces_List[e][0].text(),
                "type": self.AI_EquipmentTraces_List[e][1].text(),
                "description": self.AI_EquipmentTraces_List[e][2].text(),
                "equipment_traces_management_id": self.AI_EquipmentTraces_List[0][3].text(),
                "vessel_id": self.AI_EquipmentTraces_List[e][4].text(),
                "evidence_id": self.AI_EquipmentTraces_List[e][5].text(),
                "power_on_time": self.AI_EquipmentTraces_List[e][6].text(),
                "track_extraction_description": self.AI_EquipmentTraces_List[e][7].text(),
                "system_info_description": self.AI_EquipmentTraces_List[e][8].text(),
                "operation_status": self.AI_EquipmentTraces_List[e][9].text(),
                "power_off_time": self.AI_EquipmentTraces_List[e][10].text(),
                "track_recording_period": self.AI_EquipmentTraces_List[e][11].text(),
                "track_deletion_trace": self.AI_EquipmentTraces_List[e][12].text(),
                "trace_notes": self.AI_EquipmentTraces_List[e][13].text()
            }

        for o in range(1, len(self.AI_List)):
            file_data["Digital Evidence Package"]["Analysis Info"]["Other Files"][o] = {"id": self.AI_List[o][1].text(),
                                                                                        "type": self.AI_List[o][
                                                                                            2].text(),
                                                                                        "file_size": self.AI_List[o][
                                                                                            3].text(),
                                                                                        "file_path": self.AI_List[o][
                                                                                            4].text(),
                                                                                        "file_hash_type":
                                                                                            self.AI_List[o][5].text(),
                                                                                        "file_hash_value":
                                                                                            self.AI_List[o][6].text(),
                                                                                        "file_description":
                                                                                            self.AI_List[o][7].text(),
                                                                                        "file_metadata":
                                                                                            self.AI_List[o][8].text(),
                                                                                        }

        file_data["Logs"] = {0: {"log_management_id": self.Log_List[0][0].text(),
                                 "log_history_start_date_time": self.Log_List[0][1].text(),
                                 "log_history_end_date_time": self.Log_List[0][3].text(),
                                 "log_type": self.Log_List[0][4].text(),
                                 "log_description": self.Log_List[0][5].text(),
                                 "devision_name_of_logger": self.Log_List[0][6].text(),
                                 "team_name_of_logger": self.Log_List[0][7].text(),
                                 "rank_of_logger": self.Log_List[0][8].text(),
                                 "name_of_logger": self.Log_List[0][9].text()}}

        for n in range(0, len(self.Log_List)):
            file_data["Logs"][n] = {"log_management_id": self.Log_List[n][0].text(),
                                    "log_history_start_date_time": self.Log_List[n][1].text(),
                                    "log_history_end_date_time": self.Log_List[n][3].text(),
                                    "log_type": self.Log_List[n][4].text(),
                                    "log_description": self.Log_List[n][5].text(),
                                    "devision_name_of_logger": self.Log_List[n][6].text(),
                                    "team_name_of_logger": self.Log_List[n][7].text(),
                                    "rank_of_logger": self.Log_List[n][8].text(),
                                    "name_of_logger": self.Log_List[n][9].text()}

        with open(self.file_path, 'w', encoding="utf-8") as make_file:
    ...
    def DE_AddTab(self):
        ...
        tmp_DE_Gather_Info__verticalLayout_1.addLayout(tmp_DE_Gather_Info_gather_location__horizontalLayout_1)
        tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1.setObjectName("DE_Gather_Info_organization_party_name__horizontalLayout_1")
        tmp_DE_Gather_Info_organization_party_name__label_1 = QtWidgets.QLabel(tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
        tmp_DE_Gather_Info_organization_party_name__label_1.setObjectName("DE_Gather_Info_organization_party_name__label_1")
        tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1.addWidget(tmp_DE_Gather_Info_organization_party_name__label_1)
        tmp_DE_Gather_Info_organization_party_name__lineEdit_1 = QtWidgets.QLineEdit(tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
        tmp_DE_Gather_Info_organization_party_name__lineEdit_1.setObjectName("DE_Gather_Info_organization_party_name__lineEdit_1")
        tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1.addWidget(tmp_DE_Gather_Info_organization_party_name__lineEdit_1)
        tmp_DE_Gather_Info__verticalLayout_1.addLayout(tmp_DE_Gather_Info_organization_party_name__horizontalLayout_1)
        tmp_DE_Gather_Info_gather_person_name__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        ...
        tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1 = QtWidgets.QLineEdit(tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
        tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1.setObjectName("DE_Gather_Info_Gather_Source_Name__lineEdit_1")
        tmp_DE_Gather_Info_Gather_Source_Name__horizontalLayout_1.addWidget(tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1)
        tmp_DE_Gather_Info__verticalLayout_1.addLayout(tmp_DE_Gather_Info_Gather_Source_Name__horizontalLayout_1)
        tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1 = QtWidgets.QHBoxLayout()
        ...
        tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1 = QtWidgets.QLineEdit(tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
        tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1.setObjectName("DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1")
        tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___horizontalLayout_1.addWidget(tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1)
        ...
        tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(tmp_DE_Gather_Info_gather_path__horizontalLayout_1)
        tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2 = QtWidgets.QHBoxLayout()
        tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2.setObjectName("DE_Gather_Info_gather_file_size__horizontalLayout_2")
        tmp_DE_Gather_Info_gather_file_size__label_1 = QtWidgets.QLabel(tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
        tmp_DE_Gather_Info_gather_file_size__label_1.setObjectName("DE_Gather_Info_gather_file_size__label_1")
        tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2.addWidget(tmp_DE_Gather_Info_gather_file_size__label_1)
        tmp_DE_Gather_Info_gather_file_size__lineEdit_1 = QtWidgets.QLineEdit(tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
        tmp_DE_Gather_Info_gather_file_size__lineEdit_1.setObjectName("DE_Gather_Info_gather_file_size__lineEdit_1")
        tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2.addWidget( tmp_DE_Gather_Info_gather_file_size__lineEdit_1)
        tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(tmp_DE_Gather_Info_gather_file_size__horizontalLayout_2)
        tmp_DE_Gather_Info_gather_metadata__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        ...
        tmp_list.append(tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1)  # 정보 저장 매체명 26
        tmp_list.append(tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1)  # 수집 대상자 유형 27
        tmp_list.append(tmp_DE_Gather_Info_file__filebrowse__lineEdit_1)  # 파일 입력 27
        tmp_list.append(tmp_DE_Gather_Info_gather_media_type__lineEdit_1)  # 채증 미디어 유형 28
        tmp_list.append(tmp_DE_Gather_Info__gather_hash_type__lineEdit_1)  # 채증 미디어 해시 종류  29
        tmp_list.append(tmp_DE_Gather_Info_gather_hash__lineEdit_1)  # 채증 미디어 해시값 30
        tmp_list.append(tmp_DE_Gather_Info_gather_path__lineEdit_1)  # 채증 미디어 경로 31
        tmp_list.append(tmp_DE_Gather_Info_gather_file_size__lineEdit_1)  # 파일 크기 32
        tmp_list.append(tmp_DE_Gather_Info_gather_metadata__lineEdit_1)  # 파일 메타 데이터 33
        tmp_list.append(tmp_DE_Other_Files_file_browse__lineEdit_1)  # 파일 입력 34
        tmp_list.append(tmp_DE_Other_Files_id__lineEdit_1)  # 기타 파일 관리 번호 35
        tmp_list.append(tmp_DE_Other_Files_type__lineEdit_1)  # 파일 유형 36
        tmp_list.append(tmp_DE_Other_Files_file_size__lineEdit_1)  # 파일 크기 37
        tmp_list.append(tmp_DE_Other_Files_file_path__lineEdit_1)  # 파일 경로 38
        tmp_list.append(tmp_DE_Other_Files_file_hash_type__lineEdit_1)  # 해시 종류 39
        tmp_list.append(tmp_DE_Other_Files_file_hash_value__lineEdit_1)  # 해시값 40
        tmp_list.append(tmp_DE_Other_Files_file_description__lineEdit_1)  # 파일 설명 41
        tmp_list.append(tmp_DE_Other_Files_file_metadata__lineEdit_1)  # 파일 메타데이터 42
        tmp_list.append(tmp_DE_Authentication_ID__lineEdit_1)  # 수집 관리 번호 43
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_person_name__lineEdit_1)  # 수집자명 44
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1)  # 수집 시간 45
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_location__lineEdit_1)  # 수집 장소 46
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_tool__lineEdit_1)  # 수집 도구 47
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_tool_version__lineEdit_1)  # 수집 도구 버전 48
        tmp_list.append(tmp_DE_Authentication_Person_Party_Name__lineEdit_1)  # 수집 부서 49
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_serial_no__lineEdit_1)  # 일련번호 50
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_management_id__lineEdit_1)  # 디지털 증거 관리 번호 51
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1)  # 디지털 증거 유형 52
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1)  # 증거 채증 유형 53
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1)  # 채증 관리 번호 54
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)  # 파일 입력 55
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1)  # 디지털 증거 파일 이름 56
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1)  # 디지털 증거 파일 경로 57
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1)  # 해시 종류 58
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1)  # 해시값 59
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_sector_size__lineEdit_1)  # 섹터 크기 60
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1)  # 파일 크기 61
        tmp_list.append(tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1)  # 파일 메타데이터 62
        self.DE_AddAll_List.append(tmp_list)
        ...
        gather_info_list.append(tmp_DE_Gather_Info_gather_file_size__lineEdit_1)
        ...
        de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__browseButton_1)
        de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__EnterButton_1)
        self.DE_Other_Files_Button_List[len(self.DE_Other_Files_List) - 1].append(de_Other_Files_button_list)
        ...
        self.DE_Acquisition_Info_DEF_Button_List[big][med][small][1].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(big, med,
                                                                                 small))
        #
        # self.DE_Acquisition_Info_DEF_Button_List[tmp_len][tmp_lenn][0][0].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(tmp_len, tmp_lenn, 0))
        #
        # self.DE_Acquisition_Info_DEF_Button_List[tmp_len][tmp_lenn][0][1].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(tmp_len, tmp_lenn, 0))
        ...
        tmp_DE_Vessel_Info_vessel_tonnage__label_1.setText("선박 톤수:")
        tmp_DE_Vessel_Info_vessel_length__label_1.setText("선박 길이:")  # 7
        tmp_DE_Vessel_Info_vessel_total_number_of_equipmentwith_track__label_1.setText("항적 분석 장비 수:")  # 8
        tmp_DE_Vessel_Type__label_1.setText("선박 유형:")  # 9
        ...
        tmp_DE_Marines_Electronics_Info_device_model_serial_number__label_1.setText("장비 모델 시리얼 넘버:")
        tmp_DE_Marines_Electronics_Info_device_os_firmware__label_1.setText("장비 os firmware:")  # 15
        tmp_DE_Marines_Electronics_Info_device_os_firmware__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) 0.01"))
        tmp_DE_Marines_Electronics_Info_device_description__label_1.setText("장비 설명:")  # 16
        ...
        tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "" + str(len(self.DE_AddAll_List)-1))  + str(len(self.DE_Acquisition_Info_List[len(self.DE_AddAll_List)-1])-1) + str(len(self.DE_Acquisition_Info_DEF_List[len(self.DE_AddAll_List)-1][len( self.DE_Acquisition_Info_List[ len(self.DE_AddAll_List)-1])-1])-1))
    ...
    def DE_Gather_Info_file__filebrowse__browseButton_1_QFileDialog(self, a, b):
        file_name = QFileDialog.getOpenFileName(
            filter="JPG File (*.jpg);; JPEG File (*.jpeg);; MP3 File (*.mp3);; MP4 File (*.mp4)")  # JPG File (*.jpg);; JPEG File (*.jpeg);;
    ...
    def DE_Gather_Info_file__filebrowse__enterButton_1_Calculate(self, a, b):
        ...
        self.DE_Gather_Info_List[a][b][5].setText(str(file_size))
        self.DE_Gather_Info_List[a][b][6].setText(str(result))

    def DE_Other_Files_AddTab(self, a):  # tab_4
        ...
        # <Other>
        self.DE_Other_Files_Tab_Widget_List[a].addTab(tmp_tab_4, "Tab" + str(len(self.DE_Other_Files_List[a]) + 1))
        ...
        tmp_list.append(tmp_DE_Other_Files_file_description__lineEdit_1)
        tmp_list.append(tmp_DE_Other_Files_file_metadata__lineEdit_1)
        self.DE_Other_Files_List[a].append(tmp_list)

        de_Other_Files_button_list = list()
        de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__browseButton_1)
        de_Other_Files_button_list.append(tmp_DE_Other_Files_file_browse__EnterButton_1)
        self.DE_Other_Files_Button_List[a].append(de_Other_Files_button_list)

        tmp_len = len(self.DE_Other_Files_Button_List[a]) - 1
        self.DE_Other_Files_Button_List[a][tmp_len][0].clicked.connect(
            lambda: self.DE_Other_Files_file_browse__browseButton_1_QFileDialog(a, tmp_len))

        self.DE_Other_Files_Button_List[a][tmp_len][1].clicked.connect(
            lambda: self.DE_Other_Files_file_browse__EnterButton_1_Calculate(a, tmp_len)
        )
        # </Other>
    ...
    def DE_Other_Files_file_browse__browseButton_1_QFileDialog(self, a, b):
        ...
        self.DE_Other_Files_List[a][b][0].setText(file_name[0])

    def DE_Other_Files_file_browse__EnterButton_1_Calculate(self, a, b):
        file_path = self.DE_Other_Files_List[a][b][0].text()
        ...
        with open(copy_file_path, 'rb') as file:
            ...
            self.DE_Other_Files_List[a][b][2].setText(file_name[file_name.rfind(".") + 1:])
            self.DE_Other_Files_List[a][b][3].setText(str(file_size))
            self.DE_Other_Files_List[a][b][4].setText(copy_file_path)
            self.DE_Other_Files_List[a][b][5].setText("SHA-256")
            self.DE_Other_Files_List[a][b][6].setText(sha256.hexdigest())
            ...
            if magic.hex() == 'ffd8ffe000104a46' or magic.hex() == '0000001466747970':
                ...
                self.DE_Other_Files_List[a][b][8].setText(str(result))
                ...
                self.DE_Other_Files_List[a][b][8].setText(chiwon)
    ...
    def DE_Acquisition_Info_AddTab(self, a):
        ...
        # <Acquisition>
        self.DE_Acquisition_Info_Tab_Widget_List[a].addTab(tmp_Acquisition_tab,
        ...
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__enterButton_1)
        self.DE_Acquisition_Info_DEF_Button_List[a][len(self.DE_Acquisition_Info_DEF_Button_List[a]) - 1].append(
            tmp_list)
        #리스팅 끝
        ...
        tmp_len = len(self.DE_Acquisition_Info_DEF_List[a]) - 1
        tmp_len2 = len(self.DE_Acquisition_Info_DEF_List[a][tmp_len]) - 1
        self.DEF_AddButton_List[a].append(list())
        self.DEF_AddButton_List[a][tmp_len].append(tmp_DE_Acquisition_Info_DEF__addButton_1)

        tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.setPlaceholderText(_translate("SecondWindow", str(a)+str(tmp_len)+str(0)))
        ...
        self.DEF_AddButton_List[a][tmp_len][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab(a, tmp_len))
    ...
    def DE_Acquisition_Info_DEF_AddTab(self, a, b):
        ...
        tmp_DE_Acquisition_Info_file__scrollArea_1.setWidget(tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
        tmp_gridLayout_17.addWidget(tmp_DE_Acquisition_Info_file__scrollArea_1, 0, 0, 1, 1)
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[a][b].addTab(tmp_DEF_tab, "Tab" + str(
            len(self.DE_Acquisition_Info_DEF_List[a][b]) + 1))  #
        ...
        _translate = QtCore.QCoreApplication.translate
        tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", str(a) + str(b))  + str(len(self.DE_Acquisition_Info_DEF_List[a][b] )-1)  )
    ...
    def AI_Reports__AddTab(self):
        ...
        tmp_len = len(self.AIReports_List) - 1

        tmp_AI_Reports_file_info__browseButton_1.clicked.connect(
            lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(tmp_len))

        tmp_AI_Reports_file_info__enterButton_1.clicked.connect(
            lambda: self.AI_Reports_file_info__enterButton_1_Calculate(tmp_len))
        ...
        tmp_AI_Reports_submission_agency__label_1.setText("제출 기관:")
        tmp_AI_Reports_reprot_creation_datetime__label_1.setText("보고서 작성 시간:")
        tmp_AI_Reports_reprot_creation_datetime__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
        tmp_AI_Reports_division_name_of_report_maker__label_1.setText("보고서 작성 부서명:")
        tmp_AI_Reports_team_name_of_report_maker__label_1.setText("보고서 작성 팀명:")
    ...
    def AI_Reports_file_info__enterButton_1_Calculate(self, a):
        ...
        self.AIReports_List[a][12].setText(new_file_date)  # 파일 생성 날짜/시간                                   #파일 설명
    ...
    def AI_Other_Files_AddTab(self):
        ...
        tmp_len = len(self.AI_List) - 1

        tmp_AI_Other_Files_file_browse__browseButton_1.clicked.connect(
            lambda: self.AI_Other_Files_file_browse__browseButton_1_QFileDialog(tmp_len))

        tmp_AI_Other_Files_file_browse__enterButton_1.clicked.connect(
            lambda: self.AI_Other_Files_file_browse__enterButton_1_Calculate(tmp_len))
    ...
    def AI_Equipment_Traces_AddTab(self):
        ...
        tmp_AI_EquipmentTraces_description__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) TRACE"))
        tmp_AI_EquipmentTraces_mgmt_id__label_1.setText("장비 아이디:")
        tmp_AI_EquipmentTraces_mgmt_id__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) D20220203-V001-D001"))
        tmp_AI_EquipmentTraces_vessel_id__label_1.setText("선박 관리 번호:")
        tmp_AI_EquipmentTraces_vessel_id__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) D20220203-V001"))
        tmp_AI_EquipmentTraces_evidence_id__label_1.setText("증거 관리 번호:")
    ...
    def retranslateUi(self, SecondWindow):
        ...
        self.DE_Gather_Info_organization_party_name__label_1.setText(_translate("SecondWindow", "채증 부서:"))
        ...
        self.DE_Gather_Info_Gather_Relation_Person_Type_Code__lineEdit_1.setPlaceholderText(_translate("SecondWindow", "ex) 소유자, 실사용자, 기타"))
        ...
        self.DE_Gather_Info_gather_file_size__label_1.setText(_translate("SecondWindow", "파일 크기:"))
        ...
        self.DE_Other_Files_type__label_1.setText(_translate("SecondWindow", "파일 유형:"))
        ...
        self.DE_Acquisition_Info_acquisition_tool_version__label_1.setText(_translate("SecondWindow", "수집 도구 버전:"))
        ...
        self.DE_Acquisition_Info_DEF_gather_no__label_1.setText(_translate("SecondWindow", "채증 관리 번호:"))
        self.DE_Acquisition_Info_DEF_gather_no__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) D20220203-V001-D001-G001"))
        ...
        self.Acquisition_tabWidget.setTabText(self.Acquisition_tabWidget.indexOf(self.Acquisition_tab),
                                              _translate("SecondWindow", "Tab 1"))
        self.DE_tabWidget.setTabText(self.DE_tabWidget.indexOf(self.DE_tab), _translate("SecondWindow", "Tab 1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Second_tab),
                                  _translate("SecondWindow", "Digital Evidences"))
        ...
        self.AI_EquipmentTraces_vessel_id__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) D20220203-V001"))
        self.AI_EquipmentTraces_evidence_id__label_1.setText(_translate("SecondWindow", "증거 관리 번호:"))
        self.AI_EquipmentTraces_evidence_id__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) D20220203-V001-D001-I001"))
        self.AI_EquipmentTraces_user_trace_info__label_1.setText(_translate("SecondWindow", "사용자 추적 정보"))
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__label_1.setText(
            _translate("SecondWindow", "시스템 시작 시간:"))
        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__label_1.setText(
            _translate("SecondWindow", "항적 추출 방법:"))
        self.AI_EquipmentTraces_user_trace_info_system_description__label_1.setText(
            _translate("SecondWindow", "시스템 설명:"))
        self.AI_EquipmentTraces_user_trace_info_system_operation_status__label_1.setText(
            _translate("SecondWindow", "시스템 운영 상태:"))
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__label_1.setText(
            _translate("SecondWindow", "시스템 종료 시간:"))
        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) 2021-11-30 19:58:13.829475+09:00"))
        self.AI_EquipmentTraces_user_trace_info_track_recording_period__label_1.setText(
            _translate("SecondWindow", "항적 기록 시간:"))
        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__label_1.setText(
            _translate("SecondWindow", "항적 삭제 개수:"))
        ...
        self.Log_Digital_Evidence_Pack_History_Start_Date_Time__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "\'Export\'를 누르면 자동 계산 됩니다"))
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__label_1.setText(_translate("SecondWindow", "종료 시간:"))
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "\'Export\'를 누르면 자동 계산 됩니다"))
        ...
        self.Log_log_description__lineEdit_1.setPlaceholderText(
            _translate("SecondWindow", "ex) create D20210001-V001-ME001-E001"))
        ...
        self.DE_Acquisition_Info_DEF_browse__lineEdit_1.setPlaceholderText(_translate("SecondWindow","000"))
