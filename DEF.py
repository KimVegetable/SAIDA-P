...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        #DE Acquisition Info DEF에서 QFileDialog
        acquisition_info_def_button_list = list()
        acquisition_info_def_button_list.append(self.DE_Acquisition_Info_DEF_browse__browseButton_1)
        acquisition_info_def_button_list.append(self.DE_Acquisition_Info_DEF_browse__enterButton_1)
        self.DE_Acquisition_Info_DEF_Button_List[0].append(acquisition_info_def_button_list)

        self.DE_Acquisition_Info_DEF_Button_List[0][0][0].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(0, 0, 0))

        self.DE_Acquisition_Info_DEF_Button_List[0][0][1].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(0, 0))

        # DE 수집 DEF에서 addTab
        self.DE_Acquisition_Info_DEF__addButton_1.clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_AddTab(0))
    ...
    def DE_Acquisition_Info_AddTab(self, a): # tab_6
        ...
        # [큰탭][소탭][버튼]
        tmp_DE_Acquisition_Info_DEF_browse__browseButton_1.clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(0,0,0)
        )
    ...
    def DE_Acquisition_Info_DEF_AddTab(self, a):
        ...
        tmp_DE_Acquisition_Info_file__scrollArea_1.setWidget(tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
        tmp_gridLayout_17.addWidget(tmp_DE_Acquisition_Info_file__scrollArea_1, 0, 0, 1, 1)
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[a].addTab(tmp_tab_9, "Tab" + str(len(self.DE_Acquisition_Info_DEF_List[a]) +1))
        ...
        self.DE_Acquisition_Info_DEF_Button_List[a].append(acquisition_info_def_button_list)

        tmp_len = len(self.DE_Acquisition_Info_DEF_Button_List[a])-1
        tmp_len2 = len(self.DE_Acquisition_Info_Button_List[a])-1
        self.DE_Acquisition_Info_DEF_Button_List[a][tmp_len][0].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(a, tmp_len, tmp_len2)
        )
        self.DE_Acquisition_Info_DEF_Button_List[a][tmp_len][0].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(a, tmp_len)
        )
