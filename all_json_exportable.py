    ...
    def ExportButton_exporttojsonfile(self):
        ...
        for list in self.DE_AddAll_List:
            ...
            for acquisition_list in self.DE_AddAll_List:
                ...
                tmp_dict['Authentication Info'] = {'authentication_id': acquisition_list[37].text(), 'authentication_person_name': acquisition_list[38].text(),
...
#!
                ...
                for second_list in self.DE_AddAll_List:
                    tmp_list.append({'serial_no': second_list[42].text(), 'management_id': second_list[43].text(),
                                     'digital_evidence_type': second_list[44].text(),
                                  'evidences_gathering_type': second_list[45].text(),
                                  'gather_no': second_list[46].text(), 'file_name': second_list[48].text(),
                                      'file_path': second_list[49].text(), 'hash_type': second_list[50].text(),
                                      'hash_value': second_list[51].text(), 'sector_size': second_list[51].text()})
