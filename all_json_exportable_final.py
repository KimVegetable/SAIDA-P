...
class Ui_SecondWindow(object):
    ...
    def ExportButton_exporttojsonfile(self):
        ...
        for list in self.DE_AddAll_List:
            ...
            ##
            tmp_dict['Gather Info'] = {'gather_no': list[17].text(), 'gather_location': list[18].text(), 'gather_person_name': list[19].text(),
            ...
            for other_files_list in self.DE_AddAll_List:
                tmp_list.append({'other_files_id': other_files_list[30].text(), 'other_files_type': other_files_list[31].text(),
                                               'other_files_size': other_files_list[32].text(), 'other_files_path': other_files_list[33].text(),
                                             'other_files_hash_type': other_files_list[34].text(), 'other_files_hash_value': other_files_list[35].text(),
                                          'other_files_file_description': other_files_list[36].text(), 'other_files_file_metadata': other_files_list[37].text()})
            ...
            for acquisition_list in self.DE_AddAll_List:
                ...
                tmp_dict['Authentication Info'] = {'authentication_id': acquisition_list[38].text(), 'authentication_person_name': acquisition_list[39].text(),
                                     'authentication_date_time': acquisition_list[40].text(),
                                     'authentication_location': acquisition_list[41].text(), 'authentication_tool': acquisition_list[42].text()}
#!
                tmp_list = []
