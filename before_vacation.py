...
class Ui_SecondWindow(object):
    ...
    ##################
        ...
        self.DE_Acquisition_Info_DEF_List = list() #가장 작은 단위 선언. 나중에 setup하면서 항목들이 들어옴., browse가 0번째, Enter가 1번째, 라인에딧이 그 다음부터
    ...
    def setupUi(self, SecondWindow):
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List.append(self.tabWidget_10)
        ...
        # DE Acquisition Info DEF에서 QFileDialog, Calculate
        self.DE_Acquisition_Info_DEF_List[0][0][0].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(0))

        # DE Acquisition_Info DEF Calculate
        self.DE_Acquisition_Info_DEF_List[0][0][1].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate())
        ...
        self.DE_Acquisition_Info_DEF__addButton_1.clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_AddTab(0, 0))
    ...
    def DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(self, a):

        print("Big 1 -> Acq 1 -> DEF 1을 클릭하셨습니다")
        file_name = QFileDialog.getOpenFileName()



        self.DE_Acquisition_Info_DEF_List[0][a][7].setText(file_name[0])

        # self.DE_Acquisition_Info_DEF_List[a][b][c][0].setText(file_name[0])
    ...
    def DE_other_files_file_browse__EnterButton_1_Calculate(self, a, b):
        ...
        with open(copy_file_path, 'rb') as file:
            ...
            if magic.hex() == 'ffd8ffe000104a46' or magic.hex() == '0000001466747970':
                ...
                print("d")
                # self.DE_Other_Files_Info_L_ist[a][b][8].setText(str(result))
                ...
                print("d")
                # self.DE_Other_Files_Info_L_ist[a][b][8].setText(chiwon)

    def DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(self): # , a, b

        self.DE_Acquisition_Info_DEF_List[0][0][8].setText("디지털 증거 파일 이름")
    ...
    def DE_Acquisition_Info_AddTab(self, a): # tab_6
        ...
        # # # tmp_len2 = len(self.DE_Acquisition_Info_Button_List)-1
        # # # [큰탭][소탭][버튼]
        # self.DE_Acquisition_Info_List[0][0][0].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_AddTab(0))
        #

        # self.DE_Acquisition_Info_DEF_List[tmp_len][tmp_len2][0][0].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(tmp_len,tmp_len2,0)
        # )
        #
        # self.DE_Acquisition_Info_DEF_List[tmp_len][tmp_len2][0][1].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_AddTab(tmp_len,tmp_len2,0)
        # )
    ...
    def DE_Acquisition_Info_DEF_AddTab(self, a, b):
        ...
        a = a + 1
        b = b + 1
        print("Big" + " " + str(a) + " " + "Acq" + " " + str(b) + " " + "번째 입니다")
        ...
        # tmp_DE_Acquisition_Info_file__scrollArea_1.setWidget(tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
        # tmp_gridLayout_17.addWidget(tmp_DE_Acquisition_Info_file__scrollArea_1, 0, 0, 1, 1)
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[a].addTab(tmp_tab_9, "Tab")
        #
        # tmp_list = list()
        ...
        # tmp_list.append(tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1)
        # tmp_list.append(tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1)
        # self.DE_Acquisition_Info_DEF_List[a].append(tmp_list)  # a= 전체 tab의 개수-1.b = 수집정보 tab의 개수-1
        # self.DE_Acquisition_Info_List.append(self.DE_Acquisition_Info_DEF_List)
        #
        # self.DE_Acquisition_Info_DEF_List[0][a][0].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(a)
        # )
        #
        # # self.DE_Acquisition_Info_DEF_List[0][1][1].clicked.connect(
        # #     lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate()
        # # )
        #
        #
    ...
    def DE_AddTab(self):
        ...
        # [큰탭][소탭][버튼]
        self.DE_Other_Files_Button_List[tmp_len][0][0].clicked.connect(lambda: self.DE_other_files_file_browse__browseButton_1_QFileDialog(tmp_len, 0))
        ...
        # Acquisition Info 추가
        tmp_list = list()
        tmp_list.append(tmp_DE_Acquisition_Info_DEF__addButton_1)
        ...
        Big = len(self.DE_AddAll_List)-1
        Acq = len(self.DE_Acquisition_Info_List[0])-1

        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_AddTab(Big, Acq))

        # # Acquisition Info DEF 추가
        # acquisition_info_def_list = list()
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_serial_no__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_management_id__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_sector_size__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1)  #
        # acquisition_info_def_list.append(tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1)  #
        # self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1].append(acquisition_info_def_list)
        #
        # acquisition_info_def_button_list = list()
        # acquisition_info_def_button_list.append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)
        # acquisition_info_def_button_list.append(tmp_DE_Acquisition_Info_DEF_browse__enterButton_1)
        # self.DE_Acquisition_Info_DEF_Button_List[len(self.DE_Acquisition_Info_List)-1].append(acquisition_info_def_button_list)
        #
        # tmp_len = len(self.DE_Acquisition_Info_DEF_List)-1
        # # [큰탭][소탭][버튼]
        # self.DE_Acquisition_Info_DEF_Button_List[tmp_len][0][0].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(tmp_len, 0)
        # )
        # self.DE_Acquisition_Info_DEF_Button_List[tmp_len][0][1].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(tmp_len,0)
        # )
        # tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_AddTab(tmp_len)
        # )
