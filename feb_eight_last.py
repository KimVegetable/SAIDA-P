...
class Ui_SecondWindow(object):
            ...
            with open(self.file_path, 'r', encoding="utf-8") as f:
                ...
                for i in range(0, len(data['Digital Evidence Package']['Digital Evidences'])):
                    ...
                    if i == 0:
                        ...
                        for j in range(0, len(data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info'][
                            ...
                            if j == 0:
                                ...
                                gather_metadata = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info'][
                                    'Gather Info Media File'][j]['gather_metadata']
                    ...
                    for j in range(0, len(
                            data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'])):

                        if j == 0:

                            authentication_id = \
                            data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                        ...
                        for k in range(0, len(
                            ...
                            if k == 0:
                                ...
                                serial_no = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['serial_no']
                                management_id = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['digital_evidence_management_id']
                                digital_evidence_type = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['digital_evidence_type']
                                evidences_gathering_type = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['evidences_gathering_type']
                                gather_no = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['gather_management_id']
                                DEF_file_name = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['file_name']
                                DEF_file_path = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['file_path']
                                hash_type = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['hash_type']
                                hash_value = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['hash_value']
                                sector_size = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['sector_size']
                                DEF_file_size = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['file_size']
                                metadata = \
                                data['Digital Evidence Package']['Digital Evidences'][i]['Authentication Info'][j][
                                    'Digital Evidence Files'][k]['metadata']
                ...
                for i in range(0, len(data['Digital Evidence Package']['Analysis Info']['Reports'])):
                    ...
                    if i == 0:
                        ...
                        mgmt_id = data['Digital Evidence Package']['Analysis Info']['Reports'][i][
    ...
    def Easy_Export(self):
        ...
        file_data["Digital Evidence Package"] = {"Case Info":
                                                     {"case_mangement_id": self.CI_List[0].text(),
                                                          ...
                                                          {"Vessel_Info":
                                                           ...
                                                           'Gather Info':
                                                               {"gather_management_id": self.DE_AddAll_List[0][17].text(),
                                                                ...
                                                                "Gather Info Media File":
                                                                    {"0":
                                                                         {'gather_media_type': self.DE_AddAll_List[0][27].text(),
                                                                          'gather_hash_type': self.DE_AddAll_List[0][28].text(),
                                                                          'gather_hash': self.DE_AddAll_List[0][29].text(),
                                                                          'gather_path': self.DE_AddAll_List[0][30].text(),
                                                                          'gather_metadata': self.DE_AddAll_List[0][31].text()}}
                                                                    },
                                                           "Other Files":
                                                               {"0":
                                                                    {'other_files_id': self.DE_AddAll_List[0][32].text(),
                                                                     'other_files_type': self.DE_AddAll_List[0][33].text(),
                                                                     'other_files_size': self.DE_AddAll_List[0][34].text(),
                                                                     'other_files_path': self.DE_AddAll_List[0][35].text(),
                                                                     'other_files_hash_type': self.DE_AddAll_List[0][36].text(),
                                                                     'other_files_hash_value': self.DE_AddAll_List[0][37].text(),
                                                                     'other_files_file_description': self.DE_AddAll_List[0][38].text(),
                                                                     'other_files_file_metadata': self.DE_AddAll_List[0][39].text()
                                                                     }
                                                           ...
                                                           "Authentication Info":
                                                               {"0":
                                                                    {
                                                                        'authentication_management_id': self.DE_AddAll_List[0][40].text(),
                                                                        'authentication_person_name': self.DE_AddAll_List[0][41].text(),
                                                                        'authentication_date_time': self.DE_AddAll_List[0][42].text(),
                                                                        'authentication_location': self.DE_AddAll_List[0][43].text(),
                                                                        'authentication_tool': self.DE_AddAll_List[0][44].text(),
                                                                        'authentication_tool_version': self.DE_AddAll_List[0][45].text(),
                                                                        'authentication_person_party_name': self.DE_AddAll_List[0][46].text() ,

                                                                        "Digital Evidence Files":
                                                                            {"0":
                                                                                 {"serial_no": self.DE_AddAll_List[0][47].text(),
                                                                                  "digital_evidence_management_id": self.DE_AddAll_List[0][48].text(),
                                                                                  "digital_evidence_type": self.DE_AddAll_List[0][49].text(),
                                                                                  "evidences_gathering_type": self.DE_AddAll_List[0][50].text(),
                                                                                  "gather_management_id": self.DE_AddAll_List[0][51].text(),
                                                                                  "file_name": self.DE_AddAll_List[0][52].text(),
                                                                                  "file_path": self.DE_AddAll_List[0][53].text(),
                                                                                  "hash_type": self.DE_AddAll_List[0][54].text() ,
                                                                                  "hash_value": self.DE_AddAll_List[0][55].text() ,
                                                                                  "sector_size": self.DE_AddAll_List[0][56].text() ,
                                                                                  "file_size": self.DE_AddAll_List[0][57].text() ,
                                                                                  "metadata": self. DE_AddAll_List[0][58].text()
                                                                                  }
                                                                             }
                                                                        }
                                                                }
        ...
        for g in range (1, len(self.DE_Gather_Info_List[big])):

            file_data["Digital Evidence Package"]["Digital Evidences"][big] = { "Gather Info" :
                                                                                   {    "gather_management_id": self.DE_AddAll_List[big][17].text(),
                                                                                        "gather_location": self.DE_AddAll_List[big][18].text(),
                                                                                        "gather_person_name": self.DE_AddAll_List[big][19].text(),
                                                                                        "gather_datetime": self.DE_AddAll_List[big][20].text(),
                                                                                        "gather_person_agency": self.DE_AddAll_List[big][21].text(),
                                                                                        "gather_person_rank": self.DE_AddAll_List[big][22].text(),
                                                                                        "gather_organization_code": self.DE_AddAll_List[big][23].text(),
                                                                                        "submitter_name" : self.DE_AddAll_List[big][24].text(),
                                                                                        "gather_source_name" : self.DE_AddAll_List[big][25].text(),
                                                                                        "gather_relation_person_type_code": self.DE_AddAll_List[big][26].text(),

                                                                                        "Gather Info Media File" :
                                                                                             { 0:
                                                                                                 {
                                                                                                  'gather_media_type': self.DE_Gather_Info_List[big][g][0].text(),
                                                                                                  'gather_hash_type':self.DE_Gather_Info_List[big][g][1].text(),
                                                                                                  'gather_hash':self.DE_Gather_Info_List[big][g][2].text(),
                                                                                                  'gather_path':self.DE_Gather_Info_List[big][g][3].text(),
                                                                                                  'gather_metadata':self.DE_Gather_Info_List[big][g][4].text()
                                                                                                                                                                }
                                                                                                                                                                        }
                                                                                                                                                                            }
                                                                                                                                                                                 }
        ...
        # for o in range (1, len(self.DE_Other_Files_List[big])):
        #     file_data["Digital Evidence Package"]["Digital Evidences"]["0"]["Other Files"][o] = {"other_files_id": self.DE_Other_Files_List[big][o][0].text(),
        #                                                                                         "other_files_type": self.DE_Other_Files_List[big][o][1].text(),
        #                                                                                         "other_files_size": self.DE_Other_Files_List[big][o][2].text(),
        #                                                                                         "other_files_path": self.DE_Other_Files_List[big][o][3].text(),
        #                                                                                         "other_files_hash_type": self.DE_Other_Files_List[big][o][4].text(),
        #                                                                                         "other_files_hash_value": self.DE_Other_Files_List[big][o][5].text(),
        #                                                                                         "other_files_file_description": self.DE_Other_Files_List[big][o][6].text(),
        #                                                                                         "other_files_file_metadata": self.DE_Other_Files_List[big][o][7].text()
        #                                                                                         }
        # for a in range (1, len(self.DE_Acquisition_Info_List[big])):
        #
        #     file_data["Digital Evidence Package"]["Digital Evidences"]["0"]["Authentication Info"][a] =  {
        ...
        # a = len(self.DE_Acquisition_Info_DEF_List[a])
        #
        # for d in range (1, len(self.DE_Acquisition_Info_DEF_List[big][a])):
        #
        #     file_data["Digital Evidence Package"]["Digital Evidences"]["0"]["Authentication Info"]["0"]["Digital Evidence Files"][d] = {"serial_no": self.DE_Acquisition_Info_DEF_List[big][a][d][0].text(),
        ...
        # for all in range (1, len(self.DE_AddAll_List)):
        #
        #     file_data["Digital Evidence Package"]["Digital Evidences"][all] = {"Vessel_Info":
        ...
        #                                                                         "gather_relation_person_type_code": self.DE_AddAll_List[0][26].text(),
        #
        #                                                                         "Gather_Info Media File":
        #                                                                             {"0":
        #                                                                                  {'gather_media_type': self.DE_AddAll_List[all][27].text(),
        #                                                                                   'gather_hash_type': self.DE_AddAll_List[all][28].text(),
        #                                                                                   'gather_hash': self.DE_AddAll_List[all][29].text(),
        #                                                                                   'gather_path': self.DE_AddAll_List[all][30].text(),
        #                                                                                   'gather_metadata': self.DE_AddAll_List[all][31].text()}}
        #                                                                             },
        #                                                                    "Other_ Files":
        #                                                                        {"0":
        #                                                                             {'other_files_id': self.DE_AddAll_List[all][32].text(),
        #                                                                              'other_files_type': self.DE_AddAll_List[all][33].text(),
        #                                                                              'other_files_size': self.DE_AddAll_List[all][34].text(),
        #                                                                              'other_files_path': self.DE_AddAll_List[all][35].text(),
        #                                                                              'other_files_hash_type': self.DE_AddAll_List[all][36].text(),
        #                                                                              'other_files_hash_value': self.DE_AddAll_List[all][37].text(),
        #                                                                              'other_files_file_description': self.DE_AddAll_List[all][38].text(),
        #                                                                              'other_files_file_metadata': self.DE_AddAll_List[all][39].text()
        #                                                                              }
        #
        #                                                                         }
        #                                                                       ,
        ...
        #                                                                        {"0":
        #                                                                             {
        #                                                                                 'authentication_management_id': self.DE_AddAll_List[all][40].text(),
        #                                                                                 'authentication_person_name': self.DE_AddAll_List[all][41].text(),
        #                                                                                 'authentication_date_time': self.DE_AddAll_List[all][42].text(),
        #                                                                                 'authentication_location': self.DE_AddAll_List[all][43].text(),
        #                                                                                 'authentication_tool': self.DE_AddAll_List[all][44].text(),
        #                                                                                 'authentication_tool_version': self.DE_AddAll_List[all][45].text(),
        #                                                                                 'authentication_person_party_name': self.DE_AddAll_List[all][46].text() ,
        #
        #                                                                                 "Digital Evidence Files":
        #                                                                                     {"0":
        #                                                                                          {"serial_no": self.DE_AddAll_List[all][47].text(),
        #                                                                                           "digital_evidence_management_id": self.DE_AddAll_List[all][48].text(),
        #                                                                                           "digital_evidence_type": self.DE_AddAll_List[all][49].text(),
        #                                                                                           "evidences_gathering_type": self.DE_AddAll_List[all][50].text(),
        #                                                                                           "gather_management_id": self.DE_AddAll_List[all][51].text(),
        #                                                                                           "file_name": self.DE_AddAll_List[all][52].text(),
        #                                                                                           "file_path": self.DE_AddAll_List[all][53].text(),
        #                                                                                           "hash_type": self.DE_AddAll_List[all][54].text() ,
        #                                                                                           "hash_value": self.DE_AddAll_List[all][55].text() ,
        #                                                                                           "sector_size": self.DE_AddAll_List[all][56].text() ,
        #                                                                                           "file_size": self.DE_AddAll_List[all][57].text() ,
        #                                                                                           "metadata": self. DE_AddAll_List[all][58].text()
        #                                                                                           }
        #                                                                                      }
        #                                                                                 }
        #                                                                         }
        ...
        file_data["Logs"] = {0: {"log_management": self.Log_List[0][0].text(),
        ...
        for n in range (0, len(self.Log_List)):
            ...
            file_data["Logs"][n] = {"log_management": self.Log_List[n][0].text(),
...
# gather를 좀더 손봐서 해보면 될듯. 아직 완벽한 상황은 아님