...
class Ui_SecondWindow(object):
    ...
    def Easy_Export(self):
        ...
        file_data["Digital Evidence Package"]["Digital Evidences"] = {0:{"Vessel_Info":
                                                                                   ...
                                                                                   'Gather Info':
                                                                                       {"gather_management_id": self.DE_AddAll_List[0][17].text(),
                                                                                        ...
                                                                                        "Gather Info Media File":
                                                                                            {0:
                                                                                                 {'gather_media_type': self.DE_Gather_Info_List[0][0][0].text(),
                                                                                                  'gather_hash_type': self.DE_Gather_Info_List[0][0][1].text(),
                                                                                                  'gather_hash': self.DE_Gather_Info_List[0][0][2].text(),
                                                                                                  'gather_path': self.DE_Gather_Info_List[0][0][3].text(),
                                                                                                  'gather_metadata': self.DE_Gather_Info_List[0][0][4].text()}}}
                                                                                           ,
                                                                                        "Other Files":
                                                                                            {0:
                                                                                                 {'other_files_id':self.DE_Other_Files_List[0][0][0].text(),
                                                                                                  'other_files_type':self.DE_Other_Files_List[0][0][0].text(),
                                                                                                  'other_files_size':self.DE_Other_Files_List[0][0][0].text(),
                                                                                                  'other_files_path': self.DE_Other_Files_List[0][0][0].text(),
                                                                                                  'other_files_hash_type':self.DE_Other_Files_List[0][0][0].text(),
                                                                                                  'other_files_hash_value':self.DE_Other_Files_List[0][0][0].text(),
                                                                                                  'other_files_file_description':self.DE_Other_Files_List[0][0][0].text(),
                                                                                                  'other_files_file_metadata':self.DE_Other_Files_List[0][0][0].text()
                                                                                                  }
        ...
        try:
            for all in range(1, 100): #100
                for g in range (0, len(self.DE_Gather_Info_List[all])):
                # for o in range (0, len(self.DE_Other_Files_List[all])):
                # for a in range (0, len(self.DE_Acquisition_Info_List[all])):
                    file_data["Digital Evidence Package"]["Digital Evidences"][all] = {"Vessel_Info":
                                                                                   ...
                                                                                   'Gather Info':
                                                                                       {"gather_management_id": self.DE_AddAll_List[all][17].text(),
                                                                                        ...
                                                                                        "Gather Info Media File":
                                                                                            {0:
                                                                                                 {'gather_media_type': self.DE_Gather_Info_List[all][g][0].text(),
                                                                                                  'gather_hash_type': self.DE_Gather_Info_List[all][g][1].text(),
                                                                                                  'gather_hash': self.DE_Gather_Info_List[all][g][2].text(),
                                                                                                  'gather_path': self.DE_Gather_Info_List[all][g][3].text(),
                                                                                                  'gather_metadata': self.DE_Gather_Info_List[all][g][4].text()}}}
                                                                                            ,
                                                                                    "Other Files":
                                                                                   {0:
                                                                                        {'other_files_id': self.DE_Other_Files_List[all][0][0].text(),
                                                                                         'other_files_type': self.DE_Other_Files_List[all][0][0].text(),
                                                                                         'other_files_size': self.DE_Other_Files_List[all][0][0].text(),
                                                                                         'other_files_path': self.DE_Other_Files_List[all][0][0].text(),
                                                                                         'other_files_hash_type': self.DE_Other_Files_List[all][0][0].text(),
                                                                                         'other_files_hash_value': self.DE_Other_Files_List[all][0][0].text(),
                                                                                         'other_files_file_description': self.DE_Other_Files_List[all][0][0].text(),
                                                                                         'other_files_file_metadata': self.DE_Other_Files_List[all][0][0].text()
                                                                                         }
                                                                               ...
                                                                               #     {0:
                                                                               #          {
                                                                               #              'authentication_management_id': self.DE_Acquisition_Info_List[all][a][0].text(),
                                                                               #              'authentication_person_name': self.DE_Acquisition_Info_List[all][a][0].text(),
                                                                               #              'authentication_date_time': self.DE_Acquisition_Info_List[all][a][0].text(),
                                                                               #              'authentication_location': self.DE_Acquisition_Info_List[all][a][0].text(),
                                                                               #              'authentication_tool': self.DE_Acquisition_Info_List[all][a][0].text(),
                                                                               #              'authentication_tool_version': self.DE_Acquisition_Info_List[all][a][0].text(),
                                                                               #              'authentication_person_party_name': self.DE_Acquisition_Info_List[all][a][0].text() ,
                                                                               #
                                                                               #              "Digital Evidence Files":
                                                                               #                  {"0":
            ...
            for big in range(0, 100): #100
                    for o in range(0, len(self.DE_Other_Files_List[big])):
                        file_data["Digital Evidence Package"]["Digital Evidences"][big]["Other Files"][o]= {
                                                                                                  'other_files_id': self.DE_Other_Files_List[big][o][0].text(),
...
# other 완성. 이제 그대로 따라하면서 acquisition을 만들어 봅시다!