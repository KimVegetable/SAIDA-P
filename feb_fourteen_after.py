...
class Ui_SecondWindow(object):
            ...
            with open(self.file_path, 'r', encoding="utf-8") as f:
                ...
                for i in range(0, len(data['Digital Evidence Package']['Digital Evidences'])):
                    ...
                    if i == 0:
                        ...
                        vessel_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info']['vessel_name']
                        vessel_management_id = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info']['vessel_management_id']
                        ...
                        vessel_length = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info'][
                            'vessel_length']
                        total_number_of_equipment_with_track = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info']['total_number_of_equipment_with_track']
                        vessel_type = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Vessel Info']['vessel_type']
                        ...
                        device_management_id = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                                'device_management_id']
                        device_type = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                                'device_type']
                        device_manufacturer = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info']['device_manufacturer']
                        device_model_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                                'device_model_name']
                        device_model_serial_number = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                                'device_model_serial_number']
                        device_os_firmware = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                                'device_os_firmware']
                        device_descripton = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Marine Electronics Info'][
                                'device_description']
                        ...
                        gather_location = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                            'gather_location']
                        gather_person_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                            'gather_person_name']
                        gather_datetime = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                            'gather_datetime']
                        gather_person_agency = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                            'gather_person_agency']
                        gather_person_rank = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                            'gather_person_rank']
                        ...
                        submitter_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                            'submitter_name']
                        gather_source_name = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info'][
                            'gather_source_name']
                        ...
                        self.DE_Gather_Info_Gather_Relation_Person_Type_Code___lineEdit_1.setText(
                            gather_relation_person_type_code)

                        ##################Gather Info _ Media File 부분####################
                        len(data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['Gather Info Media File'])

                        for j in range(0, len(data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['Gather Info Media File'])):

                            if j == 0:
                                gather_media_type = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['Gather Info Media File'][str(j)]['gather_media_type']
                                gather_hash_type = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['Gather Info Media File'][str(j)]['gather_hash_type']
                                gather_hash = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['Gather Info Media File'][str(j)]['gather_hash']
                                gather_path = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['Gather Info Media File'][str(j)]['gather_path']
                                gather_metadata = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Gather Info']['Gather Info Media File'][str(j)]['gather_metadata']
                                ...
                                tmp_DE_Gather_Info_file__horizontalLayout_1.setObjectName(
                                    "DE_Gather_Info_file__horizontalLayout_1")
                                ...
                                tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1.setGeometry(
                                    QtCore.QRect(0, -139, 381, 219))
                                tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1.setObjectName(
                                    "DE_Gather_Info_file__scrollAreaWidgetContents_1")
                                tmp_gridLayout_18 = QtWidgets.QGridLayout(
                                ...
                                tmp_DE_Gather_Info_file__verticalLayout_1.setObjectName(
                                    "DE_Gather_Info_file__verticalLayout_1")
                                ...
                                tmp_DE_Gather_Info_file__filebrowse__label_1.setObjectName(
                                    "DE_Gather_Info_file__filebrowse__label_1")
                                ...
                                tmp_DE_Gather_Info_file__filebrowse__lineEdit_1.setObjectName(
                                    "DE_Gather_Info_file__filebrowse__lineEdit_1")
                                tmp_DE_Gather_Info_file__filebrowse__horizontalLayout_1.addWidget(
                                ...
                                tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(
                                    tmp_DE_Gather_Info_file__filebrowse__horizontalLayout_1)
                                ...
                                tmp_DE_Gather_Info_gather_media_type__label_1.setObjectName(
                                    "DE_Gather_Info_gather_media_type__label_1")
                                ...
                                tmp_DE_Gather_Info__gather_hash_type__label_1.setObjectName(
                                    "DE_Gather_Info__gather_hash_type__label_1")
                                ...
                                tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(
                                    tmp_DE_Gather_Info_gather_hash_type__horizontalLayout_1)
                                ...
                                tmp_DE_Gather_Info_gather_hash__label_1.setObjectName(
                                    "DE_Gather_Info_gather_hash__label_1")
                                tmp_DE_Gather_Info_gather_hash__horizontalLayout_1.addWidget(
                                    tmp_DE_Gather_Info_gather_hash__label_1)
                                tmp_DE_Gather_Info_gather_hash__lineEdit_1 = QtWidgets.QLineEdit(
                                    tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
                                tmp_DE_Gather_Info_gather_hash__lineEdit_1.setObjectName(
                                    "DE_Gather_Info_gather_hash__lineEdit_1")
                                tmp_DE_Gather_Info_gather_hash__horizontalLayout_1.addWidget(
                                    tmp_DE_Gather_Info_gather_hash__lineEdit_1)
                                tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(
                                    tmp_DE_Gather_Info_gather_hash__horizontalLayout_1)
                                ...
                                tmp_DE_Gather_Info_gather_path__label_1.setObjectName(
                                    "DE_Gather_Info_gather_path__label_1")
                                tmp_DE_Gather_Info_gather_path__horizontalLayout_1.addWidget(
                                    tmp_DE_Gather_Info_gather_path__label_1)
                                tmp_DE_Gather_Info_gather_path__lineEdit_1 = QtWidgets.QLineEdit(
                                    tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
                                tmp_DE_Gather_Info_gather_path__lineEdit_1.setObjectName(
                                    "DE_Gather_Info_gather_path__lineEdit_1")
                                tmp_DE_Gather_Info_gather_path__horizontalLayout_1.addWidget(
                                    tmp_DE_Gather_Info_gather_path__lineEdit_1)
                                tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(
                                    tmp_DE_Gather_Info_gather_path__horizontalLayout_1)
                                ...
                                tmp_DE_Gather_Info_gather_metadata__label_1 = QtWidgets.QLabel(
                                    tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
                                tmp_DE_Gather_Info_gather_metadata__label_1.setObjectName(
                                    "DE_Gather_Info_gather_metadata__label_1")
                                ...
                                tmp_DE_Gather_Info_gather_metadata__lineEdit_1 = QtWidgets.QLineEdit(
                                    tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
                                tmp_DE_Gather_Info_gather_metadata__lineEdit_1.setObjectName(
                                    "DE_Gather_Info_gather_metadata__lineEdit_1")
                                tmp_DE_Gather_Info_gather_metadata__horizontalLayout_1.addWidget(
                                    tmp_DE_Gather_Info_gather_metadata__lineEdit_1)
                                tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(
                                    tmp_DE_Gather_Info_gather_metadata__horizontalLayout_1)
                                tmp_gridLayout_18.addLayout(tmp_DE_Gather_Info_file__verticalLayout_1, 1, 0, 1, 1)
                                tmp_DE_Gather_Info_file__scrollArea_1.setWidget(
                                    tmp_DE_Gather_Info_file__scrollAreaWidgetContents_1)
                                tmp_DE_Gather_Info_file__horizontalLayout_1.addWidget(
                                    tmp_DE_Gather_Info_file__scrollArea_1)
                                tmp_gridLayout_27.addLayout(tmp_DE_Gather_Info_file__horizontalLayout_1, 0, 0, 1, 1)

                                self.DE_Gather_Info_Tab_Widget_List[i].addTab(tmp_tab_8, "Tab" + str(len(self.DE_Gather_Info_List[i]) + 1))
                    ...
                    for j in range(0, len(data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'])):

                        if j == 0:

                            id = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                                'other_files_id']
                            type = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                                'other_files_type']
                            file_size = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                                'other_files_size']
                            file_path = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                                'other_files_path']
                            file_hash_type = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                                'other_files_hash_type']
                            file_hash_value = \
                                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                                    'other_files_hash_value']
                            file_description = \
                                data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                                    'other_files_file_description']
                            file_metadata = data['Digital Evidence Package']['Digital Evidences'][str(i)]['Other Files'][str(j)][
                            ...
                            self.DE_Other_Files_Tab_Widget_List[i].addTab(tmp_tab_4, "Tab" + str(len(self.DE_Other_Files_List[i]) + 1))
                            ...
                            self.DE_Other_Files_Button_List[i][tmp_len][0].clicked.connect(
                                lambda: self.DE_Other_Files_file_browse__browseButton_1_QFileDialog(i, tmp_len))

                            self.DE_Other_Files_Button_List[i][tmp_len][1].clicked.connect(
                                lambda: self.DE_Other_Files_file_browse__EnterButton_1_Calculate(i, tmp_len)
                            )
                            # </Other>
                    ...
                    for j in range(0, len(data['Digital Evidence Package']['Digital Evidences'][str(i)]['Authentication Info'])):

                        if j == 0:

                            authentication_id = \
                            data['Digital Evidence Package']['Digital Evidences'][str(i)]['Authentication Info'][str(j)][
                            ...
                            self.DE_Acquisition_Info_acquisition_person_name__lineEdit_1.setText(
                                authentication_person_name)
                            ...
                            self.DE_Acquisition_Info_acquisition_tool_version__lineEdit_1.setText(
                                authentication_tool_version)
                            self.DE_Authentication_Person_Party_Name__lineEdit_1.setText(
                                authentication_person_party_name)
                            ...
                            for k in range(0, len(data['Digital Evidence Package']['Digital Evidences'][str(i)][
                                ...
                                if k == 0:
                                    ...
                                    self.DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1.setText(
                                        digital_evidence_type)
                                    self.DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1.setText(
                                        evidences_gathering_type)
                                    self.DE_Acquisition_Info_DEF_gather_no__lineEdit_1.setText(gather_no)
                                    self.DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1.setText(
                                        DEF_file_name)
                                    self.DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1.setText(
                                        DEF_file_path)
                                    ...
                                    tmp_gridLayout_15.addLayout(tmp_DE_Acquisition_Info__DEF_file__verticalLayout_1, 0,
                                                                0,
                                                                1, 1)
                                    ...
                                    self.DE_Acquisition_Info_DEF_Tab_Widget_List[i][j].addTab(tmp_DEF_tab, "Tab" + str(
                                        len(self.DE_Acquisition_Info_DEF_List[i][j]) + 1))  #
                                    ...
                                    tmp_list.append(
                                        tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1)  # 3
                                    ...
                                    tmp_list.append(
                                        tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1)  # 5
                                    tmp_list.append(
                                        tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1)  # 6
                                    ...
                                    self.DE_Acquisition_Info_DEF_Button_List[i][j][tmp_len][0].clicked.connect(
                                        lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(i, j,
                                                                                                                tmp_len))
                                    self.DE_Acquisition_Info_DEF_Button_List[i][j][tmp_len][1].clicked.connect(
                                        lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(i, j,
                                                                                                             tmp_len))
                            ...
                            tmp_gridLayout_4.addLayout(tmp_DE_Acquisition_Info_DEF__addButton__horizontalLayout_1, 1, 0,
                                                       1, 1)
                            ...
                            # <Acquisition>
                            self.DE_Acquisition_Info_Tab_Widget_List[i].addTab(tmp_Acquisition_tab, "Tab" + str(len(self.DE_Acquisition_Info_List[i]) + 1))
                            ...
                            tmp_DE_Acquisition_Info_acquisition_person_name__lineEdit_1.setText(authentication_person_name)
                            tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1.setText(authentication_date_time)
                            tmp_DE_Acquisition_Info_acquisition_location__lineEdit_1.setText(authentication_location)
                            tmp_DE_Acquisition_Info_acquisition_tool__lineEdit_1.setText(authentication_tool)
                            tmp_DE_Acquisition_Info_acquisition_tool_version__lineEdit_1.setText(authentication_tool_version)
                            tmp_DE_Authentication_Person_Party_Name__lineEdit_1.setText(authentication_person_party_name)
                            ...
                            self.DE_Acquisition_Info_DEF_List[i][len(self.DE_Acquisition_Info_DEF_List[i]) - 1].append(
                                tmp_list)
                            ...
                            self.DE_Acquisition_Info_DEF_Button_List[mp_len][mp_lenn][mp_lennn][0].clicked.connect(
                                lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(mp_len, mp_lenn,
                                                                                                        mp_lennn))

                            self.DE_Acquisition_Info_DEF_Button_List[mp_len][mp_lenn][mp_lennn][1].clicked.connect(
                                lambda: self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(mp_len, mp_lenn,
                                                                                                     mp_lennn))
                            ...
                            self.DEF_AddButton_List[i][tmp_len][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab(i, tmp_len))
                ...
                for i in range(0, len(data['Logs'])):
                    ...
                    if i == 0:
                        ...
                        self.Log_digital_evidence_package_management_id__lineEdit_1.setText(
                            str(int(digital_evidence_package_management_id) + 1))
    ...
    def Easy_Export(self):
        ...
        datetime.datetime.now()
        now = datetime.datetime.now()
        self.Log_Digital_Evidence_Pack_History_End_Date_Time__lineEdit_1.setText(str(now))
        ...
        file_data["Digital Evidence Package"] = {"Case Info":
                                                 ...
                                                 "Digital Evidences": {0:
                                                                            {"Vessel Info":
                                                                               {"vessel_name": self.DE_AddAll_List[0][0].text(),
                                                                                "vessel_management_id": self.DE_AddAll_List[0][1].text(),
                                                                                "vessel_MMSI": self.DE_AddAll_List[0][2].text(),
                                                                                "vessel_callsign": self.DE_AddAll_List[0][3].text(),
                                                                                "vessel_IMO": self.DE_AddAll_List[0][4].text(),
                                                                                "vessel_MRN": self.DE_AddAll_List[0][5].text(),
                                                                                "vessel_tonnage": self.DE_AddAll_List[0][6].text(),
                                                                                "vessel_length": self.DE_AddAll_List[0][7].text(),
                                                                                "total_number_of_equipment_with_track": self.DE_AddAll_List[0][8].text(),
                                                                                "vessel_type": self.DE_AddAll_List[0][9].text()
                                                                                                                                }

                                                                                ,

                                                                           'Marine Electronics Info':
                                                                               {"device_management_id": self.DE_AddAll_List[0][10].text(),
                                                                                "device_type": self.DE_AddAll_List[0][11].text(),
                                                                                "device_manufacturer": self.DE_AddAll_List[0][12].text(),
                                                                                "device_model_name": self.DE_AddAll_List[0][13].text(),
                                                                                "device_model_serial_number": self.DE_AddAll_List[0][14].text(),
                                                                                "device_os_firmware": self.DE_AddAll_List[0][15].text(),
                                                                                "device_description": self.DE_AddAll_List[0][16].text()
                                                                                                                                        }
                                                                                ,

                                                                           'Gather Info':
                                                                               {"gather_management_id": self.DE_AddAll_List[0][17].text(),
                                                                                "gather_location": self.DE_AddAll_List[0][18].text(),
                                                                                "gather_person_name": self.DE_AddAll_List[0][19].text(),
                                                                                "gather_datetime": self.DE_AddAll_List[0][20].text(),
                                                                                "gather_person_agency": self.DE_AddAll_List[0][21].text(),
                                                                                "gather_person_rank": self.DE_AddAll_List[0][22].text(),
                                                                                "gather_organization_code": self.DE_AddAll_List[0][23].text(),
                                                                                "submitter_name" : self.DE_AddAll_List[0][24].text(),
                                                                                "gather_source_name" : self.DE_AddAll_List[0][25].text(),
                                                                                "gather_relation_person_type_code": self.DE_AddAll_List[0][26].text(),

                                                                                "Gather Info Media File":
                                                                                    {0:
                                                                                         {'gather_media_type': self.DE_Gather_Info_List[0][0][1].text(),
                                                                                          'gather_hash_type': self.DE_Gather_Info_List[0][0][2].text(),
                                                                                          'gather_hash': self.DE_Gather_Info_List[0][0][3].text(),
                                                                                          'gather_path': self.DE_Gather_Info_List[0][0][4].text(),
                                                                                          'gather_metadata': self.DE_Gather_Info_List[0][0][5].text()
                                                                                                                                                        }
                                                                                                                                                            }
                                                                                                                                                                }
                                                                                   ,
                                                                           "Other Files":
                                                                                {0:
                                                                                     {'other_files_id':self.DE_Other_Files_List[0][0][1].text(),
                                                                                      'other_files_type':self.DE_Other_Files_List[0][0][2].text(),
                                                                                      'other_files_size':self.DE_Other_Files_List[0][0][3].text(),
                                                                                      'other_files_path': self.DE_Other_Files_List[0][0][4].text(),
                                                                                      'other_files_hash_type':self.DE_Other_Files_List[0][0][5].text(),
                                                                                      'other_files_hash_value':self.DE_Other_Files_List[0][0][6].text(),
                                                                                      'other_files_file_description':self.DE_Other_Files_List[0][0][7].text(),
                                                                                      'other_files_file_metadata':self.DE_Other_Files_List[0][0][8].text()
                                                                                                                                                                }
                                                                                                                                                                    }
                                                                                ,
                                                                           "Authentication Info":
                                                                                {0:
                                                                                     {
                                                                                         'authentication_management_id': self.DE_Acquisition_Info_List[0][0][0].text(),
                                                                                         'authentication_person_name': self.DE_Acquisition_Info_List[0][0][0].text(),
                                                                                         'authentication_date_time': self.DE_Acquisition_Info_List[0][0][0].text(),
                                                                                         'authentication_location': self.DE_Acquisition_Info_List[0][0][0].text(),
                                                                                         'authentication_tool': self.DE_Acquisition_Info_List[0][0][0].text(),
                                                                                         'authentication_tool_version': self.DE_Acquisition_Info_List[0][0][0].text(),
                                                                                         'authentication_person_party_name': self.DE_Acquisition_Info_List[0][0][0].text() ,

                                                                                         "Digital Evidence Files":
                                                                                             {0:
                                                                                                  {"serial_no": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "digital_evidence_management_id": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "digital_evidence_type":self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "evidences_gathering_type": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "gather_management_id": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "file_name": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "file_path": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "hash_type": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text() ,
                                                                                                   "hash_value": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text() ,
                                                                                                   "sector_size": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text(),
                                                                                                   "file_size": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text() ,
                                                                                                   "metadata": self.DE_Acquisition_Info_DEF_List[0][0][0][0].text()
                                                                                                                                                                    }
                                                                                                                                                                        }
                                                                                                                                                                            }
                                                                                                                                                                                }
                                                 ...
                                                 "Analysis Info":
                                                     {"Reports":
                                                       {0:
                                                            ...
                                                            "equipment_management_id": self.AIReports_List[0][3].text(),
                                                            "submission_agency": self.AIReports_List[0][4].text(),
                                                            "report_creation_datetime": self.AIReports_List[0][5].text(),
                                                            "division_name_of_report_maker":self.AIReports_List[0][6].text(),
                                                            "team_name_of_report_maker":self.AIReports_List[0][7].text(),
                                                            "file_name": self.AIReports_List[0][8].text(),
                                                            "file_size": self.AIReports_List[0][9].text(),
                                                            "file_path": self.AIReports_List[0][10].text(),
                                                            "file_creation_datetime": self.AIReports_List[0][11].text(),
                                                            "file_description": self.AIReports_List[0][12].text(),
                                                            "hash_type": self.AIReports_List[0][13].text(),
                                                            "hash_value": self.AIReports_List[0][14].text()}
                                                                                                                }
                                                      ,
                                                      "Equipment Traces":
                                                          {0:
                                                               {"id": self.AI_EquipmentTraces_List[0][0].text(),
                                                                ...
                                                                "description": self.AI_EquipmentTraces_List[0][2].text(),
                                                                "equipment_traces_management_id":self.AI_EquipmentTraces_List[0][3].text(),
                                                                "vessel_id": self.AI_EquipmentTraces_List[0][4].text(),
                                                                "evidence_id": self.AI_EquipmentTraces_List[0][5].text(),
                                                                "power_on_time": self.AI_EquipmentTraces_List[0][6].text(),
                                                                "track_extraction_description":self.AI_EquipmentTraces_List[0][7].text(),
                                                                "system_info_description":self.AI_EquipmentTraces_List[0][8].text(),
                                                                "operation_status": self.AI_EquipmentTraces_List[0][9].text(),
                                                                "power_off_time": self.AI_EquipmentTraces_List[0][10].text(),
                                                                "track_recording_period":self.AI_EquipmentTraces_List[0][11].text(),
                                                                "track_deletion_trace": self.AI_EquipmentTraces_List[0][12].text(),
                                                                "trace_notes": self.AI_EquipmentTraces_List[0][13].text()
                                                                }
                                                           }
                                                      ,
                                                      "Other Files":
                                                          {0:
                                                          {"id": self.AI_List[0][0].text(),
                                                           "type": self.AI_List[0][1].text(),
                                                           "file_size": self.AI_List[0][2].text(),
                                                           "file_path": self.AI_List[0][3].text(),
                                                           "file_hash_type": self.AI_List[0][4].text(),
                                                           "file_hash_value": self.AI_List[0][5].text(),
                                                           "file_description": self.AI_List[0][6].text(),
                                                           "file_metadata": self.AI_List[0][7].text(),
                                                           }
        ...
        for all in range(1, len(self.DE_AddAll_List)): #100
            ...
            file_data["Digital Evidence Package"]["Digital Evidences"][all] = {"Vessel Info":
                                                                               {"vessel_name": self.DE_AddAll_List[all][0].text(),
                                                                                "vessel_management_id": self.DE_AddAll_List[all][1].text(),
                                                                                "vessel_MMSI": self.DE_AddAll_List[all][2].text(),
                                                                                "vessel_callsign": self.DE_AddAll_List[all][3].text(),
                                                                                "vessel_IMO": self.DE_AddAll_List[all][4].text(),
                                                                                "vessel_MRN": self.DE_AddAll_List[all][5].text(),
                                                                                "vessel_tonnage": self.DE_AddAll_List[all][6].text(),
                                                                                "vessel_length": self.DE_AddAll_List[all][7].text(),
                                                                                "total_number_of_equipment_with_track": self.DE_AddAll_List[all][8].text(),
                                                                                "vessel_type": self.DE_AddAll_List[all][9].text()},

                                                                           'Marine Electronics Info':
                                                                               {"device_management_id": self.DE_AddAll_List[all][10].text(),
                                                                                "device_type": self.DE_AddAll_List[all][11].text(),
                                                                                "device_manufacturer": self.DE_AddAll_List[all][12].text(),
                                                                                "device_model_name": self.DE_AddAll_List[all][13].text(),
                                                                                "device_model_serial_number": self.DE_AddAll_List[all][14].text(),
                                                                                "device_os_firmware": self.DE_AddAll_List[all][15].text(),
                                                                                "device_description": self.DE_AddAll_List[all][16].text()
                                                                                },

                                                                           'Gather Info':
                                                                               {"gather_management_id": self.DE_AddAll_List[all][17].text(),
                                                                                "gather_location": self.DE_AddAll_List[all][18].text(),
                                                                                "gather_person_name": self.DE_AddAll_List[all][19].text(),
                                                                                "gather_datetime": self.DE_AddAll_List[all][20].text(),
                                                                                "gather_person_agency": self.DE_AddAll_List[all][21].text(),
                                                                                "gather_person_rank": self.DE_AddAll_List[all][22].text(),
                                                                                "gather_organization_code": self.DE_AddAll_List[all][23].text(),
                                                                                "submitter_name" : self.DE_AddAll_List[all][24].text(),
                                                                                "gather_source_name" : self.DE_AddAll_List[all][25].text(),
                                                                                "gather_relation_person_type_code": self.DE_AddAll_List[0][26].text(),

                                                                                "Gather Info Media File":
                                                                                    {0:
                                                                                         {'gather_media_type': self.DE_Gather_Info_List[all][0][1].text(),
                                                                                          'gather_hash_type': self.DE_Gather_Info_List[all][0][2].text(),
                                                                                          'gather_hash': self.DE_Gather_Info_List[all][0][3].text(),
                                                                                          'gather_path': self.DE_Gather_Info_List[all][0][4].text(),
                                                                                          'gather_metadata': self.DE_Gather_Info_List[all][0][5].text()}}}
                                                                                    ,
                                                                            "Other Files":
                                                                           {0:
                                                                                {'other_files_id': self.DE_Other_Files_List[all][0][1].text(),
                                                                                 'other_files_type': self.DE_Other_Files_List[all][0][2].text(),
                                                                                 'other_files_size': self.DE_Other_Files_List[all][0][3].text(),
                                                                                 'other_files_path': self.DE_Other_Files_List[all][0][4].text(),
                                                                                 'other_files_hash_type': self.DE_Other_Files_List[all][0][5].text(),
                                                                                 'other_files_hash_value': self.DE_Other_Files_List[all][0][6].text(),
                                                                                 'other_files_file_description': self.DE_Other_Files_List[all][0][7].text(),
                                                                                 'other_files_file_metadata': self.DE_Other_Files_List[all][0][8].text()
                                                                                 }
                ...
                ,
                                                                           "Authentication Info":
                                                                               {0:
                                                                                   {
                                                                                       'authentication_management_id':self.DE_Acquisition_Info_List[all][0][0].text(),
                                                                                       'authentication_person_name':self.DE_Acquisition_Info_List[all][0][1].text(),
                                                                                       'authentication_date_time':self.DE_Acquisition_Info_List[all][0][2].text(),
                                                                                       'authentication_location':self.DE_Acquisition_Info_List[all][0][3].text(),
                                                                                       'authentication_tool':self.DE_Acquisition_Info_List[all][0][4].text(),
                                                                                       'authentication_tool_version':self.DE_Acquisition_Info_List[all][0][5].text(),
                                                                                       'authentication_person_party_name':self.DE_Acquisition_Info_List[all][0][6].text(),

                                                                                       "Digital Evidence Files":
                                                                                           {"0":
                                                                                                {
                                                                                                    "serial_no":self.DE_Acquisition_Info_DEF_List[all][0][0][0].text(),
                                                                                                    "digital_evidence_management_id":self.DE_Acquisition_Info_DEF_List[all][0][0][1].text(),
                                                                                                    "digital_evidence_type":self.DE_Acquisition_Info_DEF_List[all][0][0][2].text(),
                                                                                                    "evidences_gathering_type":self.DE_Acquisition_Info_DEF_List[all][0][0][3].text(),
                                                                                                    "gather_management_id":self.DE_Acquisition_Info_DEF_List[all][0][0][4].text(),
                                                                                                    "file_name":self.DE_Acquisition_Info_DEF_List[all][0][0][5].text(),
                                                                                                    "file_path":self.DE_Acquisition_Info_DEF_List[all][0][0][6].text(),
                                                                                                    "hash_type":self.DE_Acquisition_Info_DEF_List[all][0][0][7].text(),
                                                                                                    "hash_value":self.DE_Acquisition_Info_DEF_List[all][0][0][8].text(),
                                                                                                    "sector_size":self.DE_Acquisition_Info_DEF_List[all][0][0][9].text(),
                                                                                                    "file_size":self.DE_Acquisition_Info_DEF_List[all][0][0][10].text(),
                                                                                                    "metadata":self.DE_Acquisition_Info_DEF_List[all][0][0][11].text()
                                                                                                    }
                                                                                            }
                                                                                   }}}
        ...
        try:
            for big in range(0, 100): #100
                    for g in range(0, len(self.DE_Gather_Info_List[ big])):
                        file_data["Digital Evidence Package"]["Digital Evidences"][big]["Gather Info"]["Gather Info Media File"][g]= {
                                                                                                                                      ...
                                                                                                                                      'gather_metadata':self.DE_Gather_Info_List[big][g][5].text()
                                                                                                                                                                                                    }
                                                                                                                    ...
                                                                                                                    {"0":
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            "digital_evidence_management_id": self.DE_Acquisition_Info_DEF_List[big][a][0][1].text(),
                                                                                                                            ...
                                                                                                                            "file_name": self.DE_Acquisition_Info_DEF_List[big][a][0][5].text(),
                                                                                                                            "file_path": self.DE_Acquisition_Info_DEF_List[big][a][0][6].text(),
                                                                                                                            "hash_type": self.DE_Acquisition_Info_DEF_List[big][a][0][7].text(),
                                                                                                                            "hash_value": self.DE_Acquisition_Info_DEF_List[big][a][0][8].text(),
                                                                                                                            "sector_size": self.DE_Acquisition_Info_DEF_List[big][a][0][9].text(),
                                                                                                                            "file_size": self.DE_Acquisition_Info_DEF_List[big][a][0][10].text(),
                                                                                                                            "metadata": self.DE_Acquisition_Info_DEF_List[big][a][0][11].text()
                                                                                                                        }
                                                                                                                                                                                                                 }}
                ...
                for a in range (0, len(self.DE_Acquisition_Info_List[big])):
                    for d in range (1, len(self.DE_Acquisition_Info_DEF_List[big][a])):
                        file_data["Digital Evidence Package"]["Digital Evidences"][big]["Authentication Info"][a]["Digital Evidence Files"][d] = {
                                                                                                                                                    ...
                                                                                                                                                    "file_name": self.DE_Acquisition_Info_DEF_List[big][a][d][5].text(),
                                                                                                                                                    "file_path": self.DE_Acquisition_Info_DEF_List[big][a][d][6].text(),
                                                                                                                                                    "hash_type": self.DE_Acquisition_Info_DEF_List[big][a][d][7].text(),
                                                                                                                                                    "hash_value": self.DE_Acquisition_Info_DEF_List[big][a][d][8].text(),
                                                                                                                                                    "sector_size": self.DE_Acquisition_Info_DEF_List[big][a][d][9].text(),
                                                                                                                                                    "file_size": self.DE_Acquisition_Info_DEF_List[big][a][d][10].text(),
                                                                                                                                                    "metadata": self.DE_Acquisition_Info_DEF_List[big][a][d][11].text()}
        except:
            pass
        ...
        for r in range (1, len(self.AIReports_List)):
            ...
            file_data["Digital Evidence Package"]["Analysis Info"]["Reports"][r] =     {"id": self.AIReports_List[r][0].text(),
                                                                                        ...
                                                                                        "file_name": self.AIReports_List[r][8].text(),
                                                                                        "file_size": self.AIReports_List[r][9].text(),
                                                                                        "file_path": self.AIReports_List[r][10].text(),
                                                                                        "file_creation_datetime": self.AIReports_List[r][11].text(),
                                                                                        "file_description": self.AIReports_List[r][12].text(),
                                                                                        "hash_type": self.AIReports_List[r][13].text(),
                                                                                        "hash_value": self.AIReports_List[r][14].text()}

        for e in range (1, len(self.AI_EquipmentTraces_List)):

            file_data["Digital Evidence Package"]["Analysis Info"]["Equipment Traces"][e] = {"id": self.AI_EquipmentTraces_List[e][0].text(),
        ...
        for o in range (1, len(self.AI_List)):
            ...
            file_data["Digital Evidence Package"]["Analysis Info"]["Other Files"][o] = {"id": self.AI_List[o][0].text(),
                                                                                                     "type": self.AI_List[o][1].text(),
                                                                                                    "file_size": self.AI_List[o][2].text(),
                                                                                                     "file_path": self.AI_List[o][3].text(),
                                                                                                        "file_hash_type": self.AI_List[o][4].text(),
                                                                                                        "file_hash_value": self.AI_List[o][5].text(),
                                                                                                         "file_description": self.AI_List[o][6].text(),
                                                                                                        "file_metadata": self.AI_List[o][7].text(),
                                                                                                   }
    ...
    def ExportButton_exporttojsonfile(self):
        ...
        for list in self.DE_AddAll_List:
            ...
            ##
            tmp_dict['Gather Info'] = {'gather_management_id': list[17].text(), 'gather_location': list[18].text(),
            ...
            tmp_list = []
            for list in self.DE_AddAll_List:
                tmp_list.append({'gather_media_type': list[27].text(),
                                 'gather_hash_type': list[28].text(),
                                 'gather_hash': list[29].text(),
                                 'gather_path': list[30].text(),
                                 'gather_metadata': list[31].text()})
            ...
            for other_files_list in self.DE_AddAll_List:
                tmp_list.append(
                    {'other_files_id': other_files_list[32].text(),
                     'other_files_type': other_files_list[33].text(),
                     'other_files_size': other_files_list[34].text(),
                     'other_files_path': other_files_list[35].text(),
                     'other_files_hash_type': other_files_list[36].text(),
                     'other_files_hash_value': other_files_list[37].text(),
                     'other_files_file_description': other_files_list[38].text(),
                     'other_files_file_metadata': other_files_list[39].text()})
            ...
            tmp_list = []
            for list in self.DE_AddAll_List:
                tmp_list.append({'authentication_management_id': list[40].text(),
                                 'authentication_person_name': list[41].text(),
                                 'authentication_date_time': list[42].text(),
                                 'authentication_location': list[43].text(),
                                 'authentication_tool': list[44].text(),
                                 'authentication_tool_version': list[45].text(),
                                 'authentication_person_party_name': list[46].text()
                                 })
            ...
            for acquisition_list in self.DE_AddAll_List:
                tmp_list.append({'serial_no': acquisition_list[47].text(),
                                 'digital_evidence_management_id': acquisition_list[48].text(),
                                 'digital_evidence_type': acquisition_list[49].text(),
                                 'evidences_gathering_type': acquisition_list[50].text(),
                                 'gather_management_id': acquisition_list[51].text(),

                                 'file_name': acquisition_list[52].text(),

                                 'file_path': acquisition_list[53].text() ,
                                 'hash_type': acquisition_list[54].text(),
                                 'hash_value': acquisition_list[55].text(),
                                 'sector_size': acquisition_list[56].text(),
                                 'file_size': acquisition_list[57].text(),
                                 'metadata': acquisition_list[58].text()
                                 })
        ...
        for list in self.AIReports_List:
            list_AIReports.append(
                {'id': list[0].text(), 'type': list[1].text(), 'subtype': list[2].text(),
                 'equipment_management_id': list[3].text(), 'submission_agency': list[4].text(),
        ...
        for list in self.AI_EquipmentTraces_List:
            list_AIEquipmentTraces.append(
                {'id': list[0].text(), 'type': list[1].text(), 'description': list[2].text(),
                 'equipment_traces_management_id': list[3].text(), 'vessel_id': list[4].text(), 'evidence_id': list[5].text(),
    ...
    def DE_AddTab(self):
        ...
        tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1.setObjectName("DE_Gather_Inf_Gather_Source_Name__lineEdit_1")
        ...
        tmp_list.append(tmp_DE_Vessel_Info_vessel_MMSI__lineEdit_1)  # 2
        tmp_list.append(tmp_DE_Vessel_Info_vessel_callsign__lineEdit_1)  # 3
        tmp_list.append(tmp_DE_Vessel_Info_vessel_IMO__lineEdit_1)  # 4
        tmp_list.append(tmp_DE_Vessel_Info_vessel_MRN__lineEdit_1)  # 5
        tmp_list.append(tmp_DE_Vessel_Info_vessel_tonnage__lineEdit_1)  # 6
        ...
        tmp_list.append(tmp_DE_Marines_Electronics_Info_device_model_name__lineEdit_1)  # 13
        tmp_list.append(tmp_DE_Marines_Electronics_Info_device_model_serial_number__lineEdit_1)  # 14
        ...
        tmp_list.append(tmp_DE_Gather_Info_Gather_Source_Name__lineEdit_1)  # 25
        tmp_list.append(tmp_DE_Gather_Info_Gather_Relation_Person_Type_Code___lineEdit_1)  # 26
        tmp_list.append(tmp_DE_Gather_Info_gather_media_type__lineEdit_1)  # 27
        tmp_list.append(tmp_DE_Gather_Info__gather_hash_type__lineEdit_1)  # 28
        tmp_list.append(tmp_DE_Gather_Info_gather_hash__lineEdit_1)  # 29
        tmp_list.append(tmp_DE_Gather_Info_gather_path__lineEdit_1)  # 30
        tmp_list.append(tmp_DE_Gather_Info_gather_metadata__lineEdit_1)  # 31
        tmp_list.append(tmp_DE_Other_Files_id__lineEdit_1)  # 32
        tmp_list.append(tmp_DE_Other_Files_type__lineEdit_1)  # 33
        tmp_list.append(tmp_DE_Other_Files_file_size__lineEdit_1)  # 34
        tmp_list.append(tmp_DE_Other_Files_file_path__lineEdit_1)  # 35
        tmp_list.append(tmp_DE_Other_Files_file_hash_type__lineEdit_1)  # 36
        tmp_list.append(tmp_DE_Other_Files_file_hash_value__lineEdit_1)  # 37
        tmp_list.append(tmp_DE_Other_Files_file_description__lineEdit_1)  # 38
        tmp_list.append(tmp_DE_Other_Files_file_metadata__lineEdit_1)  # 39
        tmp_list.append(tmp_DE_Authentication_ID__lineEdit_1)  # 40
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_person_name__lineEdit_1)  # 41
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1)  # 42
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_location__lineEdit_1)  # 43
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_tool__lineEdit_1)  # 44
        tmp_list.append(tmp_DE_Acquisition_Info_acquisition_tool_version__lineEdit_1)  # 45
        tmp_list.append(tmp_DE_Authentication_Person_Party_Name__lineEdit_1)  # 46
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_serial_no__lineEdit_1)  # 47
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_management_id__lineEdit_1)  # 48
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_type__lineEdit_1)  # 49
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_evidences_gathering_type__lineEdit_1)  # 50
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_gather_no__lineEdit_1)  # 51
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1)  # 52
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1)  # 53
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1)  # 54
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1)  # 55
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_sector_size__lineEdit_1)  # 56
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_file_size__lineEdit_1)  # 57
        tmp_list.append(tmp_DE_Acquisition_Info_DEF__metadata__lineEdit_1)  # 58
        self.DE_AddAll_List.append(tmp_list)
        # <DE_AddAll_List 공통>
    ...
    def AI_Reports__AddTab(self):
        ...
        tmp_AI_Reports_file_info__browseButton_1.clicked.connect(lambda: self.AI_Reports_file_info__browseButton_1_QFileDialog(tmp_len))

        tmp_AI_Reports_file_info__enterButton_1.clicked.connect(lambda: self.AI_Reports_file_info__enterButton_1_Calculate(tmp_len))
    ...
    def AI_Other_Files_AddTab(self):
        ...
        tmp_AI_Other_Files_file_browse__browseButton_1.clicked.connect(lambda: self.AI_Other_Files_file_browse__browseButton_1_QFileDialog(tmp_len))

        tmp_AI_Other_Files_file_browse__enterButton_1.clicked.connect(lambda: self.AI_Other_Files_file_browse__enterButton_1_Calculate(tmp_len))
    ...
    def Log__addButton_AddTab(self):
        ...
        tmp_Log_digital_evidence_package_management_id__lineEdit_1.setText("1")
...
# export는 완벽하게 되니까 이제 DEF를 load해봅시다