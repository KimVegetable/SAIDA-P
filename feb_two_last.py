...
from PyQt5.QtWidgets import QDialog, QApplication, QTabWidget, QWidget, QFileDialog
...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        tmp_list[0].append(self.tabWidget_10)
        ...
        self.DE_Acquisition_Info__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_AddTab(0, 0))

        self.DE__addButton.clicked.connect(self.DE_AddTab)

        tmp_list = list()
        tmp_list.append(self.DE_Acquisition_Info_DEF__addButton_1)
        self.DE_Acquisition_Info_Button_List[0].append(tmp_list)

        self.DE_Acquisition_Info_Button_List[0][0][0].clicked.connect(lambda:self.DE_Acquisition_Info_DEF_AddTab(0,0))

    def DE_AddTab(self, b):
        ...
        tmp_DE_Acquisition_Info__addButton_1.clicked.connect(lambda : self.DE_Acquisition_Info_AddTab(tmp_len, b))

        a = len(self.DE_Acquisition_Info_List) - 1

        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab(a, b))
        ...
        self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1][len(self.DE_Acquisition_Info_DEF_List[b])-1].append(tmp_list)
        ...
        # self.DE_Acquisition_Info_DEF_Button_List[len(self.DE_Acquisition_Info_DEF_List)-1][len(self.DE_Acquisition_Info_DEF_List[b])-1].append(tmp_list)

        tmp_len = len(self.DE_Acquisition_Info_DEF_List[b]) - 1

        # self.DE_Acquisition_Info_DEF_Button_List[b][tmp_len][0][0].clicked.connect(
        #     lambda : self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(b, tmp_len, 0)
        # )

        # self.DE_Acquisition_Info_DEF_Button_List[b][tmp_len][0][1].clicked.connect(
        #     lambda : self.DE_Acquisition_Info_DEF_browse__enterButton_1_Calculate(b, tmp_len, 0)
        # )

        self.DE_Acquisition_Info_DEF__addButton_1.clicked.connect(
            lambda : self.DE_Acquisition_Info_AddTab(b, tmp_len)
        )
    ...
    def DE_Acquisition_Info_AddTab(self, a, b):
        tmp_tab_6 = QtWidgets.QWidget()
        tmp_tab_6.setObjectName("tab_6")
        tmp_gridLayout_29 = QtWidgets.QGridLayout(tmp_tab_6)
        tmp_gridLayout_29.setObjectName("gridLayout_29")
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[a].append(tmp_list)

        tmp_len = len(self.DE_Acquisition_Info_DEF_Tab_Widget_List[a]) - 1

        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_AddTab(a, tmp_len))
    ...
    def DE_Acquisition_Info_DEF_AddTab(self, a, b):
        ...
        tmp_DE_Acquisition_Info_file__scrollArea_1.setWidget(
            tmp_DE_Acquisition_Info_DEF__scrollAreaWidgetContents_1)
        tmp_gridLayout_17.addWidget(tmp_DE_Acquisition_Info_file__scrollArea_1, 0, 0, 1, 1)
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[a][b][0].addTab(tmp_tab_9, "Tab" )

        # + str(len(self.DE_Acquisition_Info_DEF_List[a][b][len(self.DE_Acquisition_Info_DEF_Tab_Widget_List[a]) - 1]) + 1)
        ...
        # tmp_len = len(self.DE_Acquisition_Info_DEF_Button_List[a][b]) - 1
        # self.DE_Acquisition_Info_DEF_Button_List[a][b][tmp_len][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse_browseButton_1_QFileDialog(a, b, tmp_len))

        # self.DE_Acquisition_Info_DEF_Button_List[a][b][tmp_len][1].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse_enterButton_1_Calculate(a, b, tmp_len))
...
# widget은 다 됬음. 뒤로 가서 해도 잘됨. 이제 QfileDialog만 잘 연결해봅시다.