...
class Ui_SecondWindow(object):
    ...
    def __init__(self):
        ...
        # self.DE_AddAll_List.append(list())

        self.DE_Tab_Widget_List = list()
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[0].append(list())


        self.DE_Acquisition_Info_List = list()
        # self.DE_Acquisition_Info_List.append(list())
        self.DE_Acquisition_Info_Tab_Widget_List = list()
        self.DE_Acquisition_Info_Tab_Widget_List.append(list())

        self.DE_Acquisition_Info_DEF_Browse_Button_List = list()
        self.DE_Acquisition_Info_DEF_Browse_Button_List.append(list())
    ...
    def setupUi(self, SecondWindow):
        ...
        self.DE_Gather_Info_Gather_Source_Name__horizontalLayout_1.addWidget(self.DE_Gather_Inf_Gather_Source_Name__lineEdit_1)
        ...
        self.DE_Acquisition_Info_List.append(self.DE_Acquisition_Info_DEF_List)

        self.DE_AddAll_List.append(self.DE_Acquisition_Info_List)



        self.DE__addButton.clicked.connect(lambda : self.DE_AddTab)

        self.DE_Acquisition_Info_Tab_Widget_List[0].append(self.tabWidget_8)  # self.tabWidget_8 Acq

        self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][0].append(self.tabWidget_10)

        al_l = len(self.DE_AddAll_List)

        ac_q = len(self.DE_Acquisition_Info_List)

        de_f = len(self.DE_Acquisition_Info_DEF_List)

        # de_f_deep = len(self.DE_AddAll_List[])

        self.DE_Acquisition_Info__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_AddTab())

        self.DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab()) # a = big tab의 a번째, b = acquisition_info의 b번째



        # self.DE_AddAll_Tab_Widget_List.append(self.tabWidget_10)  # tabWidget_DEF(10)         tab_DEF(9)




        self.DE_Tab_Widget_List.append(self.tabWidget_10)




        tmp_list = list()
        tmp_list.append(self.DE__addButton)
        self.DE_Button_List.append(tmp_list)

        self.DE_Button_List[0][0].clicked.connect(self.DE_AddTab)

        # DE_Tab 0 -> Acq_Tab 0 -> DEF 0 -> Browse

        tmp_list = list()
        tmp_list.append(self.DE_Acquisition_Info__addButton_1)
        self.DE_Acquisition_Info_Button_List.append(tmp_list)

        # <한묶음>
        tmp_list = list()
        tmp_list.append(self.DE_Acquisition_Info_DEF_browse__browseButton_1)
        self.DE_Acquisition_Info_DEF_Browse_Button_List[0].append(tmp_list)

        tmp_list = list()
        tmp_list.append(self.DE_Acquisition_Info_DEF_browse__lineEdit_1)
        self.DE_Acquisition_Info_DEF_List[0].append(tmp_list)

        self.DE_Acquisition_Info_DEF_Browse_Button_List[0][0][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog())
        # </한묶음>
...
##여기까지 setup
    ...
    def DE_AddTab(self):
        ...
        self.DE_Tab_Widget_List.append(self.tabWidget_3)
        ...
        tmp_list = list()
        tmp_list.append(tmp_tabWidget_8)

        self.DE_Acquisition_Info_Tab_Widget_List.append(tmp_list)

        tmp_DE_Acquisition_Info__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_AddTab())

        tmp_list = list()
        tmp_list.append(list())
        tmp_list[0].append(tmp_tabWidget_10)
        self.DE_Acquisition_Info_DEF_Tab_Widget_List.append(tmp_list)

        #!
        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab())


        tmp_list = list()
        tmp_list.append(list())
        tmp_list[0].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)
        self.DE_Acquisition_Info_DEF_Browse_Button_List.append(tmp_list)

        if len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1])-1]) == 1:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1])-1][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog())

        elif len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1])-1]) == 2:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1])-1][1].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog())

        elif len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1])-1]) == 3:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1])-1][2].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog())


        tmp_list = list()
        tmp_list.append(list())
        tmp_list[0].append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)
    ...
    def DE_Acquisition_Info_AddTab(self):
        ...
        tmp_list = list()
        tmp_list.append(tmp_tabWidget_10)
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[  len(self.DE_Tab_Widget_List) -1 ].append(tmp_list)


        #처음에는 이걸로
        self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1].append(self.tabWidget_8)

        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab())

        self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Acquisition_Info_Tab_Widget_List)-1][ len(self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Acquisition_Info_Tab_Widget_List)-1])-1               ].addTab(tmp_tab_6, "Tab " + str(len(self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Tab_Widget_List) - 1])  ))
        ...
        if len(self.DE_Acquisition_Info_DEF_Browse_Button_List ) == 1:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[0].append(tmp_list)

        elif len(self.DE_Acquisition_Info_DEF_Browse_Button_List ) == 2:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[1].append(tmp_list)

        elif len(self.DE_Acquisition_Info_DEF_Browse_Button_List ) == 3:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[2].append(tmp_list)
        ...
        if len(self.DE_Acquisition_Info_DEF_List) == 1:

            tmp_list = list()
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)
            self.DE_Acquisition_Info_DEF_List[0].append(tmp_list)

        elif len(self.DE_Acquisition_Info_DEF_List) == 2:

            tmp_list = list()
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)
            self.DE_Acquisition_Info_DEF_List[1].append(tmp_list)

        elif len(self.DE_Acquisition_Info_DEF_List) == 3:

            tmp_list = list()
            tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)
            self.DE_Acquisition_Info_DEF_List[2].append(tmp_list)
    ...
    def DE_Acquisition_Info_DEF_AddTab(self):
        ...
        # 개수
        al_a = len(self.DE_AddAll_List)

        ac_q = len(self.DE_Acquisition_Info_List)

        de_f = len(self.DE_Acquisition_Info_DEF_List)

        self.DE_Acquisition_Info_DEF_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1][len(self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1])-1].append(self.tabWidget_10)
        #
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1][len(self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1])-1][0].addTab(tmp_tab_9, "Tab" + str(len(self.DE_Acquisition_Info_DEF_Tab_Widget_List[  len(self.DE_Tab_Widget_List)-1  ][     len(self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1])  -1  ])  ))
                                                                                                                                                                      #이부분은 항상 0
        # self.DE_Acquisition_Info_DEF_Browse_Button_List[ len(self.DE_Tab_Widget_List) - 1  ][   len(  self.DE_Acquisition_Info_DEF_Browse_Button_List[          len(self.DE_Tab_Widget_List) - 1             ]               [             len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Tab_Widget_List) - 1])   -  1                     ]   )             - 1            ].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)



        # self.DE_Acquisition_Info_DEF_Browse_Button_List[ len(self.DE_Tab_Widget_List) - 1][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Tab_Widget_List) - 1 ][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Tab_Widget_List) - 1 ])- 1]) -  1 ].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)

        # DE Tab 1의 Acq Tab 1에 있는 DEF Button를 늘리는 경우
        # self.DE_Acquisition_Info_DEF_Browse_Button_List[0][0].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)

        # DE Tab 1의 Acq Tab 2에 있는 DEF Button를 늘리는 경우
        # self.DE_Acquisition_Info_DEF_Browse_Button_List[0][1].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)

        # DE Tab 1의 Acq Tab 3에 있는 DEF Button를 늘리는 경우
        # self.DE_Acquisition_Info_DEF_Browse_Button_List[0][2].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)




        if len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1]) == 1:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][0].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)

        elif len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1]) == 2:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][1].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)

        elif len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1]) == 3:

            self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][2].append(tmp_DE_Acquisition_Info_DEF_browse__browseButton_1)
        ...
        # self.DE_Acquisition_Info_DEF_List[ len(self.DE_Tab_Widget_List) - 1  ][   len(  self.DE_Acquisition_Info_DEF_Browse_Button_List[          len(self.DE_Tab_Widget_List) - 1             ]               [             len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Tab_Widget_List) - 1])   -  1                     ]   )             - 1            ].append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)
        ...
        # DE 0번째, Acq 0번째, DEF 0번째, Browse버튼 누르기

        if len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1][len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1])-1]) == 1:

            self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1][len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1])-1].append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)

        elif len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1][len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1])-1]) == 2:

            self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1][len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1])-1].append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)

        elif len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1][len(self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_List)-1])-1]) == 3:
    ...
    def DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(self):

        print("wait")

        file_name = QFileDialog.getOpenFileName()
        #
        # self.DE_Acquisition_Info_DEF_List[len(self.DE_Tab_Widget_List)-1][ len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Tab_Widget_List)-1]) - 1  ][1].setText(file_name[0])
        # #

        # self.DE_Acquisition_Info_DEF_List[0][0][0].setText(file_name[0])

        # self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][0][0].setText(file_name[0])

        # self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][ len(self.DE_Acquisition_Info_DEF_Browse_Button_List[ len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1    ])-1         ][0].setText(file_name[0])

        self.DE_Acquisition_Info_DEF_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1][ len(self.DE_Acquisition_Info_DEF_Browse_Button_List[ len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1    ])-1         ][                 len(self.DE_Acquisition_Info_DEF_Browse_Button_List[   len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1  ][len(self.DE_Acquisition_Info_DEF_Browse_Button_List[len(self.DE_Acquisition_Info_DEF_Browse_Button_List)-1])-1])-1    ].setText(file_name[0])
        ...
        # self.DE_Acquisition_Info_DEF_List[0][1][0].setText(file_name[0])
        ...
        # # Acquisition Tab이 1개,DEF tab이 2개일때 browse 버튼 누르기
        # self.DE_AddAll_List[0][0][de_f-1][2].setText(file_name[0])

        # 키자마자 browse누르는 경우
        # self.DE_Acquisition_Info_DEF_List[0][0][5].setText(file_name[0])

        #DEF Tab2에서 browse누르는 경우
        # self.DE_Acquisition_Info_DEF_List[0][1][5].setText(file_name[0])

        #DEF Tab3에서 browse누르는 경우
        # self.DE_Acquisition_Info_DEF_List[0][2][5].setText(file_name[0])
