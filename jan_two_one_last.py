...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[0].append(self.tabWidget_10) #tabWidget_DEF(10) tab_DEF(9)
        ...
        self.DE_Acquisition_Info_DEF_Button_List[0].append(tmp_list)

        self.DE_Acquisition_Info_DEF_Button_List[0][0][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(-1))

##여기까지 setup

    def DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(self, b, acq):
        ...
        # Acquisition Tab 1의 DEF tab의 browse 버튼 누르기
        # self.DE_Acquisition_Info_DEF_List[0][b+1][5].setText(file_name[0])

        # Acquisition Tab 2의 DEF tab의 browse 버튼 누르기
        # self.DE_Acquisition_Info_DEF_List[1][b + 1][5].setText(file_name[0])

        # Acquisition Tab 3의 DEF tab의 browse 버튼 누르기
        # self.DE_Acquisition_Info_DEF_List[2][b + 1][5].setText(file_name[0])


        # Acquisition Tab ?의 DEF tab의 browse 버튼 누르기
        self.DE_Acquisition_Info_DEF_List[acq][b + 1][5].setText(file_name[0])
    ...
    def DE_Acquisition_Info_DEF_AddTab(self):
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][len(self.DE_Acquisition_Info_List[0]) - 1].addTab(tmp_tab_9,"Tab" + str(len(self.DE_Acquisition_Info_DEF_List[0]) + 1))
        ...
        print(len(self.DE_Acquisition_Info_DEF_List[0])-1)

        b = len(self.DE_Acquisition_Info_DEF_List[0])-1

        acq = len(self.DE_Acquisition_Info_List[0])-1

        #완전처음엔 b = 0이므로

        #DEF Tab 1번째 browse 클릭
        ...
        #DEF Tab 2번째 browse 클릭
        # self.DE_Acquisition_Info_DEF_Button_List[0][1][0].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(a))

        # #DEF Tab 3번째 browse 클릭
        # self.DE_Acquisition_Info_DEF_Button_List[0][2][0].clicked.connect(
        #     lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(a))

        # DEF Tab b+1번째 browse클릭
        self.DE_Acquisition_Info_DEF_Button_List[0][b][0].clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(b, acq))
    ...
    def DE_Acquisition_Info_AddTab(self, a):
        ...
        self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_AddAll_List)-1].addTab(tmp_tab_6, "Tab"+ str(len(self.DE_Acquisition_Info_List[0])+1))



        self.DE_Acquisition_Info_DEF_Tab_Widget_List[0].append(tmp_tabWidget_10)
        ...
        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(
            lambda: self.DE_Acquisition_Info_DEF_AddTab()
        )

        acq = len(self.DE_Acquisition_Info_List[0])-1

        tmp_DE_Acquisition_Info_DEF_browse__browseButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(0, acq))
    ...
    def DE_AddTab(self):
        ...
        a = 0
        tmp_DE_Acquisition_Info__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_AddTab(a))
...
# 나름 완성 prototype_jan_1/21_17/18