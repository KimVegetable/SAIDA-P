...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        self.DE_Acquisition_Info__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_AddTab(al_l, ac_q, de_f))

        self.DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab(al_l, ac_q, de_f)) # a = big tab의 a번째, b = acquisition_info의 b번째
        ...
        self.DE_Acquisition_Info_DEF_Browse_Button_List[0][0][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(1, 1, 1))
        # </한묶음>
...
##여기까지 setup
    ...
    def DE_AddTab(self):
        ...
        #
        # tmp_lenn = len(self.DE_Acquisition_Info_List) - 1
        ...
        tmp_DE_Acquisition_Info__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_AddTab(al_l, ac_q ,de_f))
        ...
        #!
        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab(al_l, ac_q, de_f))
    ...
    def DE_Acquisition_Info_AddTab(self, al_l, ac_q, de_f):
        ...
        self.DE_Acquisition_Info_Tab_Widget_List[al_l - 1][0].addTab(tmp_tab_6, "Tab " + str(len(self.DE_Acquisition_Info_Tab_Widget_List[len(self.DE_Tab_Widget_List) - 1])  ))
    ...
    def DE_Acquisition_Info_DEF_AddTab(self, al_l, ac_q, de_f):
    ...
    def DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(self):
        ...
        # self.DE_Acquisition_Info_DEF_List[0][1][0].setText(file_name[0]) DE1 Acq2 DEF 1
