...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        tmp_list.append(self.DE_Acquisition_Info_DEF_browse__lineEdit_1)  #1
        ...
        self.DE_Tab_Widget_List.append(self.tabWidget_10) # tabWidget_3 DE전체


        self.DE_AddAll_List[0][0][0][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(1, 1, 1))
...
##여기까지 setup
    ...
    def DE_AddTab(self):
        ...
        self.DE_Tab_Widget_List.append(tmp_tabWidget_10)
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[1].append(tmp_tabWidget_10)
    ...
    def DE_Acquisition_Info_AddTab(self, al_l, ac_q, de_f):
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[0].append(tmp_list)
        ...
        self.DE_AddAll_List[0][0].append(tmp_list)
        #
        # tmp_list = list()
        # tmp_list.append(tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1)
        # self.DE_Acquisition_Info_List.append(tmp_list)
        #
        # tmp_DE_Acquisition_Info_DEF_browse__browseButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(0, 0, 0))

        DE_Tab_Count = len(self.DE_Tab_Widget_List) #DE Tab의 전체 개수 입니다.

        # DE_Tab이 1개일때는 len(self.DE_Tab_Widget_List) = 1
        # DE_Tab이 2개일때는 len(self.DE_Tab_Widget_List) = 2
        # DE_Tab이 3개일때는 len(self.DE_Tab_Widget_List) = 3


        # 특정 Acquisition_Info_Tab의 개수를 구할려면 []를 써야함
        # ex) DE_Tab1번의 Acquisition_Info_Tab_Widget의 수를 구할려면 len(self.DE_Acquisition_Info_Tab_Widget_List[0])
        #     DE_Tab2번의 Acquisition_Info_Tab_Widget의 수를 구할려면 len(self.DE_Acquisition_Info_Tab_Widget_List[1])
        #     DE_Tab3번의 Acquisition_Info_Tab_Widget의 수를 구할려면 len(self.DE_Acquisition_Info_Tab_Widget_List[2])




        ACQ_Tab_Count = len(self.DE_Acquisition_Info_Tab_Widget_List)

        de_f = len(self.DE_Acquisition_Info_DEF_List)

        print(al_l, ac_q, de_f)

        ac_q_deep = len(self.DE_AddAll_List[0][0])

        number = len(self.DE_Acquisition_Info_Tab_Widget_List[al_l-1])
        ...
        # 처음에는
        # self.DE_Acquisiton_Info_Tab_Widget_List[0]의 개수
        #
        # DE tab이 2개가 되면
        # self.DE_Acquisition_Info_Tab_Widget_List[1]의 개수
        #
        # DE tab이 3개가 되면
        # self.DE_Acquisition_Info_Tab_Widget_List[2]의 개수





        tmp_DE_Acquisition_Info_DEF_browse__browseButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(al_l, ac_q, de_f))

        tmp_DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab(al_l, ac_q, de_f))

        # print("DE Tab " + str(al_l) + "의 Acq Tab " + str(ac_q) +  " 가 생성되었습니다.")
        #
        # print("DE: " + str(al_l+1) + "개," + " Acq: " + str(ac_q+1) + "개," + " DEF: " + str(de_f+1) + "개 입니다")
    ...
    def DE_Acquisition_Info_DEF_AddTab(self, al_l, ac_q, de_f):
        ...
        tmp_list.append(tmp_DE_Acquisition_Info_DEF_browse__lineEdit_1)  # 2
        # tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1)
        # tmp_list.append(tmp_DE_Acquisition_Info_DEF_digital_evidence_file_path__lineEdit_1)
        # tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_type__lineEdit_1)
        # tmp_list.append(tmp_DE_Acquisition_Info_DEF_hash_value__lineEdit_1)
        ...
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][0].append(self.tabWidget_10)
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][1].append(self.tabWidget_10)
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][2].append(self.tabWidget_10)

        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[1][0].append(self.tabWidget_10)
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[1][1].append(self.tabWidget_10)
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[1][2].append(self.tabWidget_10)

        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[2][0].append(self.tabWidget_10)
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[2][1].append(self.tabWidget_10)
        # self.DE_Acquisition_Info_DEF_Tab_Widget_List[2][2].append(self.tabWidget_10)

        self.DE_Acquisition_Info_DEF_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1][len(self.DE_Acquisition_Info_Tab_Widget_List[0])-1].append(self.tabWidget_10)
        ...
        # Acq Tab이 1개일때는 len(self.DE_Acquisition_Info_Tab_Widget_List) = 1
        # Acq Tab이 2개일때는 len(self.DE_Acquisition_Info_Tab_Widget_List) = 2
        # Acq Tab이 3개일때는 len(self.DE_Acquisition_Info_Tab_Widget_List) = 3


        # DE_Tab 1번의 Acq 1번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][0][0].addTab(tmp_tab_9, "Tab" + str(de_f))
        # DE_Tab 1번의 Acq 2번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][1][0].addTab(tmp_tab_9, "Tab" + str(de_f))
        # DE_Tab 1번의 Acq 3번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][2][0].addTab(tmp_tab_9, "Tab" + str(de_f))

        # DE_Tab 2번의 Acq 1번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[1][0][0].addTab(tmp_tab_9, "Tab" + str(de_f))
        # DE_Tab 2번의 Acq 1번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[1][1][0].addTab(tmp_tab_9, "Tab" + str(de_f))
        # DE_Tab 2번의 Acq 1번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[1][2][0].addTab(tmp_tab_9, "Tab" + str(de_f))

        # DE_Tab 3번의 Acq 1번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[2][0][0].addTab(tmp_tab_9, "Tab" + str(de_f))
        # DE_Tab 3번의 Acq 1번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[2][1][0].addTab(tmp_tab_9, "Tab" + str(de_f))
        # DE_Tab 3번의 Acq 1번의 Acquisition_Info_DEF_Tab_Widget을 더할려면  self.DE_Acquisition_Info_DEF_Tab_Widget_List[2][2][0].addTab(tmp_tab_9, "Tab" + str(de_f))


        #
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[len(self.DE_Tab_Widget_List)-1][len(self.DE_Acquisition_Info_Tab_Widget_List[0])-1][0].addTab(tmp_tab_9, "Tab" + str("1/27 아침은 여기부터"))
        #DE 1의 Acq 1의 DEF1에다가 하시오



        # self.DE_Acquisition_Info_List[0][0][0].append(self.DE_Acquisition_Info_DEF_List)
        #
        # self.DE_AddAll_List.append(self.DE_Acquisition_Info_List)
        ...
        # DEF Tab de_f+1번째 browse클릭
        self.DE_AddAll_List[0][0][de_f-1][0].clicked.connect(lambda: self.DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(al_a, ac_q, de_f))
    ...
    def DE_Acquisition_Info_DEF_browse__browseButton_1_QFileDialog(self, al_l, ac_q, de_f):

        print("DE Tab " + str(al_l-1) + "의 Acq Tab " + str(ac_q-1) + "의 DEF Tab " + str(de_f-1) + "의 Browse를 선택하셨습니다.")
        print("DE: " + str(al_l) + "개," + " Acq: " + str(ac_q) + "개," + " DEF: " + str(de_f) + "개 입니다")

        file_name = QFileDialog.getOpenFileName()
        #
        self.DE_AddAll_List[0][0][de_f-1][1].setText(file_name[0])
        #
