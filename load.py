...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        self.DE_Other_Files_List.append(self.gridLayout_13)
        ...
        tmp_list.append(self.DE_other_files_file_description__lineEdit_1)
        tmp_list.append(self.DE_other_files_file_metadata__lineEdit_1)
        self.DE_Other_Files_List.append(tmp_list)
        ...
        self.DE_other_files__addButton_1.clicked.connect(self.DE_Other_Files_Add)

        ##DE Other File에서 Browse누르면 파일 클릭하면 파일 업로드
        self.DE_other_files_file_browse__browseButton_1.clicked.connect(
            lambda: self.DE_other_files_file_browse__browseButton_1_QFileDialog(0))

        ##DE Other File에서 Enter누르면 파일 계산
        self.DE_other_files_file_browse__EnterButton_1.clicked.connect(
            lambda: self.DE_other_files_file_browse__EnterButton_1_Calculate(0))
        ...
        if self.mode == 'load':
           #with open(self.file_path, 'r') as f:
            with open(self.file_path, 'r', encoding="utf-8") as f:
                data = json.load(f)
              ##data = json.load(f)
              ##data = [json.loads(f) for f in open(self.file_path,'rt' ,encoding='UTF8')]
                ...
                for i in range(0, len(data['Digital Evidence Package']['Digital Evidences'])):
                    ...
                    if i == 0:
                        management_id = data['Digital Evidence Package']['Digital Evidences'][i]['management_id']
                        digital_evidence_type = data['Digital Evidence Package']['Digital Evidences'][i]['management_id']
                        evidence_gathering_type = data['Digital Evidence Package']['Digital Evidences'][i]['management_id']

                        vessel_management_id = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_management_id']
                        vessel_name = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_name']
                        vessel_MMSI = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_MMSI']
                        vessel_callsign = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_callsign']
                        vessel_IMO = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_IMO']
                        vessel_MRN = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_MRN']
                        vessel_tonnage = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_tonnage']
                        vessel_length = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['vessel_length']
                        total_number_of_equipment_with_track = data['Digital Evidence Package']['Digital Evidences'][i]['Vessel Info']['total_number_of_equipment_with_track']

                        device_management_id = data['Digital Evidence Package']['Digital Evidences'][i]['Marine Electronics Info']['device_management_id']
                        device_type = data['Digital Evidence Package']['Digital Evidences'][i]['Marine Electronics Info']['device_type']
                        device_manufacturer = data['Digital Evidence Package']['Digital Evidences'][i]['Marine Electronics Info']['device_manufacturer']
                        device_model_name = data['Digital Evidence Package']['Digital Evidences'][i]['Marine Electronics Info']['device_model_name']
                        device_model_serial_number = data['Digital Evidence Package']['Digital Evidences'][i]['Marine Electronics Info']['device_model_serial_number']
                        device_os_firmware = data['Digital Evidence Package']['Digital Evidences'][i]['Marine Electronics Info']['device_os_firmware']
                        device_descripton = data['Digital Evidence Package']['Digital Evidences'][i]['Marine Electronics Info']['device_description']

                        gather_datetime = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['gather_datetime']
                        gather_location = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['gather_location']
                        gather_person_name = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['gather_person_name']
                        gather_person_agency = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['gather_person_agency']
                        gather_person_rank = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['gather_person_rank']
                        submitter_name = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['submitter_name']

                        acquisition_person_name = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['aquisition_person_name'] #acquisition
                        acquisition_datetime = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['acquisition_datetime']
                        acquisition_location = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['acquisition_location']
                        acquisition_tool = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['acquisition_tool']


                        self.DE_management_id__lineEdit_1.setText(management_id)
                        self.DE_digital_evidence_type__lineEdit_1.setText(digital_evidence_type)
                        self.DE_evidences_gathering_type__ineEdit_1.setText(evidence_gathering_type)
                        ...
                        self.DE_Vessel_Info_vessel_total_number_of_equipmentwith_track__lineEdit_1.setText(total_number_of_equipment_with_track)
                        ...
                        self.DE_Marines_Electronics_Info_device_model_serial_number__lineEdit_1.setText(device_model_serial_number)
                        ...
                        self.DE_Acquisition_Info_acquisition_person_name__lineEdit_1.setText(acquisition_person_name)
                        self.DE_Acquisition_Info_acquisition_date_time__lineEdit_1.setText(acquisition_datetime)
                        self.DE_Acquisition_Info_acquisition_location__lineEdit_1.setText(acquisition_location)
                        self.DE_Acquisition_Info_acquisition_tool__lineEdit_1.setText(acquisition_tool)

                        ##############Gather Info Media File 부분 #####
                        len(data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['Gather Info Media File'])

                        for j in range (0, len(data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['Gather Info Media File'])):

                            if j == 0:

                                gather_media_type = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['Gather Info Media File'][j]['gather_media_type']
                                gather_hash_type = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['Gather Info Media File'][j]['gather_hash_type']
                                gather_hash = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['Gather Info Media File'][j]['gather_hash']
                                gather_path = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info']['Gather Info Media File'][j]['gather_path']
                                ...
                                tmp_DE_Gather_Info_gather_media_type__horizontalLayout_1.setObjectName(
                                    "DE_Gather_Info_gather_media_type__horizontalLayout_" + str(
                                        self.DE_Gather_Info_num))
                                ...
                                self.DE_Gather_Info_File_List[a].addLayout(tmp_DE_Gather_Info_file__verticalLayout_1,
                                                                           self.DE_Gather_Info_num, 0, 1, 1)
                                ...
                                gather_media_type = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info'][
                                    'Gather Info Media File'][j]['gather_media_type']
                                gather_hash_type = data['Digital Evidence Package']['Digital Evidences'][i]['Gather Info'][
                        ...
                        ######### Acquisition Digital Info File ###########
                        len(data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['Acquisition Digital Info File'])

                        for j in range (0, len(data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['Acquisition Digital Info File'])):

                            if j == 0:

                                digital_evidence_file_name = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['Acquisition Digital Info File'][j]['digital_evidence_file_name']
                                digital_evidence_file_path = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['Acquisition Digital Info File'][j]['digital_evidence_file_path']
                                hash_type = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['Acquisition Digital Info File'][j]['hash_type']
                                hash_value = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info']['Acquisition Digital Info File'][j]['hash_value']

                                self.DE_Acquisition_Info_digital_evidence_file_name__lineEdit_1.setText(digital_evidence_file_name)
                                self.DE_Acquisition_Info_digital_evidence_file_path__lineEdit_1.setText(digital_evidence_file_path)
                                self.DE_Acquisition_Info_hash_type__lineEdit_1.setText(hash_type)
                                self.DE_Acquisition_Info_hash_value__lineEdit_1.setText(hash_value)
                                ...
                                tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1.setObjectName(
                                    "DE_Aquisition_Info_file_browse_horizontalLayout_" + str(
                                ...
                                tmp_DE_Acquisition_Info_file_browse__label_1.setMaximumSize(
                                ...
                                tmp_DE_Acquisition_Info_file_browse__browseButton_1.setObjectName(
                                    "DE_Acquisition_Info_file_browse__browseButton_" + str(
                                        self.DE_Acquisition_Info_num))
                                tmp_DE_Acquisition_Info_file_browse__browseButton_1.setText("Browse...")
                                j = len(self.DE_Acquisition_Info_List[i])
                                ...
                                tmp_DE_Acquisition_Info_digital_evidence_file_name__label_1.setObjectName(
                                    "DE_Acquisition_Info_digital_evidence_file_name__label_" + str(
                                        self.DE_Acquisition_Info_num))
                                ...
                                tmp_DE_Acquisition_Info_digital_evidence_file_name__lineEdit_1.setObjectName(
                                    "DE_Acquisition_Info_digital_evidence_file_name__lineEdit_" + str(
                                        self.DE_Acquisition_Info_num))
                                tmp_DE_Acquisition_Infro_file_digital_evidence_file_name__horizontalLayout_1.addWidget(
                                ...
                                tmp_DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1.setObjectName(
                                    "DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_" + str(
                                        self.DE_Acquisition_Info_num))
                                ...
                                tmp_DE_Acquisition_Info_digital_evidence_file_path__label_1.setObjectName(
                                    "DE_Acquisition_Info_digital_evidence_file_path__label_" + str(
                                        self.DE_Acquisition_Info_num))
                                ...
                                tmp_DE_Acquisition_Info_digital_evidence_file_path__lineEdit_1.setObjectName(
                                    "DE_Acquisition_Info_digital_evidence_file_path__lineEdit_" + str(
                                        self.DE_Acquisition_Info_num))
                                tmp_DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1.addWidget(
                                ...
                                tmp_DE_Acquisition_Info_hash_type__horizontalLayout_1.setObjectName(
                                    "DE_Acquisition_Info_hash_type__horizontalLayout_" + str(
                                        self.DE_Acquisition_Info_num))
                                ...
                                tmp_DE_Acquisition_Info_hash_type__horizontalLayout_1.addWidget(
                                    tmp_DE_Acquisition_Info_hash_type__label_1)
                                ...
                                tmp_DE_Acquisition_Info_hash_value__horizontalLayout_1.setObjectName(
                                    "DE_Acquisition_Info_hash_value__horizontalLayout_" + str(
                                        self.DE_Acquisition_Info_num))
                                ...
                                tmp_DE_Aquisition_Info_file__verticalLayout_1.addLayout(
                                    tmp_DE_Acquisition_Info_hash_value__horizontalLayout_1)
                                self.DE_Acquisition_Info_File_List[i].addLayout(tmp_DE_Aquisition_Info_file__verticalLayout_1, self.DE_Acquisition_Info_num, 0, 1, 1)
                                ...
                                digital_evidence_file_name = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info'][
                                    'Acquisition Digital Info File'][j]['digital_evidence_file_name']
                                digital_evidence_file_path = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info'][
                                    'Acquisition Digital Info File'][j]['digital_evidence_file_path']
                                hash_type = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info'][
                                    'Acquisition Digital Info File'][j]['hash_type']
                                hash_value = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info'][
                                    'Acquisition Digital Info File'][j]['hash_value']

                                tmp_DE_Acquisition_Info_digital_evidence_file_name__lineEdit_1.setText(digital_evidence_file_name)
                                tmp_DE_Acquisition_Info_digital_evidence_file_path__lineEdit_1.setText(digital_evidence_file_path)
                                tmp_DE_Acquisition_Info_hash_type__lineEdit_1.setText(hash_type)
                                tmp_DE_Acquisition_Info_hash_value__lineEdit_1.setText(hash_value)
                        ...
                        tmp_DE_digital_evidence_type__horizontalLayout_1.setObjectName(
                            "DE_digital_evidence_type__horizontalLayout_1")
                        ...
                        tmp_DE_evidences_gathering_type__horizontalLayout_1.setObjectName(
                            "DE_evidences_gathering_type__horizontalLayout_1")
                        ...
                        tmp_DE_evidences_gathering_type__horizontalLayout_1.addWidget(
                            tmp_DE_evidences_gathering_type__label_1)
                        ...
                        tmp_DE_evidences_gathering_type__horizontalLayout_1.addWidget(
                            tmp_DE_evidences_gathering_type__lineEdit_1)
                        ...
                        tmp_DE_Marines_Electronics_Info_Vessel_Info_Other_Files__horizontalLayout_1.setObjectName(
                            "DE_Marines_Electronics_Info_Vessel_Info_Other_Files__horizontalLayout_1")
                        ...
                        tmp_DE_Marines_Electronics_Info_Vessel_Info_Other_Files__horizontalLayout_1.addLayout(
                            tmp_DE_Vessel_Info__horizontalLayout_1)
                        ...
                        tmp_DE_Marine_Electronics_Info__horizontalLayout_1.addWidget(
                            tmp_DE_Marine_Electronics_Info__label_1)
                        ...
                        tmp_DE_Marines_Electronics_Info_Vessel_Info_Other_Files__horizontalLayout_1.addLayout(
                            tmp_DE_Marine_Electronics_Info__horizontalLayout_1)
                        ...
                        tmp_DE_Marines_Electronics_Info_Vessel_Info_Other_Files__horizontalLayout_1.addLayout(
                            tmp_DE_other_files__horizontalLayout_1)
                        tmp_DE_AddAll__verticalLayout_1.addLayout(
                            tmp_DE_Marines_Electronics_Info_Vessel_Info_Other_Files__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info__scrollAreaWidgetContents_1.setObjectName(
                            "DE_Gather_Info__scrollAreaWidgetContents_1")
                        ...
                        tmp_DE_Gather_Info_gather_location__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Gather_Info_gather_location__lineEdit_1.setObjectName(
                            "DE_Gather_Info_gather_location__lineEdit_1")
                        tmp_DE_Gather_Info_gather_location__horizontalLayout_1.addWidget(
                            tmp_DE_Gather_Info_gather_location__lineEdit_1)
                        tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                            tmp_DE_Gather_Info_gather_location__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info_gather_person_name__label_1 = QtWidgets.QLabel(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Gather_Info_gather_person_name__label_1.setObjectName(
                            "DE_Gather_Info_gather_person_name__label_1")
                        ...
                        tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                            tmp_DE_Gather_Info_gather_person_name__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info_gather_datetime__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Gather_Info_gather_datetime__lineEdit_1.setObjectName(
                            "DE_Gather_Info_gather_datetime__lineEdit_1")
                        tmp_DE_Gather_Info_gather_datetime__horizontalLayout_1.addWidget(
                            tmp_DE_Gather_Info_gather_datetime__lineEdit_1)
                        tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                            tmp_DE_Gather_Info_gather_datetime__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                            tmp_DE_Gather_Info_gather_person_agency__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info_gather_person_rank__label_1 = QtWidgets.QLabel(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Gather_Info_gather_person_rank__label_1.setObjectName(
                            "DE_Gather_Info_gather_person_rank__label_1")
                        ...
                        tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                            tmp_DE_Gather_Info_gather_person_rank__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info_submitter_name__horizontalLayout_1.addWidget(
                            tmp_DE_Gather_Info_submitter_name__label_1)
                        tmp_DE_Gather_Info_submitter_name__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Gather_Info_submitter_name__lineEdit_1.setObjectName(
                            "DE_Gather_Info_submitter_name__lineEdit_1")
                        tmp_DE_Gather_Info_submitter_name__horizontalLayout_1.addWidget(
                            tmp_DE_Gather_Info_submitter_name__lineEdit_1)
                        tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                            tmp_DE_Gather_Info_submitter_name__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info_file__blanklabel_1 = QtWidgets.QLabel(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Gather_Info_file_addButton__horizontalLayout_1.addWidget(
                            tmp_DE_Gather_Info_file__blanklabel_1)
                        tmp_DE_Gather_Info__addButton_1 = QtWidgets.QPushButton(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Gather_Info__verticalLayout_1.addLayout(
                            tmp_DE_Gather_Info_file_addButton__horizontalLayout_1)
                        ...
                        tmp_DE_Gather_Info_file__scrollArea_1 = QtWidgets.QScrollArea(
                            tmp_DE_Gather_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Acquisition_Info__scrollArea_1 = QtWidgets.QScrollArea(
                            tmp_DE_sub__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Acquisition_Info_addButton__horizontalLayout_1.setObjectName(
                            "DE_Acquisition_Info_addButton__horizontalLayout_1")
                        tmp_DE_Acquisition_Info__blanklabel_1 = QtWidgets.QLabel(
                            tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Acquisition_Info_addButton__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info__blanklabel_1)
                        tmp_DE_Acquisition_Info__addButton_1 = QtWidgets.QPushButton(
                            tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info__addButton_1.setObjectName("DE_Acquisition_Info__addButton_1")
                        tmp_DE_Acquisition_Info_addButton__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info__addButton_1)
                        tmp_DE_Acquisition_Info__verticalLayout_1.addLayout(
                            tmp_DE_Acquisition_Info_addButton__horizontalLayout_1)
                        tmp_DE_Acquisition_Info_file__scrollArea_1 = QtWidgets.QScrollArea(
                            tmp_DE_Acquisition_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1.setObjectName(
                            "DE_Aquisition_Info__scrollAreaWidgetContents_1")
                        ...
                        tmp_DE_Aquisition_Info_file__verticalLayout_1 = QtWidgets.QVBoxLayout()
                        tmp_DE_Aquisition_Info_file__verticalLayout_1.setObjectName(
                            "DE_Aquisition_Info_file__verticalLayout_1")
                        tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1 = QtWidgets.QHBoxLayout()
                        tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1.setObjectName(
                            "DE_Aquisition_Info_file_browse_horizontalLayout_1")
                        tmp_DE_Acquisition_Info_file_browse__label_1 = QtWidgets.QLabel(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_file_browse__label_1.setMaximumSize(QtCore.QSize(16777215, 16500000))
                        tmp_DE_Acquisition_Info_file_browse__label_1.setObjectName(
                            "DE_Acquisition_Info_file_browse__label_1")
                        tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_file_browse__label_1)
                        tmp_DE_Acquisition_Info_file_browse__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_file_browse__lineEdit_1.setObjectName(
                            "DE_Acquisition_Info_file_browse__lineEdit_1")
                        tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_file_browse__lineEdit_1)
                        tmp_DE_Acquisition_Info_file_browse__browseButton_1 = QtWidgets.QPushButton(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_file_browse__browseButton_1.setObjectName(
                            "DE_Acquisition_Info_file_browse__browseButton_1")
                        tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_file_browse__browseButton_1)
                        tmp_DE_Acquisition_Info_file_browse__enterButton_1 = QtWidgets.QPushButton(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_file_browse__enterButton_1.setObjectName(
                            "DE_Acquisition_Info_file_browse__enterButton_1")
                        tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_file_browse__enterButton_1)
                        tmp_DE_Aquisition_Info_file__verticalLayout_1.addLayout(
                            tmp_DE_Aquisition_Info_file_browse_horizontalLayout_1)
                        tmp_DE_Acquisition_Infro_file_digital_evidence_file_name__horizontalLayout_1 = QtWidgets.QHBoxLayout()
                        tmp_DE_Acquisition_Infro_file_digital_evidence_file_name__horizontalLayout_1.setObjectName(
                            "DE_Acquisition_Infro_file_digital_evidence_file_name__horizontalLayout_1")
                        tmp_DE_Acquisition_Info_digital_evidence_file_name__label_1 = QtWidgets.QLabel(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_digital_evidence_file_name__label_1.setObjectName(
                            "DE_Acquisition_Info_digital_evidence_file_name__label_1")
                        tmp_DE_Acquisition_Infro_file_digital_evidence_file_name__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_digital_evidence_file_name__label_1)
                        tmp_DE_Acquisition_Info_digital_evidence_file_name__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_digital_evidence_file_name__lineEdit_1.setObjectName(
                            "DE_Acquisition_Info_digital_evidence_file_name__lineEdit_1")
                        tmp_DE_Acquisition_Infro_file_digital_evidence_file_name__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_digital_evidence_file_name__lineEdit_1)
                        tmp_DE_Aquisition_Info_file__verticalLayout_1.addLayout(
                            tmp_DE_Acquisition_Infro_file_digital_evidence_file_name__horizontalLayout_1)
                        tmp_DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1 = QtWidgets.QHBoxLayout()
                        tmp_DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1.setObjectName(
                            "DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1")
                        tmp_DE_Acquisition_Info_digital_evidence_file_path__label_1 = QtWidgets.QLabel(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_digital_evidence_file_path__label_1.setObjectName(
                            "DE_Acquisition_Info_digital_evidence_file_path__label_1")
                        tmp_DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_digital_evidence_file_path__label_1)
                        tmp_DE_Acquisition_Info_digital_evidence_file_path__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_digital_evidence_file_path__lineEdit_1.setObjectName(
                            "DE_Acquisition_Info_digital_evidence_file_path__lineEdit_1")
                        tmp_DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_digital_evidence_file_path__lineEdit_1)
                        tmp_DE_Aquisition_Info_file__verticalLayout_1.addLayout(
                            tmp_DE_Aquisition_Info_digital_evidence_file_path__horizontalLayout_1)
                        tmp_DE_Acquisition_Info_hash_type__horizontalLayout_1 = QtWidgets.QHBoxLayout()
                        tmp_DE_Acquisition_Info_hash_type__horizontalLayout_1.setObjectName(
                            "DE_Acquisition_Info_hash_type__horizontalLayout_1")
                        tmp_DE_Acquisition_Info_hash_type__label_1 = QtWidgets.QLabel(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Acquisition_Info_hash_type__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_hash_type__lineEdit_1.setObjectName(
                            "DE_Acquisition_Info_hash_type__lineEdit_1")
                        tmp_DE_Acquisition_Info_hash_type__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_hash_type__lineEdit_1)
                        tmp_DE_Aquisition_Info_file__verticalLayout_1.addLayout(
                            tmp_DE_Acquisition_Info_hash_type__horizontalLayout_1)
                        tmp_DE_Acquisition_Info_hash_value__horizontalLayout_1 = QtWidgets.QHBoxLayout()
                        tmp_DE_Acquisition_Info_hash_value__horizontalLayout_1.setObjectName(
                            "DE_Acquisition_Info_hash_value__horizontalLayout_1")
                        tmp_DE_Acquisition_Info_hash_value__label_1 = QtWidgets.QLabel(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Acquisition_Info_hash_value__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Aquisition_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Acquisition_Info_hash_value__lineEdit_1.setObjectName(
                            "DE_Acquisition_Info_hash_value__lineEdit_1")
                        tmp_DE_Acquisition_Info_hash_value__horizontalLayout_1.addWidget(
                            tmp_DE_Acquisition_Info_hash_value__lineEdit_1)
                        tmp_DE_Aquisition_Info_file__verticalLayout_1.addLayout(
                            tmp_DE_Acquisition_Info_hash_value__horizontalLayout_1)
                        ...
                        tmp_DE_Vessel_Info__scrollAreaWidgetContents_1.setObjectName(
                            "DE_Vessel_Info__scrollAreaWidgetContents_1")
                        ...
                        tmp_DE_Vessel_Info_vessel_name__label_1 = QtWidgets.QLabel(
                        ...
                        tmp_DE_Veseel_Info_vessel_name__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_name__label_1)
                        ...
                        tmp_DE_Veseel_Info_vessel_name__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_name__lineEdit_1)
                        ...
                        tmp_DE_Vessel_Info__verticalLayout_1.addLayout(
                            tmp_DE_Vessel_Info_vessel_management_id__horizontalLayout_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_MMSI__label_1 = QtWidgets.QLabel(
                            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Vessel_Info_vessel_MMSI__label_1.setObjectName("DE_Vessel_Info_vessel_MMSI__label_1")
                        tmp_DE_Vessel_Info_vessel_MMSI__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_MMSI__label_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_MMSI__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_MMSI__lineEdit_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_callsign__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Vessel_Info_vessel_callsign__lineEdit_1.setObjectName(
                            "DE_Vessel_Info_vessel_callsign__lineEdit_1")
                        tmp_DE_Vessel_Info_vessel_callsign__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_callsign__lineEdit_1)
                        tmp_DE_Vessel_Info__verticalLayout_1.addLayout(
                            tmp_DE_Vessel_Info_vessel_callsign__horizontalLayout_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_IMO__label_1 = QtWidgets.QLabel(
                            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_IMO__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_IMO__lineEdit_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_MRN__label_1 = QtWidgets.QLabel(
                            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_MRN__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_MRN__lineEdit_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_tonnage__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_tonnage__label_1)
                        tmp_DE_Vessel_Info_vessel_tonnage__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Vessel_Info_vessel_tonnage__lineEdit_1.setObjectName(
                            "DE_Vessel_Info_vessel_tonnage__lineEdit_1")
                        tmp_DE_Vessel_Info_vessel_tonnage__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_tonnage__lineEdit_1)
                        tmp_DE_Vessel_Info__verticalLayout_1.addLayout(
                            tmp_DE_Vessel_Info_vessel_tonnage__horizontalLayout_1)
                        ...
                        tmp_DE_Vessel_Info_vessel_length__label_1 = QtWidgets.QLabel(
                            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Vessel_Info_vessel_length__label_1.setObjectName("DE_Vessel_Info_vessel_length__label_1")
                        tmp_DE_Vessel_Info_vessel_length__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_length__label_1)
                        tmp_DE_Vessel_Info_vessel_length__lineEdit_1 = QtWidgets.QLineEdit(
                            tmp_DE_Vessel_Info__scrollAreaWidgetContents_1)
                        tmp_DE_Vessel_Info_vessel_length__lineEdit_1.setObjectName(
                            "DE_Vessel_Info_vessel_length__lineEdit_1")
                        tmp_DE_Vessel_Info_vessel_length__horizontalLayout_1.addWidget(
                            tmp_DE_Vessel_Info_vessel_length__lineEdit_1)
                        ...
                        tmp_DE_Marines_Electronics_Info__scrollArea_1 = QtWidgets.QScrollArea(
                            tmp_DE_sub__scrollAreaWidgetContents_1)
                        tmp_DE_Marines_Electronics_Info__scrollArea_1.setWidgetResizable(True)
                        tmp_DE_Marines_Electronics_Info__scrollArea_1.setObjectName(
                            "DE_Marines_Electronics_Info__scrollArea_1")
                        tmp_DE_Marines_Electronics_Info__scrollAreaWidgetContents_1 = QtWidgets.QWidget()
                        tmp_DE_Marines_Electronics_Info__scrollAreaWidgetContents_1.setGeometry(
                            QtCore.QRect(0, 0, 249, 227))
                        ...
                        tmp_gridLayout_6 = QtWidgets.QGridLayout(
                        ...
                        management_id = data['Digital Evidence Package']['Digital Evidences'][i]['management_id']
                        digital_evidence_type = data['Digital Evidence Package']['Digital Evidences'][i][
                            'management_id']
                        evidence_gathering_type = data['Digital Evidence Package']['Digital Evidences'][i][
                            'management_id']
                        ...
                        acquisition_person_name = \
                        data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info'][
                            'aquisition_person_name']  # acquisition
                        ...
                        data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info'][
                            'acquisition_location']
                        acquisition_tool = data['Digital Evidence Package']['Digital Evidences'][i]['Acquisition Info'][
                            'acquisition_tool']

                        tmp_DE_management_id__lineEdit_1.setText(management_id)
                        tmp_DE_digital_evidence_type__lineEdit_1.setText(digital_evidence_type)
                        tmp_DE_evidences_gathering_type__ineEdit_1.setText(evidence_gathering_type)

                        tmp_DE_Vessel_Info_vessel_management_id__lineEdit_1.setText(vessel_management_id)
                        tmp_DE_Vessel_Info_vessel_name__lineEdit_1.setText(vessel_name)
                        tmp_DE_Vessel_Info_vessel_MMSI__lineEdit_1.setText(vessel_MMSI)
                        tmp_DE_Vessel_Info_vessel_callsign__lineEdit_1.setText(vessel_callsign)
                        tmp_DE_Vessel_Info_vessel_IMO__lineEdit_1.setText(vessel_IMO)
                        tmp_DE_Vessel_Info_vessel_MRN__lineEdit_1.setText(vessel_MRN)
                        tmp_DE_Vessel_Info_vessel_tonnage__lineEdit_1.setText(vessel_tonnage)
                        tmp_DE_Vessel_Info_vessel_length__lineEdit_1.setText(vessel_length)
                        tmp_DE_Vessel_Info_vessel_total_number_of_equipmentwith_track__lineEdit_1.setText(total_number_of_equipment_with_track)

                        tmp_DE_Marines_Electronics_Info_device_management_id__lineEdit_1.setText(device_management_id)
                        tmp_DE_Marines_Electronics_Info_device_type__lineEdit_1.setText(device_type)
                        tmp_DE_Marines_Electronics_Info_device_manufacturer__lineEdit_1.setText(device_manufacturer)
                        tmp_DE_Marines_Electronics_Info_device_model_name__lineEdit_1.setText(device_model_name)
                        tmp_DE_Marines_Electronics_Info_device_model_serial_number__lineEdit_1.setText(device_model_serial_number)
                        tmp_DE_Marines_Electronics_Info_device_os_firmware__lineEdit_1.setText(device_os_firmware)
                        tmp_DE_Marines_Electronics_Info_device_description__lineEdit_1.setText(device_descripton)

                        tmp_DE_Gather_Info_gather_datetime__lineEdit_1.setText(gather_datetime)
                        tmp_DE_Gather_Info_gather_location__lineEdit_1.setText(gather_location)
                        tmp_DE_Gather_Info_gather_person_name__lineEdit_1.setText(gather_person_name)
                        tmp_DE_Gather_Info_gather_person_agency__lineEdit_1.setText(gather_person_agency)
                        tmp_DE_Gather_Info_gather_person_rank__lineEdit_1.setText(gather_person_rank)
                        tmp_DE_Gather_Info_submitter_name__lineEdit_1.setText(submitter_name)

                        tmp_DE_Acquisition_Info_acquisition_person_name__lineEdit_1.setText(acquisition_person_name)
                        tmp_DE_Acquisition_Info_acquisition_date_time__lineEdit_1.setText(acquisition_datetime)
                        tmp_DE_Acquisition_Info_acquisition_location__lineEdit_1.setText(acquisition_location)
                        tmp_DE_Acquisition_Info_acquisition_tool__lineEdit_1.setText(acquisition_tool)
                ...
                for i in range(0, len(data['Digital Evidence Package']['Analysis Info']['Other Files'])):
                    ...
                    if i == 0:
                        ...
                        tmp_AI_other_files_file_browse__browseButton_1 = QtWidgets.QPushButton(
                            self.AI__scrollAreaWidgetContents)
                        ...
                        tmp_AI_other_files_file_size__label_1.setObjectName(
                            "AI_other_files_file_size__label_" + str(self.AI_num))
                ...
                for i in range(0, len(data['Digital Evidence Package']['Analysis Info']['Reports'])):
                    ...
                    if i == 0:
                        ...
                        submission_agency = data['Digital Evidence Package']['Analysis Info']['Reports'][i]['submission_agency']
                        report_creation_datetime = data['Digital Evidence Package']['Analysis Info']['Reports'][i]['report_creation_datetime']
                        division_name_of_report_maker = data['Digital Evidence Package']['Analysis Info']['Reports'][i]['division_name_of_report_maker']
                        team_name_of_report_maker = data['Digital Evidence Package']['Analysis Info']['Reports'][i]['team_name_of_report_maker']
                        ...
                        file_creation_datetime = data['Digital Evidence Package']['Analysis Info']['Reports'][i]['file_creation_datetime']
                        file_description = data['Digital Evidence Package']['Analysis Info']['Reports'][i]['file_description']
                        ...
                        tmp_AI_Reports_file_info__label_1 = QtWidgets.QLabel(
                            self.AI_Reports__scrollAreaWidgetContents_1)
                        ...
                        tmp_AI_Reports_file_name__label_1 = QtWidgets.QLabel(
                            self.AI_Reports__scrollAreaWidgetContents_1)
                        tmp_AI_Reports_file_name__label_1.setObjectName(
                            "AI_Reports_file_name__label_" + str(self.AIReports_num))
                        ...
                        tmp_AI_Reports_file_size__label_1 = QtWidgets.QLabel(
                            self.AI_Reports__scrollAreaWidgetContents_1)
                        ...
                        tmp_AI_Reports_file_path__label_1 = QtWidgets.QLabel(
                            self.AI_Reports__scrollAreaWidgetContents_1)
                        tmp_AI_Reports_file_path__label_1.setObjectName(
                            "AI_Reports_file_path__label_" + str(self.AIReports_num))
                ...
                for i in range (0, len(data['Digital Evidence Package']['Analysis Info']['Equipment Traces'])):
                    ...
                    if i == 0:
                        ...
                        description = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['description']
                        mgmt_id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['mgmt_id']
                        vessel_id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['vessel_id']
                        evidence_id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['evidence_id']
                        power_on_time = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['power_on_time']
                        track_extraction_description = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['track_extraction_description']
                        system_info_description = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['system_info_description']
                        operation_status = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['operation_status']
                        power_off_time = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['power_off_time']
                        track_recording_period = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['track_recording_period']
                        track_deletion_trace = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['track_deletion_trace']
                        trace_notes = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i]['trace_notes']
                        ...
                        self.AI_EquipmentTraces_user_trace_info_system_power_on_time__lineEdit_1.setText(power_on_time)
                        self.AI_EquipmentTraces_user_trace_info_track_extractopm_description__lineEdit_1.setText(track_extraction_description)
                        self.AI_EquipmentTraces_user_trace_info_system_description__lineEdit_1.setText(system_info_description)
                        self.AI_EquipmentTraces_user_trace_info_system_operation_status__lineEdit_1.setText(system_info_description)
                        self.AI_EquipmentTraces_user_trace_info_system_power_off_time__lineEdit_1.setText(power_off_time)
                        self.AI_EquipmentTraces_user_trace_info_track_recording_period__lineEdit_1.setText(track_recording_period)
                        self.AI_EquipmentTraces_user_trace_info_track_deletion_trace__lineEdit_1.setText(track_deletion_trace)
                        self.AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_1.setText(trace_notes)
                        ...
                        tmp_AI_EquipmentTraces_user_traces_info_sub__horizontalLayout_1.setObjectName(
                            "AI_EquipmentTraces_user_traces_info_sub__horizontalLayout_-" + str(
                        ...
                        tmp_AI_EquipmentTraces_user_traces_info_sub__verticalLayout_1.setObjectName(
                            "AI_EquipmentTraces_user_traces_info_sub__verticalLayout_-" + str(
                                self.AI_EquipmentTraces_num))
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_system_power_on_time__label_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_system_power_on_time__label_-" + str(
                                self.AI_EquipmentTraces_num))
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_system_description__label_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_system_description__label_-" + str(
                                self.AI_EquipmentTraces_num))
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_system_description__lineEdit_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_system_description__lineEdit_-" + str(
                                self.AI_EquipmentTraces_num))
                        tmp_AI_EquipmentTraces_user_trace_info_system_description__horizontalLayout_1.addWidget(
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_system_power_off_time__label_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_system_power_off_time__label_-" + str(
                                self.AI_EquipmentTraces_num))
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_track_recording_period__label_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_track_recording_period__label_-" + str(
                                self.AI_EquipmentTraces_num))
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_track_deletion_trace__label_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_track_deletion_trace__label_-" + str(
                                self.AI_EquipmentTraces_num))
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_user_trace_notes__label_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_user_trace_notes__label_-" + str(
                                self.AI_EquipmentTraces_num))
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_1.setObjectName(
                            "AI_EquipmentTraces_user_trace_info_user_trace_notes__lineEdit_-" + str(
                                self.AI_EquipmentTraces_num))
                        tmp_AI_EquipmentTraces_user_trace_info_user_trace_notes__horizontalLayout_1.addWidget(
                        ...
                        self.gridLayout_19.addLayout(tmp_AI_EquipmentTraces__verticalLayout_1,
                                                     self.AI_EquipmentTraces_num, 0, 2, 2)
                        ...
                        evidence_id = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i][
                            'evidence_id']
                        power_on_time = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i][
                            'power_on_time']
                        ...
                        data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i][
                            'system_info_description']
                        operation_status = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i][
                            'operation_status']
                        power_off_time = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i][
                            'power_off_time']
                        track_recording_period = \
                        data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i][
                            'track_recording_period']
                        track_deletion_trace = data['Digital Evidence Package']['Analysis Info']['Equipment Traces'][i][
                        ...
                        tmp_AI_EquipmentTraces_user_trace_info_track_extractopm_description__lineEdit_1.setText(track_extraction_description)
                ...
                ############## Digital Evidence Package Log 부분 ##################
                len(data['Digital Evidence Package Log'])

                for i in range(0, len(data['Digital Evidence Package Log'])):

                    if i == 0:
                        digital_evidence_package_management_id = data['Digital Evidence Package Log'][i]['digital_evidence_package_management_id']
                        log_datetime = data['Digital Evidence Package Log'][i]['log_datetime']  # datetime으로 고쳤음
                        log_type = data['Digital Evidence Package Log'][i]['log_type']
                        log_description = data['Digital Evidence Package Log'][i]['log_description']
                        devision_name_of_logger = data['Digital Evidence Package Log'][i]['devision_name_of_logger']
                        team_name_of_logger = data['Digital Evidence Package Log'][i]['team_name_of_logger']
                        rank_of_logger = data['Digital Evidence Package Log'][i]['rank_of_logger']
                        name_of_logger = data['Digital Evidence Package Log'][i]['name_of_logger']

                        self.DEPL_digital_evidence_package_management_id__lineEdit_1.setText(digital_evidence_package_management_id)
                        self.DEPL_log_datetime__lineEdit_1.setText(log_datetime)
                        self.DEPL_log_type__lineEdit_1.setText(log_type)
                        self.DEPL_log_description__lineEdit_1.setText(log_description)
                        self.DEPL_devision_name_of_logger__lineEdit_1.setText(devision_name_of_logger)
                        self.DEPL_team_name_of_logger__lineEdit_1.setText(team_name_of_logger)
                        self.DEPL_rank_of_logger__lineEdit_1.setText(rank_of_logger)
                        self.DEPL_name_of_logger__lineEdit_1.setText(name_of_logger)
                        ...
                        tmp_DEPL__verticalLayout_1.addLayout(
                            tmp_DEPL_digital_evidence_package_management_id___horizontalLayout_1)
                        ...
                        tmp_DEPL_log_datetime__lineEdit_1.setObjectName(
                            "DEPL_log_datetime__lineEdit_" + str(self.DEPL_num))
                        ...
                        tmp_DEPL_log_type__horizontalLayout_1.setObjectName(
                            "DEPL_log_type__horizontalLayout_" + str(self.DEPL_num))
                        ...
                        tmp_DEPL_log_description__label_1.setObjectName(
                            "DEPL_log_description__label_" + str(self.DEPL_num))
                        ...
                        tmp_DEPL_log_description__lineEdit_1.setObjectName(
                            "DEPL_log_description__lineEdit_" + str(self.DEPL_num))
                        ...
                        tmp_DEPL_devision_name_of_logger__horizontalLayout_1.addWidget(
                            tmp_DEPL_devision_name_of_logger__label_1)
                        tmp_DEPL_devision_name_of_logger__lineEdit_1 = QtWidgets.QLineEdit(
                            self.scrollAreaWidgetContents_12)
                        tmp_DEPL_devision_name_of_logger__lineEdit_1.setObjectName(
                            "DEPL_devision_name_of_logger__lineEdit_" + str(self.DEPL_num))
                        tmp_DEPL_devision_name_of_logger__horizontalLayout_1.addWidget(
                            tmp_DEPL_devision_name_of_logger__lineEdit_1)
                        ...
                        tmp_DEPL_team_name_of_logger__label_1.setObjectName(
                            "DEPL_team_name_of_logger__label_" + str(self.DEPL_num))
                        tmp_DEPL_team_name_of_logger__label_1.setText("이력 분석 팀명: ")
                        tmp_DEPL_team_name_of_logger__horizontalLayout_1.addWidget(
                            tmp_DEPL_team_name_of_logger__label_1)
                        ...
                        tmp_DEPL_team_name_of_logger__horizontalLayout_1.addWidget(
                            tmp_DEPL_team_name_of_logger__lineEdit_1)
                        ...
                        tmp_DEPL_rank_of_logger__label_1.setObjectName(
                            "DEPL_rank_of_logger__label_" + str(self.DEPL_num))
                        ...
                        tmp_DEPL_rank_of_logger__lineEdit_1.setObjectName(
                            "DEPL_rank_of_logger__lineEdit_" + str(self.DEPL_num))
                        ...
                        tmp_DEPL_name_of_logger__label_1.setObjectName(
                            "DEPL_name_of_logger__label_" + str(self.DEPL_num))
                        ...
                        tmp_DEPL_name_of_logger__lineEdit_1.setObjectName(
                            "DEPL_name_of_logger__lineEdit_" + str(self.DEPL_num))
                        ...
                        digital_evidence_package_management_id = data['Digital Evidence Package Log'][i]['digital_evidence_package_management_id']
                        log_datetime = data['Digital Evidence Package Log'][i]['log_dateteime']  # datetime으로 고쳤음
                        log_type = data['Digital Evidence Package Log'][i]['log_type']
                        log_description = data['Digital Evidence Package Log'][i]['log_description']
                        devision_name_of_logger = data['Digital Evidence Package Log'][i]['devision_name_of_logger']
                        team_name_of_logger = data['Digital Evidence Package Log'][i]['team_name_of_logger']
                        ...
                        tmp_DEPL_digital_evidence_package_management_id__lineEdit_1.setText(digital_evidence_package_management_id)
                        tmp_DEPL_log_datetime__lineEdit_1.setText(log_datetime)
                        tmp_DEPL_log_type__lineEdit_1.setText(log_type)
                        tmp_DEPL_log_description__lineEdit_1.setText(log_description)
                        tmp_DEPL_devision_name_of_logger__lineEdit_1.setText(devision_name_of_logger)
                        tmp_DEPL_team_name_of_logger__lineEdit_1.setText(team_name_of_logger)
                        tmp_DEPL_rank_of_logger__lineEdit_1.setText(rank_of_logger)
                        tmp_DEPL_name_of_logger__lineEdit_1.setText(name_of_logger)


            '''json 읽고 읽은 애들 개수 체크해서 넣기
            개수 읽어서 [0]째는 값만 세팅 [1], [2], [n] 얘네들은 만들어주면서 값넣고 edittext 리스트'''
    ...
    def ExportButton_exporttojsonfile(self):
        ...
        for i, list in enumerate(self.DE_AddAll_List):
            ...
            ##Acquisition Info반복
            tmp_dict['Acquisition Info'] = {'acquisition_person_name': list[29].text(),
            ...
            ##DE Other Info 시작
            tmp_dict['Other Files'] = {'other_files_id': list[33].text(),
                                       'other_files_type': list[34].text(),
                                       'other_files_size': list[35].text(),
                                       'other_files_path': list[36].text(),
                                       'other_files_hash_type': list[37].text(),
                                       'other_files_hash_value': list[38].text(),
                                       'other_files_file_description': list[39].text(),
                                       'other_files_file_metadata': list[40].text()}
            tmp_list = []
            for other_list in self.DE_Other_Files_List[i]:
                tmp_list.append({'other_files_id': list[1].text(), 'other_files_type': list[2].text(),
    ...
    def DE__addButton_AddDE(self,a):
        ...
        self.DE_Other_Files_List.append(tmp_gridLayout_13)
        ...
        tmp_DE_other_files__addButton_1.clicked.connect(
            lambda: self.DE_Other_Files_Add(a))
    ...
    # DE Gather의 +누르고 Browse눌러서 파일 업로드
    def DE_other_files_file_browse__browseButton_1_QFileDialog2(self, a):
        file_name = QFileDialog.getOpenFileName()
        self.DE_AddAll_Other_Files_Browse_List[a][0].setText(file_name[0])
    ...
    def DE_Other_Files_Add(self, a):
        ...
        b = len(self.DE_Other_Files_List[a])
        tmp_DE_other_files_file_browse__browseButton_1.clicked.connect(
        ...
        tmp_DE_other_files__verticalLayout_1.addLayout(tmp_DE_other_files_file_metadata__horizontalLayout_1)
        self.DE_Other_Files_List[a].addLayout(tmp_DE_other_files__verticalLayout_1, self.DE_Other_Files_num, 0, 1, 1)
    ...
    def DE_other_files_file_browse__browseButton_1_QFileDialog(self, a):
        file_name = QFileDialog.getOpenFileName()
        self.DE_Other_Files_List[a][0].setText(file_name[0])

    ## DE Other Files Enter 누르면 파일 계산
    def DE_other_files_file_browse__EnterButton_1_Calculate(self, a):
        file_path = self.DE_Other_Files_List[a][0].text()
        file_name = file_path[file_path.rfind("/") + 1:]
        copy_file_path = ".\\디지털 증거\\기타 파일\\" + file_name
        if os.path.isdir(".\\디지털 증거\\기타 파일\\") == False:
            os.makedirs(".\\디지털 증거\\기타 파일")
        ...
        with open(copy_file_path, 'rb') as file:
            ...
            # 0
            # 1
        self.DE_Other_Files_List[a][2].setText(file_name[file_name.rfind(".") + 1:])
        self.DE_Other_Files_List[a][3].setText(str(file_size))
        self.DE_Other_Files_List[a][4].setText(copy_file_path)
        self.DE_Other_Files_List[a][5].setText("SHA-256")
        self.DE_Other_Files_List[a][6].setText(sha256.hexdigest())

    # ##DE 전체 +누르고 Gather에서 다시 add
    # def DE_Gather_Info__addButton_1_AddGatherAdd2(self, a):
    #     print("adsfds")
    #
    #     self.DE_AddAll_Gather_Enter_num += 1
    #
    ...
    #     tmp_DE_Gather_Info_file__verticalLayout_1 = QtWidgets.QVBoxLayout()
    #     tmp_DE_Gather_Info_file__verticalLayout_1.setObjectName(
    #         "DE_Gather_Info_file__verticalLayout_" + str(self.DE_AddAll_Gather_Enter_num))
    #
    #     tmp = QtWidgets.QFrame(self.DE_Gather_Info__scrollAreaWidgetContents_1)
    #     tmp.setFrameShape(QtWidgets.QFrame.HLine)
    #     tmp.setFrameShadow(QtWidgets.QFrame.Sunken)
    ...
    #     tmp_DE_Gather_Info_file__filebrowse__horizontalLayout_1 = QtWidgets.QHBoxLayout()
    #     tmp_DE_Gather_Info_file__filebrowse__horizontalLayout_1.setObjectName(
    #         "DE_Gather_Info_file__filebrowse__horizontalLayout_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_file__filebrowse__label_1 = QtWidgets.QLabel(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_file__filebrowse__label_1.setObjectName(
    #         "DE_Gather_Info_file__filebrowse__label_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_file__filebrowse__label_1.setText("파일 입력: ")
    #     tmp_DE_Gather_Info_file__filebrowse__horizontalLayout_1.addWidget(
    #         tmp_DE_Gather_Info_file__filebrowse__label_1)
    #     tmp_DE_Gather_Info_file__filebrowse__lineEdit_1 = QtWidgets.QLineEdit(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_file__filebrowse__lineEdit_1.setObjectName(
    #         "DE_Gather_Info_file__filebrowse__lineEdit_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_file__filebrowse__horizontalLayout_1.addWidget(
    #         tmp_DE_Gather_Info_file__filebrowse__lineEdit_1)
    #
    #     tmp_DE_Gather_Info_file__filebrowse__browseButton_1 = QtWidgets.QPushButton(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_file__filebrowse__browseButton_1.setObjectName(
    #         "DE_Gather_Info_file__filebrowse__browseButton_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_file__filebrowse__browseButton_1.setText("Browse...")
    #     b = len(self.DE_Gather_Info_List[a]) - 1
    #     tmp_DE_Gather_Info_file__filebrowse__browseButton_1.clicked.connect(
    #         lambda: self.DE_Gather_Info_file__filebrowse__browseButton_1_QFileDialog(a, b))
    #     tmp_DE_Gather_Info_file__filebrowse__horizontalLayout_1.addWidget(
    #         tmp_DE_Gather_Info_file__filebrowse__browseButton_1)
    ...
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_file__filebrowse__enterButton_1.setObjectName(
    #         "DE_Gather_Info_file__filebrowse__enterButton_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_file__filebrowse__enterButton_1.setText("Enter")
    #     b = len(self.DE_Gather_Info_List[a]) - 1
    #     tmp_DE_Gather_Info_file__filebrowse__enterButton_1.clicked.connect(
    #         lambda: self.DE_Gather_Info_file__filebrowse__enterButton_1_Calculate(a, b))
    ...
    #     tmp_DE_Gather_Info_gather_media_type__horizontalLayout_1 = QtWidgets.QHBoxLayout()
    #     tmp_DE_Gather_Info_gather_media_type__horizontalLayout_1.setObjectName(
    #         "DE_Gather_Info_gather_media_type__horizontalLayout_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_media_type__label_1 = QtWidgets.QLabel(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_gather_media_type__label_1.setObjectName(
    #         "DE_Gather_Info_gather_media_type__label_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_media_type__label_1.setText("채증 미디어 유형: ")
    #     tmp_DE_Gather_Info_gather_media_type__horizontalLayout_1.addWidget(
    #         tmp_DE_Gather_Info_gather_media_type__label_1)
    #     tmp_DE_Gather_Info_gather_media_type__lineEdit_1 = QtWidgets.QLineEdit(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_gather_media_type__lineEdit_1.setObjectName(
    #         "DE_Gather_Info_gather_media_type__lineEdit_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_media_type__horizontalLayout_1.addWidget(
    #         tmp_DE_Gather_Info_gather_media_type__lineEdit_1)
    #     tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(
    #         tmp_DE_Gather_Info_gather_media_type__horizontalLayout_1)
    ...
    #     tmp_DE_Gather_Info_gather_hash_type__horizontalLayout_1 = QtWidgets.QHBoxLayout()
    #     tmp_DE_Gather_Info_gather_hash_type__horizontalLayout_1.setObjectName(
    #         "DE_Gather_Info_gather_hash_type__horizontalLayout_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info__gather_hash_type__label_1 = QtWidgets.QLabel(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info__gather_hash_type__label_1.setObjectName(
    #         "DE_Gather_Info__gather_hash_type__label_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info__gather_hash_type__label_1.setText("채증 미디어 해시 종류: ")
    #     tmp_DE_Gather_Info_gather_hash_type__horizontalLayout_1.addWidget(
    #         tmp_DE_Gather_Info__gather_hash_type__label_1)
    #     tmp_DE_Gather_Info__gather_hash_type__lineEdit_1 = QtWidgets.QLineEdit(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info__gather_hash_type__lineEdit_1.setObjectName(
    #         "DE_Gather_Info__gather_hash_type__lineEdit_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_hash_type__horizontalLayout_1.addWidget(
    #         tmp_DE_Gather_Info__gather_hash_type__lineEdit_1)
    #     tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(tmp_DE_Gather_Info_gather_hash_type__horizontalLayout_1)
    #     tmp_DE_Gather_Info__gather_hash_type__lineEdit_1.setReadOnly(True)
    ...
    #     tmp_DE_Gather_Info_gather_hash__horizontalLayout_1 = QtWidgets.QHBoxLayout()
    #     tmp_DE_Gather_Info_gather_hash__horizontalLayout_1.setObjectName(
    #         "DE_Gather_Info_gather_hash__horizontalLayout_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_hash__label_1 = QtWidgets.QLabel(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_gather_hash__label_1.setObjectName(
    #         "DE_Gather_Info_gather_hash__label_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_hash__label_1.setText("채증 미디어 해시 값: ")
    #     tmp_DE_Gather_Info_gather_hash__horizontalLayout_1.addWidget(tmp_DE_Gather_Info_gather_hash__label_1)
    #     tmp_DE_Gather_Info_gather_hash__lineEdit_1 = QtWidgets.QLineEdit(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_gather_hash__lineEdit_1.setObjectName(
    #         "DE_Gather_Info_gather_hash__lineEdit_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_hash__horizontalLayout_1.addWidget(tmp_DE_Gather_Info_gather_hash__lineEdit_1)
    #     tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(tmp_DE_Gather_Info_gather_hash__horizontalLayout_1)
    #     tmp_DE_Gather_Info_gather_hash__lineEdit_1.setReadOnly(True)
    #     ##self.DE_Gather_Info_gather_hash__lineEdit_1.setReadOnly(True)
    ...
    #     tmp_DE_Gather_Info_gather_path__horizontalLayout_1 = QtWidgets.QHBoxLayout()
    #     tmp_DE_Gather_Info_gather_path__horizontalLayout_1.setObjectName(
    #         "DE_Gather_Info_gather_path__horizontalLayout_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_path__label_1 = QtWidgets.QLabel(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_gather_path__label_1.setObjectName(
    #         "DE_Gather_Info_gather_path__label_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_path__label_1.setText("채증 미디어 경로: ")
    #     tmp_DE_Gather_Info_gather_path__horizontalLayout_1.addWidget(tmp_DE_Gather_Info_gather_path__label_1)
    #     tmp_DE_Gather_Info_gather_path__lineEdit_1 = QtWidgets.QLineEdit(
    #         self.DE_Gather_Info_file__scrollAreaWidgetContents_1)
    #     tmp_DE_Gather_Info_gather_path__lineEdit_1.setObjectName(
    #         "DE_Gather_Info_gather_path__lineEdit_" + str(self.DE_AddAll_Gather_Enter_num))
    #     tmp_DE_Gather_Info_gather_path__horizontalLayout_1.addWidget(tmp_DE_Gather_Info_gather_path__lineEdit_1)
    #     tmp_DE_Gather_Info_gather_path__lineEdit_1.setReadOnly(True)
    #     ##self.DE_Gather_Info_gather_path__lineEdit_1.setReadOnly(True)
    #
    #     tmp_DE_Gather_Info_file__verticalLayout_1.addLayout(tmp_DE_Gather_Info_gather_path__horizontalLayout_1)
    #     self.DE_Gather_Info_File_List[a].addLayout(tmp_DE_Gather_Info_file__verticalLayout_1, self.DE_AddAll_Gather_Enter_num, 0,
    #                                  1, 1)
    #
    #     tmp_list = list()
    #     tmp_list.append(tmp_DE_Gather_Info_file__filebrowse__lineEdit_1)
