...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        if self.mode == 'load':
            with open(self.file_path, 'r') as f:
                ...
                print(len(data['Digital Evidence Package Log']))
                ...
                for i in range(0, len(data['Digital Evidence Package Log'])):
                    ...
                    if i == 0:
                        ...
                        digital_evidence_package_management_id = data['Digital Evidence Package Log'][i][
                        ...
                        tmp_DEPL_digital_evidence_package_management_id__lineEdit_1.setText(
                            digital_evidence_package_management_id)
    ...
    def ExportButton_exporttojsonfile(self):
        ...
        for i, list in enumerate(self.DE_AddAll_List):
            ...
            ##DE Other Info 시작
            list_DE_Other_Files = []
            for list in self.DE_Other_Files_List:
    ...
    def DE_Gather_Info__addButton_1_AddGatherInfoFile(self, a):
        print("DE_Gather_Info__addButton_1_AddGatherInfoFile")
        self.DE_Gather_Info_num += 1
    ...
    def DE_Acquisition_Info__addButton_1_AddDEAquisitionFile(self, a):
        print("DE_Acquisition_Info__addButton_1_AddDEAquisitionFile")
        self.DE_Acquisition_Info_num += 1
        ...
        self.DE_Acquisition_Info_File_List[a].addLayout(tmp_DE_Aquisition_Info_file__verticalLayout_1, self.DE_Acquisition_Info_num, 0,
                                     1,
                                     1)
    ...
    def DE_Other_Files_Add(self):
        ...
        a = len(self.DE_Other_Files_List)
        tmp_DE_other_files_file_browse__browseButton_1.clicked.connect(
            lambda: self.DE_other_files_file_browse__browseButton_1_QFileDialog(a))
        ...
        a = len(self.DE_Other_Files_List)
        tmp_DE_other_files_file_browse__EnterButton_1.clicked.connect(
            lambda: self.DE_other_files_file_browse__EnterButton_1_Calculate(a))
        ...
        tmp_DE_other_files__verticalLayout_1.addLayout(tmp_DE_other_files_file_metadata__horizontalLayout_1)
        self.gridLayout_13.addLayout(tmp_DE_other_files__verticalLayout_1, self.DE_Other_Files_num, 0, 1, 1)
