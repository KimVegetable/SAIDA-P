...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        tmp_list.append(self.DE_Authentication_ID__lineEdit_1) #37
        ...
        tmp_list.append(self.DE_Acquisition_Info_acquisition_location__lineEdit_1) #40
        tmp_list.append(self.DE_Acquisition_Info_acquisition_tool__lineEdit_1)
        # Acquisition 추가
        tmp_list.append(self.DE_Acquisition_Info_DEF_serial_no__lineEdit_1) #42
        tmp_list.append(self.DE_Acquisition_Info_DEF_management_id__management_id__lineEdit_1)
        tmp_list.append(self.DE_Acquisition_Info_DEF_management_id__digital_evidence_type__lineEdit_1) #44
        ...
        tmp_list.append(self.DE_Acquisition_Info_DEF_digital_evidence_file_name__lineEdit_1) #48
        ...
        tmp_list.append(self.DE_Acquisition_Info_DEF_sector_size__lineEdit_1) #52
    ...
    def ExportButton_exporttojsonfile(self):
        ...
        for list in self.DE_AddAll_List:
            ...
            for acquisition_list in self.DE_AddAll_List:
                tmp_list.append({'authentication_id': acquisition_list[37].text(), 'authentication_person_name': acquisition_list[38].text(),
                                 'authentication_date_time': acquisition_list[39].text(),
                                 'authentication_location': acquisition_list[40].text(), 'authentication_tool': acquisition_list[41].text()})

                tmp_list = []
                for acquisition_list in self.DE_AddAll_List:
                    tmp_list.append({'serial_no': acquisition_list[42].text(), 'management_id': acquisition_list[43].text(),
                                     'digital_evidence_type': acquisition_list[44].text(), 'evidences_gathering_type': acquisition_list[45].text(),
                                     'gather_no': acquisition_list[46].text(), 'file_name': acquisition_list[48].text(),
                                     'file_path': acquisition_list[49].text(), 'hash_type': acquisition_list[50].text(),
                                    'hash_value': acquisition_list[51].text(), 'sector_size': acquisition_list[51].text()})
