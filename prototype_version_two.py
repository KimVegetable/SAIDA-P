...
class Ui_SecondWindow(object):
    ...
    def setupUi(self, SecondWindow):
        ...
        self.DE_Acquisition_Info_DEF__addButton_1.clicked.connect(lambda: self.DE_Acquisition_Info_DEF_AddTab(0,0)) # a = big tab의 a번째, b = acquisition_info의 b번째
    ...
    def DE_Acquisition_Info_DEF_AddTab(self, a, b):
        ...
        self.DE_Acquisition_Info_DEF_Tab_Widget_List[0][len(self.DE_Acquisition_Info_List[0])-1].addTab(tmp_tab_9, "Tab" )
        ...
        self.DE_Acquisition_Info_DEF_List[b].append(tmp_list)
