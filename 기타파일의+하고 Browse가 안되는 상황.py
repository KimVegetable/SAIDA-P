...
class Ui_SecondWindow(object):
    ...
    def DE__addButton_AddDE(self,a):
        ...
        tmp_DE_other_files_file_browse__browseButton_1.clicked.connect(
            lambda: self.DE_other_files_file_browse_browseButton_1_QFileDialog2(a))
    ...
    def DE_Acquisition_Info__addButton_1_AddDEAquisitionFile(self, a):
        ...
        self.DE_Acquisition_Info_File_List[a].addLayout(tmp_DE_Aquisition_Info_file__verticalLayout_1,
                                                        self.DE_Acquisition_Info_num, 0, 1, 1)
    ...
    def DE_other_files__addButton_1_AddDEOtherFiles(self, a):
        ...
        tmp_DE_other_files_file_browse__label_1.setObjectName(
            "DE_other_files_file_browse__label_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_browse__label_1.setText("파일 입력: ")
        ...
        tmp_DE_other_files_file_browse__lineEdit_1.setObjectName(
            "DE_other_files_file_browse__lineEdit_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_browse__horizontalLayout_1.addWidget(tmp_DE_other_files_file_browse__lineEdit_1)
        ...
        tmp_DE_other_files_file_browse__browseButton_1.setObjectName(
            "DE_other_files_file_browse__browseButton_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_browse__browseButton_1.setText("Browse...")
        ...
        tmp_DE_other_files_file_browse__EnterButton_1.setObjectName(
            "DE_other_files_file_browse__EnterButton_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_browse__EnterButton_1.setText("Enter")
        ...
        tmp_DE_other_files_id__horizontalLayout_1.setObjectName(
            "DE_other_files_id__horizontalLayout_" + str(self.DE_Other_Files_num))
        ...
        tmp_DE_other_files_id__lineEdit_1.setObjectName(
            "DE_other_files_id__lineEdit_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_id__horizontalLayout_1.addWidget(tmp_DE_other_files_id__lineEdit_1)
        tmp_DE_other_files__verticalLayout_1.addLayout(tmp_DE_other_files_id__horizontalLayout_1)
        tmp_DE_other_files_type__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        tmp_DE_other_files_type__horizontalLayout_1.setObjectName(
            "DE_other_files_type__horizontalLayout_" + str(self.DE_Other_Files_num))
        ...
        tmp_DE_other_files_type__lineEdit_1.setObjectName(
            "DE_other_files_type__lineEdit_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_type__horizontalLayout_1.addWidget(tmp_DE_other_files_type__lineEdit_1)
        tmp_DE_other_files__verticalLayout_1.addLayout(tmp_DE_other_files_type__horizontalLayout_1)
        tmp_DE_other_files_file_size__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        tmp_DE_other_files_file_size__horizontalLayout_1.setObjectName(
            "DE_other_files_file_size__horizontalLayout_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_size__label_1 = QtWidgets.QLabel(self.DE_other_files__scrollAreaWidgetContents_1)
        tmp_DE_other_files_file_size__label_1.setObjectName(
            "DE_other_files_file_size__label_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_size__label_1.setText("파일 크기: ")
        ...
        tmp_DE_other_files_file_size__lineEdit_1.setObjectName(
            "DE_other_files_file_size__lineEdit_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_size__horizontalLayout_1.addWidget(tmp_DE_other_files_file_size__lineEdit_1)
        tmp_DE_other_files__verticalLayout_1.addLayout(tmp_DE_other_files_file_size__horizontalLayout_1)
        tmp_DE_other_files_file_path__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        tmp_DE_other_files_file_path__horizontalLayout_1.setObjectName(
            "DE_other_files_file_path__horizontalLayout_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_path__label_1 = QtWidgets.QLabel(self.DE_other_files__scrollAreaWidgetContents_1)
        tmp_DE_other_files_file_path__label_1.setObjectName(
            "DE_other_files_file_path__label_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_path__label_1.setText("파일 경로: ")
        ...
        tmp_DE_other_files_file_path__lineEdit_1.setObjectName(
            "DE_other_files_file_path__lineEdit_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_path__horizontalLayout_1.addWidget(tmp_DE_other_files_file_path__lineEdit_1)
        tmp_DE_other_files__verticalLayout_1.addLayout(tmp_DE_other_files_file_path__horizontalLayout_1)
        tmp_DE_other_files_file_hash_type__horizontalLayout_1 = QtWidgets.QHBoxLayout()
        tmp_DE_other_files_file_hash_type__horizontalLayout_1.setObjectName(
            "DE_other_files_file_hash_type__horizontalLayout_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_hash_type__label_1 = QtWidgets.QLabel(
            self.DE_other_files__scrollAreaWidgetContents_1)
        tmp_DE_other_files_file_hash_type__label_1.setObjectName(
            "DE_other_files_file_hash_type__label_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_hash_type__label_1.setText("해시 종류: ")
        ...
        tmp_DE_other_files_file_hash_type__lineEdit_1.setObjectName(
            "DE_other_files_file_hash_type__lineEdit_" + str(self.DE_Other_Files_num))
        ...
        tmp_DE_other_files_file_hash_value__horizontalLayout_1.setObjectName(
            "DE_other_files_file_hash_value__horizontalLayout_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_hash_value__label_1 = QtWidgets.QLabel(
            self.DE_other_files__scrollAreaWidgetContents_1)
        tmp_DE_other_files_file_hash_value__label_1.setObjectName(
            "DE_other_files_file_hash_value__label_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_hash_value__label_1.setText("해시값: ")
        ...
        tmp_DE_other_files_file_metadata__lineEdit_1.setObjectName(
            "DE_other_files_file_metadata__lineEdit_" + str(self.DE_Other_Files_num))
        tmp_DE_other_files_file_metadata__horizontalLayout_1.addWidget(tmp_DE_other_files_file_metadata__lineEdit_1)

        tmp_DE_other_files__verticalLayout_1.addLayout(tmp_DE_other_files_file_metadata__horizontalLayout_1)
        self.DE_Other_Files_File_List[a].addLayout(tmp_DE_other_files__verticalLayout_1, self.DE_Other_Files_num, 0,
                                                   1, 1)
    ...
    # DE Other Files의 +누르고 Browse눌러서 파일 업로드
    ...
    # DE 전체 + 버튼 누르고 Other Browse
    def DE_other_files_file_browse_browseButton_1_QFileDialog2(self, a):
        file_name = QFileDialog.getOpenFileName()
        self.DE_AddAll_Other_Files_Browse_List[a][0].setText(file_name[0])
